 ...
 * @author s386
 */
public class BranchGroup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtfBtypeCode = new javax.swing.JTextField();
        ...
        setTitle("กำหนดรหัสกลุ่มสาขา");

        btnShowBranch.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        btnShowBranch.setText("แสดงรายการสาขาใน Branch Group");
        ...
        lblBtypeCode.setText("รหัสกลุ่มสาขา");
        ...
        txtfBtypeCode.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        txtfBtypeCode.setName("txtfBtypeCode"); // NOI18N
        txtfBtypeCode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtfBtypeCodeActionPerformed(evt);
            }
        });
        ...
        lblDiscription1.setText("สูตรอาหารที่ใช้");
        lblDiscription1.setName("d_lblDiscription"); // NOI18N

        txt_formula.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        txt_formula.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_formula.setText("txt_formula");
        txt_formula.setName("txtfBtypeCode"); // NOI18N
        ...
        txt_formula.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txt_formulaKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_formulaKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(lblDiscription1, javax.swing.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE))
                    .addComponent(txtfBtypeCode, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txt_formula, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(373, 373, 373))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtfBtypeCode, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txt_formula, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        tblBtype.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ประเภทสาขา", "รายละเอียด", "สูตรอาหารที่ใช้"
            }
        ) {
        ...
        tblBtype.getColumnModel().getColumn(0).setPreferredWidth(0);
        tblBtype.getColumnModel().getColumn(1).setPreferredWidth(600);
        tblBtype.getColumnModel().getColumn(2).setPreferredWidth(80);
    ...
    private void txtfBtypeCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtfBtypeCodeActionPerformed
        // TODO add your handling code here:
   }//GEN-LAST:event_txtfBtypeCodeActionPerformed
    ...
    private void tblBtypeMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBtypeMouseReleased
        if (evt.getClickCount() == 2) {
            ...
            String formula = tblBtype.getValueAt(index, 2).toString();
            if (txtfBtypeCode.getText().equals("")) {
                txtfBtypeCode.setText(typecode);
                txtfDiscription.setText(typedis);
                txt_formula.setText(formula);
            } else if (!txtfBtypeCode.getText().equals(typecode)) {
...
//        parm.put("branchtxt", "");
    ...
    private void btnShowBranchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowBranchActionPerformed
        ShowBranchOfBGroup f = new ShowBranchOfBGroup(this, true);
        f.setVisible(true);
        // TODO add your handling code here:
    ...
    private void txt_formulaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txt_formulaFocusLost
        String data = f.convertDoubleString(txt_formula.getText().trim());
        if (data.length() > 0) {
            if (!f.isNumberic(data)) {
                txt_formula.setText("1");
            } else {
                Double d = Double.parseDouble(data);
                txt_formula.setText(f.intFmtShow(d));
            }
        } else {
            txt_formula.setText("1");
        }
    ...
    private void txt_formulaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_formulaKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_formulaKeyReleased

    private void txt_formulaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_formulaKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_formulaKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BranchGroup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new BranchGroup().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtfBtypeCode;
    ...
    public boolean ChkValidEnter() {
        boolean chk = true;
        if (txtfBtypeCode.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "กรุณากำหนดรหัสประเภทสาขาก่อน");
            chk = false;
            txtfBtypeCode.requestFocus();
        } else if (txtfBtypeCode.getText().length() > 3) {
            JOptionPane.showMessageDialog(this, "กำหนดรหัสประเภทสาขาไม่ถูกต้อง... (ต้องมีขนาดไม่เกิน 3 ตัวอักษร)");
            chk = false;
            txtfBtypeCode.requestFocus();
        } else if (txtfBtypeCode.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(this, "กรุณากำหนดรหัสประเภทสาขาให้ถูกต้อง");
            chk = false;
            txtfBtypeCode.requestFocus();
        ...
        try {
            ...
            while (rs.next()) {
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("bgroupcode")), cvth.ASCII2Unicode(rs.getString("bgroupname")), rs.getInt("formula")});
                } else {
                    tbBranctype.addRow(new Object[]{rs.getString("bgroupcode"), rs.getString("bgroupname"), rs.getInt("formula")});
                }
            }
        } catch (Exception e) {
        }
    ...
    public void btnsave() {
        ...
        int formula = 1;
        if (f.isNumberic(f.convertDoubleString(txt_formula.getText().trim()))) {
            formula = Integer.parseInt(f.convertDoubleString(txt_formula.getText().trim()));
        }
        if (validateSave()) {
            if (chkdata(txtfBtypeCode.getText())) {
                ...
                try {
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Update branchgroup set bgroupname = ?, formula=? where bgroupcode = ?";
                        ...
                        prm.setInt(2, formula);
                        prm.setString(3, cvth.Unicode2ASCII(txtfBtypeCode.getText()));
                        prm.executeUpdate();
                    } else {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Update branchgroup set bgroupname = ?, formula=? where bgroupcode = ?";
    ...
    public void enter() {
        ...
        try {
            if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from branchgroup where bgroupcode ='" + cvth.Unicode2ASCII(txtfBtypeCode.getText()) + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    txtfDiscription.setText(cvth.ASCII2Unicode(rs.getString("bgroupname")));
                    txt_formula.setText(rs.getInt("formula") + "");
                    setFocus(true);
                    txtfDiscription.requestFocus();
                } else {
                    setFocus(true);
                ...
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from branchgroup where bgroupcode ='" + txtfBtypeCode.getText() + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    txtfDiscription.setText(rs.getString("bgroupname"));
                    txt_formula.setText(rs.getInt("formula") + "");
                    setFocus(true);
                    txtfDiscription.requestFocus();
                } else {
    ...
    public void delete() {
        ...
        try {
            if (chkbranfile(txtfBtypeCode.getText()) == 0) {
                ...
                JOptionPane.showMessageDialog(this, "ไม่สามารถลบข้อมูลได้ เนื่องจากมีข้อมูลอยู่ในสาขาจำนวน " + chkbranfile(txtfBtypeCode.getText()) + " รายการ");
            }
    ...
    public int chkbranfile(String code) {
        ...
        try {
            if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from branfile where bgroup ='" + cvth.Unicode2ASCII(code) + "'";
                rs = stmt.executeQuery(sql);
                while (rs.next()) {
                    count++;
                }
                ...
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from branfile where bgroup ='" + code + "'";
                rs = stmt.executeQuery(sql);
                while (rs.next()) {
                    count++;
                }
