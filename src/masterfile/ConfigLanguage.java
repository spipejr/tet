 ...
 * @author s386
 */
public class ConfigLanguage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboLang.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        ...
        db_btnconfirm.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        db_btnconfirm.setText("ตกลง");
        db_btnconfirm.setName("db_btnconfirm");
        ...
        menuDefault.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        menuDefault.setText("Default");
        menuDefault.setName("menuDefault");
        ...
        menuThai.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        menuThai.setText("Thai");
        menuThai.setName("menuThai");
        ...
        menuEng.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        menuEng.setText("English");
        menuEng.setName("menuEng");
        ...
        menuLocal.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        menuLocal.setText("Local");
        menuLocal.setName("menuLocal");
    ...
    private void db_btnconfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_db_btnconfirmActionPerformed
        lang.setChklang(i);
        lang.setText(frmName, this, lang.getChklang());
        lang.setText(ParentName, this, lang.getChklang());
        
        ConfigLanguage.this.dispose();
        new ConfigLanguage(Parent, true, ParentName);
