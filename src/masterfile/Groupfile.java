 ...
 * @author s386
 */
public class Groupfile extends javax.swing.JDialog {
    ...
    Statement stmt;
    String frmName = "groupfile";
    ThaiUtilities cvth = new ThaiUtilities();
    getLanguage lang = new getLanguage();

    public Groupfile(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        checkuserconfig();
        ...
        showdataintb();
        clear();
        tblBtype.setAutoCreateRowSorter(true);
    ...
    private void initComponents() {
        ...
        lblBtypeCode1 = new javax.swing.JLabel();
        txtfdept = new javax.swing.JTextField();
        txtfdeptname = new javax.swing.JTextField();
        ...
        setTitle("กำหนดรหัสกลุ่มสินค้า (Product Group)");
        ...
        tblBtype.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสกลุ่มสินค้า", "ชื่อกลุ่มสินค้า", "รหัสแผนก DEPT", "ชื่อแผนกสินค้า"
            }
        ) {
        ...
        tblBtype.getColumnModel().getColumn(0).setResizable(false);
        tblBtype.getColumnModel().getColumn(0).setPreferredWidth(100);
        tblBtype.getColumnModel().getColumn(1).setResizable(false);
        tblBtype.getColumnModel().getColumn(1).setPreferredWidth(300);
        tblBtype.getColumnModel().getColumn(2).setPreferredWidth(100);
        tblBtype.getColumnModel().getColumn(3).setResizable(false);
        tblBtype.getColumnModel().getColumn(3).setPreferredWidth(350);
        ...
        lblBtypeCode.setText("รหัสกลุ่มสินค้า");
        ...
        lblBtypeCode1.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        lblBtypeCode1.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblBtypeCode1.setText("รหัสแผนกสินค้า (DEPT)");
        lblBtypeCode1.setName("d_lblBtypeCode");

        txtfdept.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        txtfdept.setName("txtfCode");
        txtfdept.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtfdeptActionPerformed(evt);
            }
        });
        txtfdept.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtfdeptFocusLost(evt);
            }
        });
        txtfdept.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                txtfdeptInputMethodTextChanged(evt);
            }
        });
        txtfdept.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtfdeptKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtfdeptKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtfdeptKeyTyped(evt);
            }
        });

        txtfdeptname.setBackground(new java.awt.Color(246, 246, 182));
        txtfdeptname.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        txtfdeptname.setFocusable(false);
        txtfdeptname.setName("txtfDiscription");
        txtfdeptname.setRequestFocusEnabled(false);
        txtfdeptname.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtfdeptnameActionPerformed(evt);
            }
        });
        txtfdeptname.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtfdeptnameFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtfdeptnameFocusLost(evt);
            }
        });
        txtfdeptname.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtfdeptnameKeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(lblBtypeCode1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(txtfCode, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtfdept, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnsearchplu1, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtfdeptname, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(32, 32, 32))
        );
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(lblBtypeCode1)
                        .addComponent(txtfdept, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtfdeptname, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(26, 26, 26))
        );
    ...
    private void checkuserconfig() {
        ...
        if (userrec.getPlu1().equals("1")) {
            btnSave.setEnabled(false);
            btnDetete.setEnabled(false);
            menuSave.setEnabled(false);
            menuDelete.setEnabled(false);
        }
        if (userrec.getPlu1().equals("2")) {
            btnSave.setEnabled(true);
            btnDetete.setEnabled(false);
            menuSave.setEnabled(true);
            menuDelete.setEnabled(false);
        }
        if (userrec.getPlu1().equals("3")) {
            btnSave.setEnabled(true);
    ...
    private void db_btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_db_btnPrintActionPerformed
        ...
        ds2 = new JRBeanCollectionDataSource(report.databeanMasterfile2.getGroupfile2());
        parm.put("companyName", lang.getTextCompanyReport());
        //parm.put("Reportheader", lang.getTextReport(frmName, "texthead"));
        parm.put("Reportheader", "รายงานแสดงรายการกลุ่มสินค้า");
        parm.put("code", lang.getTextReport(frmName, "code"));
        parm.put("name", lang.getTextReport(frmName, "name"));
        parm.put("deptcode", lang.getTextReport(frmName, "code"));
        parm.put("deptname", lang.getTextReport(frmName, "name"));
//        parm.put("deptcode","รหัสแผนกสินค้า");
//        parm.put("deptname", "ชื่อแผนกสินค้า");
        ...
        String rptName = "rptgroupfile";
        Report rpt = new Report();
        rpt.viewReportbean(rptName, parm, frmName, ds2);
        // TODO add your handling code here:
    ...
    private void tblBtypeMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBtypeMouseReleased
        if (evt.getClickCount() == 2) {
            ...
            String typedis2 = tblBtype.getValueAt(index, 2).toString();
            String typedis3 = tblBtype.getValueAt(index, 3).toString();
            if (txtfCode.getText().equals("")) {
                txtfCode.setText(typecode);
                txtfDiscription.setText(typedis);
                txtfdept.setText(typedis2);
                txtfdeptname.setText(typedis3);
    ...
    private void txtfdeptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtfdeptActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptActionPerformed

    private void txtfdeptFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtfdeptFocusLost
        // TODO add your handling code here:
        if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
           txtfdeptname.setText(cvth.ASCII2Unicode(PUtility.SeekDeptName(txtfdept.getText())));
        } else {
           txtfdeptname.setText(PUtility.SeekDeptName(txtfdept.getText())); 
        }
    }//GEN-LAST:event_txtfdeptFocusLost

    private void txtfdeptKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfdeptKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode()==KeyEvent.VK_ENTER) {
           txtfDiscription.requestFocus();
        }
    }//GEN-LAST:event_txtfdeptKeyPressed

    private void txtfdeptKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfdeptKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptKeyReleased

    private void txtfdeptKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfdeptKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptKeyTyped

    private void txtfdeptnameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtfdeptnameActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptnameActionPerformed

    private void txtfdeptnameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtfdeptnameFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptnameFocusGained

    private void txtfdeptnameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtfdeptnameFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptnameFocusLost

    private void txtfdeptnameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfdeptnameKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptnameKeyPressed
    ...
    private void txtfdeptInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_txtfdeptInputMethodTextChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_txtfdeptInputMethodTextChanged
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Groupfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Groupfile dialog = new Groupfile(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel lblBtypeCode1;
    ...
    private javax.swing.JTextField txtfdept;
    private javax.swing.JTextField txtfdeptname;
    // End of variables declaration//GEN-END:variables
    public boolean ChkValidEnter() {
        boolean chk = true;
        if (txtfCode.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "กรุณากำหนดรหัสแผนกก่อน");
            chk = false;
            txtfCode.requestFocus();
        } else if (txtfCode.getText().length() > 4) {
            JOptionPane.showMessageDialog(this, "กำหนดรหัสแผนกไม่ถูกต้อง... (ต้องมีขนาดไม่เกิน 4 ตัวอักษร)");
            chk = false;
            txtfCode.requestFocus();
        } else if (txtfCode.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(this, "กรุณากำหนดรหัสแผนกให้ถูกต้อง");
            chk = false;
            txtfCode.requestFocus();
            txtfCode.setText("");
        }
    ...
    public void showdataintb() {
        ...
        try {
            ...
            while (rs.next()) {
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("groupcode")),
                                cvth.ASCII2Unicode(rs.getString("groupname")),cvth.ASCII2Unicode(rs.getString("deptcode")),cvth.ASCII2Unicode(PUtility.SeekDeptName(rs.getString("deptcode")))});
                } else {
                    tbBranctype.addRow(new Object[]{rs.getString("groupcode"),
    ...
    public boolean validateSave() {
        ...
        if (!txtfDiscription.isFocusable()) {
            ...
            chk = false;
            txtfDiscription.requestFocus();
        } else if (!PUtility.ChkDeptOK(txtfdept.getText())) {
            JOptionPane.showMessageDialog(this, "กำหนดรหัสแฟนกสินค้า (Dept) ไม่ถูกต้อง...)");
            chk = false;
            txtfdept.requestFocus();
        }
        return chk;
    ...
    public boolean chkdata(String pk) {
        ...
        try {
            if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                ...
                String sql = "select * from groupfile where groupcode ='" + cvth.Unicode2ASCII(pk) + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    chk = true;
                }
                ...
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from groupfile where groupcode ='" + pk + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    chk = true;
                }
        ...
        if (validateSave()) {
            if (chkdata(txtfCode.getText())) {
                ...
                try {
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Update groupfile set groupname = ? where groupcode = ?";
                ...
                try {
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Insert into groupfile (groupcode,groupname) values(?,?)";
                        PreparedStatement prm = (PreparedStatement) db.con.prepareStatement(sql);
    ...
    public void enter() {
        ...
        try {
            if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from groupfile where groupcode ='" + cvth.Unicode2ASCII(txtfCode.getText()) + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    txtfDiscription.setText(cvth.ASCII2Unicode(rs.getString("groupname")));
                    txtfdept.setText(cvth.ASCII2Unicode(rs.getString("deptcode")));
                    txtfdeptname.setText(cvth.ASCII2Unicode(PUtility.SeekDeptName(txtfdept.getText())));
                    setFocus(true);
                    txtfDiscription.requestFocus();
                } else {
                ...
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from groupfile where groupcode ='" + txtfCode.getText() + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    txtfDiscription.setText(rs.getString("groupname"));
                    txtfdept.setText(rs.getString("deptcode"));
                    txtfdeptname.setText(PUtility.SeekDeptName(txtfdept.getText()));
                    setFocus(true);
                    txtfDiscription.requestFocus();
                } else {
    ...
    public void delete() {
        ResultSet rs = null;
        try {
            int chk = chkproduct(txtfCode.getText());
            if (chk == -1) {
                return;
            } else if (chk == 0) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Delete from groupfile where groupcode=?";
                        PreparedStatement prm = (PreparedStatement) db.con.prepareStatement(sql);
    ...
    public int chkproduct(String code) {
        ...
        try {
            if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from product where pgroup ='" + cvth.Unicode2ASCII(code) + "'";
                rs = stmt.executeQuery(sql);
                while (rs.next()) {
                    count++;
                }
                ...
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from product where pgroup ='" + code + "'";
                rs = stmt.executeQuery(sql);
                while (rs.next()) {
                    count++;
                }
