...
import frmlist.ShowBranchOfBtype;
 ...
 * @author s386
 */
public class Branchtype extends javax.swing.JFrame {

    DefaultTableModel tbBranctype;
//    DefaultTableColumnModel tbHBranchtype;
    JTableHeader tbHBranchtype;
    dbUtility db = new dbUtility();
    Statement stmt;
    String frmName = "btype";
    ThaiUtilities cvth = new ThaiUtilities();
    getLanguage lang = new getLanguage();
    /**
     * Creates new form Branchtype
     */
    public Branchtype() {
        initComponents();
        checkuserconfig();
        tbBranctype = (DefaultTableModel) tblBtype.getModel();
//        tbHBranchtype = (DefaultTableColumnModel) tblBtype.getModel();
        tbHBranchtype = (JTableHeader) tblBtype.getTableHeader();
    ...
    private void initComponents() {
        ...
        lblBtypeCode.setText("รหัสประเภทสาขา");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtfBtypeCode, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        btnShowBranch.setText("แสดงรายการสาขาใน Branch Type");
...
private void checkuserconfig() {
        ...
        if (userrec.getMast5().equals("1")) {
            btnSave.setEnabled(false);
            btnDetete.setEnabled(false);
            menuSave.setEnabled(false);
            menuDelete.setEnabled(false);
        }
        if (userrec.getMast5().equals("2")) {
            btnSave.setEnabled(true);
            btnDetete.setEnabled(false);
            menuSave.setEnabled(true);
            menuDelete.setEnabled(false);
        }
        if (userrec.getMast5().equals("3")) {
            btnSave.setEnabled(true);
    ...
    private void txtfBtypeCodeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfBtypeCodeKeyReleased
        ...
        txtfBtypeCode.setText(out);// TODO add your handling code here:
    ...
    private void txtfBtypeCodeKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtfBtypeCodeKeyTyped
        if (txtfBtypeCode.getText().length() >= 2) {
            evt.consume();
        }
        // TODO add your handling code here:
    ...
    private void btnDeteteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeteteActionPerformed
        if (!txtfBtypeCode.getText().trim().equals("") && chkdata(txtfBtypeCode.getText())) {
            delete();
        }
        // TODO add your handling code here:
    ...
    private void db_btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_db_btnPrintActionPerformed
        ...
        ds = new JRBeanCollectionDataSource(report.databeanMasterfile.getBranchtype());
    ...
    private void btnShowBranchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShowBranchActionPerformed
        ...
        ShowBranchOfBtype dialog = new ShowBranchOfBtype(new NimbusFrame(), true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Branchtype.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new Branchtype().setVisible(true);
            }
        });
    }
    ...
    public boolean ChkValidEnter() {
        ...
        if (txtfBtypeCode.getText().equals("")) {
            ...
            chk = false;
            txtfBtypeCode.requestFocus();
        } else if (txtfBtypeCode.getText().length() > 2) {
            JOptionPane.showMessageDialog(this, "กำหนดรหัสประเภทสาขาไม่ถูกต้อง... (ต้องมีขนาดไม่เกิน 2 ตัวอักษร)");
            chk = false;
            txtfBtypeCode.requestFocus();
        ...
        try {
            ...
            while (rs.next()) {
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("btcode")), cvth.ASCII2Unicode(rs.getString("btname"))});
                    
                } else {
                    tbBranctype.addRow(new Object[]{rs.getString("btcode"), rs.getString("btname")});
                }
            }
        } catch (Exception e) {
        }
        ...
        if (validateSave()) {
            ...
            if (chkdata(txtfBtypeCode.getText())) {
                ...
                try {
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Update btype set btname = ? where btcode = ?";
                        ...
                        prm.setString(2, cvth.Unicode2ASCII(txtfBtypeCode.getText()));
                        prm.executeUpdate();
                    } else {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Update btype set btname = ? where btcode = ?";
                        ...
                        prm.setString(2, txtfBtypeCode.getText());
                        prm.executeUpdate();
                    }
                    stmt.close();
                    clear();
                ...
                try {
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) db.con.createStatement();
                        String sql = "Insert into btype (btcode,btname) values(?,?)";
                        PreparedStatement prm = (PreparedStatement) db.con.prepareStatement(sql);
    ...
    public void enter() {
        ...
        try {
            if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from btype where btcode ='" + cvth.Unicode2ASCII(txtfBtypeCode.getText()) + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    txtfDiscription.setText(cvth.ASCII2Unicode(rs.getString("btname")));
                    setFocus(true);
                    txtfDiscription.requestFocus();
                } else {
                    setFocus(true);
                ...
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from btype where btcode ='" + txtfBtypeCode.getText() + "'";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    txtfDiscription.setText(rs.getString("btname"));
                    setFocus(true);
                    txtfDiscription.requestFocus();
                } else {
                    setFocus(true);
    ...
    public void delete() {
        ...
        try {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    stmt = (Statement) db.con.createStatement();
                    String sql = "Delete from btype where btcode=?";
                    PreparedStatement prm = (PreparedStatement) db.con.prepareStatement(sql);
    ...
    public int chkbranfile(String code) {
        ...
        try {
            if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from branfile where btype ='" + cvth.Unicode2ASCII(code) + "'";
                rs = stmt.executeQuery(sql);
                while (rs.next()) {
                    count++;
                }
                ...
                stmt = (Statement) db.con.createStatement();
                String sql = "select * from branfile where btype ='" + code + "'";
                rs = stmt.executeQuery(sql);
                while (rs.next()) {
                    count++;
                }
