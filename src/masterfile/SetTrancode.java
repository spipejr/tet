 ...
 * @author s386
 */
public class SetTrancode extends javax.swing.JDialog {
    ...
    public SetTrancode(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        checkuserconfig();
        db.dbconnect();
    ...
    private void initComponents() {
        ...
        setTitle("แฟ้มข้อมูลการโอนระหว่างรหัส");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "การโอนสินต้าระหว่างรหัส", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Norasi", 1, 14))); // NOI18N
        ...
        d_lblh1.setText("จากรหัสสินค้า (PLU)");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(t_name, javax.swing.GroupLayout.PREFERRED_SIZE, 299, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        d_lblincode.setText("เป็นรหัสสินค้า (PLU)");
        d_lblincode.setName("d_lblincode"); // NOI18N
        ...
        d_lblinname.setName("d_lblinname"); // NOI18N
        ...
        d_lblqty.setText("จำนวนที่ได้");
        d_lblqty.setName("d_lblqty"); // NOI18N
        ...
        db_btndelete2.setName("db_btndelete2"); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(t_incode)
                    .addComponent(d_lblincode, javax.swing.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tbltable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "จากรหัสสินค้า", "ชื่อสินค้า/รายการ", "เป็นรหัสสินค้า", "ชื่อสินค้า/รายการ", "จำนวน", "หน่วยนับ"
            }
        ) {
        ...
        if (tbltable.getColumnModel().getColumnCount() > 0) {
            ...
            tbltable.getColumnModel().getColumn(3).setPreferredWidth(250);
        ...
        setSize(new java.awt.Dimension(896, 738));
...
private void checkuserconfig() {
    ...
    private void tbltableMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbltableMouseReleased
        if (evt.getClickCount() == 2) {
            ...
            String tcode = tbltable.getValueAt(rowSelect, 0).toString();
            String tname = tbltable.getValueAt(rowSelect, 1).toString();
            String incode = tbltable.getValueAt(rowSelect, 2).toString();
            String inname = tbltable.getValueAt(rowSelect, 3).toString();
            double qty = Double.parseDouble(tbltable.getValueAt(rowSelect, 4).toString());
            String unit = tbltable.getValueAt(rowSelect, 5).toString();

            t_code.setText(tcode);
            t_name.setText(tname);
            t_incode.setText(incode);
            t_inname.setText(inname);
            t_qty.setText(Format.integerFmt.format(qty));
            t_unit.setText(unit);
            setActive();
            t_incode.requestFocus();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SetTrancode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                SetTrancode dialog = new SetTrancode(new javax.swing.JFrame(), true);
    ...
    public boolean chkdatamenu(String plucode, String incode) {
        ...
        try {
            if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) dbUtility.con.createStatement();
                String sql = "select * from trancode where pcode1 ='" + cvth.Unicode2ASCII(plucode) + "' ";
                ...
                stmt = (Statement) dbUtility.con.createStatement();
                String sql = "select * from trancode where pcode1 ='" + plucode + "' '";
                rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    chk = true;
                }
    ...
    public void GetDetail(String Code) {
        try {
            if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                String sql = "select * from trancode "
                        + "left join product on pcode2=pcode "
                        + "where pcode1='" + cvth.Unicode2ASCII(Code) + "'";
                stmt = (Statement) dbUtility.con.createStatement();
                ResultSet rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    t_incode.setText(cvth.ASCII2Unicode(rs.getString("pcode2")));
                    t_inname.setText(cvth.ASCII2Unicode(rs.getString("pdesc")));
                    t_qty.setText(IntFmt.format(rs.getDouble("pqty")));
                    t_unit.setText(cvth.ASCII2Unicode(rs.getString("punit1")));
                }
                rs.close();
                stmt.close();
                ...
                ResultSet rs = stmt.executeQuery(sql);
                if (rs.next()) {
                    t_incode.setText(rs.getString("pcode2"));
                    t_inname.setText(rs.getString("pdesc"));
                    t_qty.setText(IntFmt.format(rs.getDouble("pqty")));
                    t_unit.setText(rs.getString("punit1"));
                }
                rs.close();
                stmt.close();
            }
    ...
    public boolean isProductOK(String Code) {
    ...
    public void showdataintb() {
        ...
        try {
            if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                stmt = (Statement) dbUtility.con.createStatement();
                String sql = "select pcode1,pcode2,pqty,tr.pactive,p1.pdesc as pdesc1,p2.pdesc as pdesc2,p2.punit1  from trancode tr  "
                        + "left join product p1 on tr.pcode1=p1.pcode "
                        + "left join product p2 on tr.pcode2=p2.pcode  ";
                rs = stmt.executeQuery(sql);
                while (rs.next()) {
                    {
                        tbmodel.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("pcode1")),
                            cvth.ASCII2Unicode(rs.getString("pdesc1")),
                            cvth.ASCII2Unicode(rs.getString("pcode2")),
                            cvth.ASCII2Unicode(rs.getString("pdesc2")),
                            rs.getDouble("pqty"),
                ...
                while (rs.next()) {
                    double ans = 0;
                    {
                        tbmodel.addRow(new Object[]{rs.getString("pcode1"),
                            rs.getString("pdesc1"),
                            rs.getString("pcode2"),
                            rs.getString("pdesc2"),
                            rs.getDouble("qty"),
        ...
        if (CheckValidSave()) {
            if (chkdatamenu(t_code.getText(), t_incode.getText())) {
                try {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) dbUtility.con.createStatement();
                        String sql = "Update trancode set pqty=?,pcode2=?  where pcode1=? ";
                        ...
                        stmt = (Statement) dbUtility.con.createStatement();
                        String sql = "Update trancode set pqty=? where pcode1=? and pcode2=?";
                        PreparedStatement prm = (PreparedStatement) dbUtility.con.prepareStatement(sql);
                        prm.setDouble(1, Double.parseDouble(PUtility.ConvertReal(t_qty.getText())));
                ...
                try {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        stmt = (Statement) dbUtility.con.createStatement();
                        String sql = "Insert into trancode (pcode1,pcode2,pqty) values(?,?,?)";
                        PreparedStatement prm = (PreparedStatement) dbUtility.con.prepareStatement(sql);
    ...
    public boolean CheckValidSave() {
        ...
        if (t_code.getText().length() > 13) {
            ...
            JOptionPane.showMessageDialog(this, "กำหนดรหัสสินค้าไม่ถูกต้อง ...ไม่สามารถโอนในรหัสตัวเองได้ !!!");
            chk = false;
            clear2();
            t_incode.requestFocus();
        }
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                try {
                    if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                        ...
                        String sql = "delete from trancode where pcode1 = ? ";
