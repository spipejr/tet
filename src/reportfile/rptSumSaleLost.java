...
import reportModel.reportSumSaleLostBean;
 ...
 * @author s386
 */
public class rptSumSaleLost extends javax.swing.JDialog {

    /**
     * Creates new form rptSumSaleLost
     */
    ...
    String frmName = "rptSumSaleLost";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();
    String[] BranArray;

    public rptSumSaleLost(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumSaleLost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumSaleLost dialog = new rptSumSaleLost(new javax.swing.JFrame(), true);
    ...
    private void inittbl() {
        try {
            ...
            tc1.setHeaderValue("item");
            TableColumn tc2 = new TableColumn(1, 80);
            tc2.setHeaderValue("RjNo");
            ...
            TableColumn tc5 = new TableColumn(5, 80);
            tc5.setHeaderValue("bran");
            TableColumn tc6 = new TableColumn(6, 80);
            tc6.setHeaderValue("bran");
            TableColumn tc7 = new TableColumn(7, 80);
            tc7.setHeaderValue("bran");
            TableColumn tc8 = new TableColumn(8, 80);
            tc8.setHeaderValue("bran");
            TableColumn tc9 = new TableColumn(9, 80);
            tc9.setHeaderValue("bran");
            TableColumn tc10 = new TableColumn(10, 80);
            tc10.setHeaderValue("bran");
            TableColumn tc13 = new TableColumn(11, 80);
            tc13.setHeaderValue("bran");
            TableColumn tc14 = new TableColumn(12, 80);
            tc14.setHeaderValue("difper");
            TableColumn tc15 = new TableColumn(13, 80);
            tc15.setHeaderValue("bran");
            TableColumn tc16 = new TableColumn(14, 80);
            tc16.setHeaderValue("bran");
            TableColumn tc17 = new TableColumn(15, 80);
            tc17.setHeaderValue("bran");
            TableColumn tc18 = new TableColumn(16, 80);
            tc18.setHeaderValue("bran");
            TableColumn tc19 = new TableColumn(17, 80);
            tc19.setHeaderValue("bran");
            TableColumn tc20 = new TableColumn(18, 80);
            tc20.setHeaderValue("bran");
            TableColumn tc21 = new TableColumn(19, 80);
            tc21.setHeaderValue("bran");
            TableColumn tc22 = new TableColumn(20, 80);
            tc22.setHeaderValue("bran");
            TableColumn tc23 = new TableColumn(21, 80);
            tc23.setHeaderValue("bran");
            TableColumn tc24 = new TableColumn(22, 80);
            tc24.setHeaderValue("bran");
            TableColumn tc25 = new TableColumn(23, 80);
            tc25.setHeaderValue("bran");
            TableColumn tc26 = new TableColumn(24, 80);
            tc26.setHeaderValue("bran");
            TableColumn tc27 = new TableColumn(25, 80);
            tc27.setHeaderValue("bran");
            TableColumn tc28 = new TableColumn(26, 80);
            tc28.setHeaderValue("bran");
            TableColumn tc29 = new TableColumn(27, 80);
            tc29.setHeaderValue("bran");
            TableColumn tc30 = new TableColumn(28, 80);
            tc30.setHeaderValue("bran");
            TableColumn tc31 = new TableColumn(29, 80);
            tc31.setHeaderValue("bran");
            TableColumn tc32 = new TableColumn(30, 80);
            tc32.setHeaderValue("bran");
            TableColumn tc33 = new TableColumn(31, 80);
            tc33.setHeaderValue("bran");
            TableColumn tc34 = new TableColumn(32, 80);
            tc34.setHeaderValue("bran");
            TableColumn tc35 = new TableColumn(33, 80);
            tc35.setHeaderValue("bran");
            TableColumn tc36 = new TableColumn(34, 80);
            tc36.setHeaderValue("bran");
            TableColumn tc37 = new TableColumn(35, 80);
            tc37.setHeaderValue("bran");
            TableColumn tc38 = new TableColumn(36, 80);
            tc38.setHeaderValue("bran");
            TableColumn tc39 = new TableColumn(37, 80);
            tc39.setHeaderValue("bran");
            TableColumn tc40 = new TableColumn(38, 80);
            tc40.setHeaderValue("bran");
            TableColumn tc41 = new TableColumn(39, 80);
            tc41.setHeaderValue("bran");
            TableColumn tc42 = new TableColumn(40, 80);
            tc42.setHeaderValue("bran");
            TableColumn tc43 = new TableColumn(41, 80);
            tc43.setHeaderValue("bran");
            TableColumn tc44 = new TableColumn(42, 80);
            tc44.setHeaderValue("bran");
            TableColumn tc45 = new TableColumn(43, 80);
            tc45.setHeaderValue("bran");
            TableColumn tc46 = new TableColumn(44, 80);
            tc46.setHeaderValue("bran");
            TableColumn tc47 = new TableColumn(45, 80);
            tc47.setHeaderValue("bran");
            TableColumn tc48 = new TableColumn(46, 80);
            tc48.setHeaderValue("bran");
            TableColumn tc49 = new TableColumn(47, 80);
            tc49.setHeaderValue("bran");
            TableColumn tc50 = new TableColumn(48, 80);
            tc50.setHeaderValue("bran");
            TableColumn tc51 = new TableColumn(49, 80);
            tc51.setHeaderValue("bran");
            TableColumn tc52 = new TableColumn(50, 80);
            tc52.setHeaderValue("bran");
            TableColumn tc53 = new TableColumn(51, 80);
            tc53.setHeaderValue("bran");
            TableColumn tc54 = new TableColumn(52, 80);
            tc54.setHeaderValue("bran");
            TableColumn tc55 = new TableColumn(53, 80);
            tc55.setHeaderValue("bran");
            TableColumn tc56 = new TableColumn(54, 80);
            tc56.setHeaderValue("bran");
            TableColumn tc57 = new TableColumn(55, 80);
            tc57.setHeaderValue("bran");
            TableColumn tc58 = new TableColumn(56, 80);
            tc58.setHeaderValue("bran");
            TableColumn tc59 = new TableColumn(57, 80);
            tc59.setHeaderValue("bran");
            TableColumn tc60 = new TableColumn(58, 80);
            tc60.setHeaderValue("bran");
            TableColumn tc61 = new TableColumn(59, 80);
            tc61.setHeaderValue("bran");
            TableColumn tc62 = new TableColumn(60, 80);
            tc62.setHeaderValue("bran");
            TableColumn tc63 = new TableColumn(61, 80);
            tc63.setHeaderValue("bran");
            TableColumn tc64 = new TableColumn(62, 80);
            tc64.setHeaderValue("bran");
            TableColumn tc65 = new TableColumn(63, 80);
            tc65.setHeaderValue("bran");
            TableColumn tc66 = new TableColumn(64, 80);
            tc66.setHeaderValue("bran");
            TableColumn tc67 = new TableColumn(65, 80);
            tc67.setHeaderValue("bran");
            TableColumn tc68 = new TableColumn(66, 80);
            tc68.setHeaderValue("bran");
            TableColumn tc69 = new TableColumn(67, 80);
            tc69.setHeaderValue("bran");
            TableColumn tc70 = new TableColumn(68, 80);
            tc70.setHeaderValue("bran");
            TableColumn tc71 = new TableColumn(69, 80);
            tc71.setHeaderValue("bran");
            TableColumn tc72 = new TableColumn(70, 80);
            tc72.setHeaderValue("bran");
            TableColumn tc73 = new TableColumn(71, 80);
            tc73.setHeaderValue("bran");
            TableColumn tc74 = new TableColumn(72, 80);
            tc74.setHeaderValue("bran");
            TableColumn tc75 = new TableColumn(73, 80);
            tc75.setHeaderValue("bran");
            TableColumn tc76 = new TableColumn(74, 80);
            tc76.setHeaderValue("bran");
            TableColumn tc77 = new TableColumn(75, 80);
            tc77.setHeaderValue("bran");
            TableColumn tc78 = new TableColumn(76, 80);
            tc78.setHeaderValue("bran");
            TableColumn tc79 = new TableColumn(77, 80);
            tc79.setHeaderValue("bran");
            TableColumn tc80 = new TableColumn(78, 80);
            tc80.setHeaderValue("bran");
            TableColumn tc81 = new TableColumn(79, 80);
            tc81.setHeaderValue("bran");
            TableColumn tc82 = new TableColumn(80, 80);
            tc82.setHeaderValue("bran");
            TableColumn tc83 = new TableColumn(81, 80);
            tc83.setHeaderValue("bran");
            TableColumn tc84 = new TableColumn(82, 80);
            tc84.setHeaderValue("bran");
            TableColumn tc85 = new TableColumn(83, 80);
            tc85.setHeaderValue("bran");
            TableColumn tc86 = new TableColumn(84, 80);
            tc86.setHeaderValue("bran");
            TableColumn tc87 = new TableColumn(85, 80);
            tc87.setHeaderValue("bran");
            TableColumn tc88 = new TableColumn(86, 80);
            tc88.setHeaderValue("bran");
            TableColumn tc89 = new TableColumn(87, 80);
            tc89.setHeaderValue("bran");
            TableColumn tc90 = new TableColumn(88, 80);
            tc90.setHeaderValue("bran");
            TableColumn tc91 = new TableColumn(89, 80);
            tc91.setHeaderValue("bran");
            TableColumn tc92 = new TableColumn(90, 80);
            tc92.setHeaderValue("bran");
            TableColumn tc93 = new TableColumn(91, 80);
            tc93.setHeaderValue("bran");
            TableColumn tc94 = new TableColumn(92, 80);
            tc94.setHeaderValue("bran");
            TableColumn tc95 = new TableColumn(93, 80);
            tc95.setHeaderValue("bran");
            TableColumn tc96 = new TableColumn(94, 80);
            tc96.setHeaderValue("bran");
            TableColumn tc97 = new TableColumn(95, 80);
            tc97.setHeaderValue("bran");
            TableColumn tc98 = new TableColumn(96, 80);
            tc98.setHeaderValue("bran");
            TableColumn tc99 = new TableColumn(97, 80);
            tc99.setHeaderValue("bran");
            TableColumn tc100 = new TableColumn(98, 80);
            tc100.setHeaderValue("bran");
            TableColumn tc101 = new TableColumn(99, 80);
            tc101.setHeaderValue("bran");
            TableColumn tc102 = new TableColumn(100, 80);
            tc102.setHeaderValue("bran");
            TableColumn tc103 = new TableColumn(101, 80);
            tc103.setHeaderValue("bran");
            TableColumn tc104 = new TableColumn(102, 80);
            tc104.setHeaderValue("bran");
            TableColumn tc105 = new TableColumn(103, 80);
            tc105.setHeaderValue("bran");
            TableColumn tc106 = new TableColumn(104, 80);
            ...
            tcm.getColumn(103).setCellRenderer(FormatCell.color1());
            tcm.getColumn(104).setCellRenderer(FormatCell.color1());
            ...
            String sql = "select * from tempdailysale where comname = '" + comname + "' order by tque";

            reportSumSaleLostModel treemodel = new reportSumSaleLostModel(sql, code, name);
                ...
                if (!this.code.equals("All")) {
                    ...
                    if (chkcol <= 32) {
                        ...
                        while (rs.next()) {
                            rec += 1;
                            endrec += 3;
                            tbl.getColumnModel().getColumn(rec * 3 - 2 + 3).setHeaderValue(cvth.ASCII2Unicode("(Sale)" + rs.getString(this.code)) + "-" + cvth.ASCII2Unicode(rs.getString(this.name)));
                            tbl.getColumnModel().getColumn(rec * 3 - 1 + 3).setHeaderValue(cvth.ASCII2Unicode("(Waste)" + rs.getString(this.code)) + "-" + cvth.ASCII2Unicode(rs.getString(this.name)));
                            tbl.getColumnModel().getColumn(rec * 3 + 3).setHeaderValue(cvth.ASCII2Unicode("(%)" + rs.getString(this.code)) + "-" + cvth.ASCII2Unicode(rs.getString(this.name)));

                            if (rec % 2 == 0) {
                                tbl.getColumnModel().getColumn(rec * 3 - 2 + 3).setCellRenderer(FormatCell.color2());
                                tbl.getColumnModel().getColumn(rec * 3 - 1 + 3).setCellRenderer(FormatCell.color2());
                                tbl.getColumnModel().getColumn(rec * 3 - 0 + 3).setCellRenderer(FormatCell.color2());
                            }
                        }

                        for (int i = endrec + 1; i <= 104; i++) {
                            TableColumn tc = tbl.getColumnModel().getColumn(endrec + 1);
                            tbl.removeColumn(tc);
                        }
                    } else {
                        for (int i = 4; i <= 104; i++) {
                            TableColumn tc = tbl.getColumnModel().getColumn(4);
                            tbl.removeColumn(tc);
                        }
                    }
                } else {
                    ...
                    tbl.getColumnModel().getColumn(4).setHeaderValue("(Sale)");
                    tbl.getColumnModel().getColumn(5).setHeaderValue("(Waste)");
                    tbl.getColumnModel().getColumn(6).setHeaderValue("(%)");
                }
            } else if (!this.code.equals("All")) {
                int chkcol = getBranchcount(sql);
                if (chkcol <= 32) {
                    ResultSet rs = null;
                    Statement stmt = (Statement) dbUtility.con.createStatement();
                    ...
                    while (rs.next()) {
                        rec += 1;
                        endrec += 3;
                        tbl.getColumnModel().getColumn(rec * 3 - 2 + 3).setHeaderValue("(Sale)" + rs.getString(this.code) + "-" + rs.getString(this.name));
                        tbl.getColumnModel().getColumn(rec * 3 - 1 + 3).setHeaderValue("(Waste)" + rs.getString(this.code) + "-" + rs.getString(this.name));
                        tbl.getColumnModel().getColumn(rec * 3 + 3).setHeaderValue("(%)" + rs.getString(this.code) + "-" + rs.getString(this.name));
    ...
    private void setTemp() {
        try {
            ...
            int BranRec = 0;
            int TRjLine = 0;
            double TSum1 = 0, TSum2 = 0, TSum3 = 0, TSum4 = 0, TSum5 = 0;

            if (this.code.equals("All")) {
                //insert masterrj
                String sqlselectMasterRj = "select * from masterrj order by rjline";

                ResultSet rsMasterRj = null;
                Statement stmtMasterRj = (Statement) dbUtility.con.createStatement();
                rsMasterRj = stmtMasterRj.executeQuery(sqlselectMasterRj);

                while (rsMasterRj.next()) {
                    if (rsMasterRj.getInt("rjline") <= 50) {
                        String sqltemp = "insert into tempdailysale(tque,tcode,tdept,tname,comname) values(?,?,?,?,?)";
                        PreparedStatement prm = (PreparedStatement) db.con.prepareStatement(sqltemp);
                        prm.setInt(1, rsMasterRj.getInt("rjline"));
                        prm.setString(2, rsMasterRj.getString("rjno"));
                        prm.setString(3, rsMasterRj.getString("dept"));
                        prm.setString(4, rsMasterRj.getString("tdesc"));
                        prm.setString(5, comname);
                        prm.executeUpdate();
                    }
                }
                rsMasterRj.close();
                String sqlinserttemp = "insert into tempdailysale(tque,tcode,tdept,tname,comname) values(?,?,?,?,?)";
                PreparedStatement prm = (PreparedStatement) db.con.prepareStatement(sqlinserttemp);
                prm.setInt(1, 51);
                prm.setString(2, "");
                prm.setString(3, "");
                prm.setString(4, cvth.Unicode2ASCII("ยอดขายเฉพาะในร้าน"));
                prm.setString(5, comname);
                prm.executeUpdate();

                sqlinserttemp = "insert into tempdailysale(tque,tcode,tdept,tname,comname) values(?,?,?,?,?)";
                prm = (PreparedStatement) db.con.prepareStatement(sqlinserttemp);
                prm.setInt(1, 52);
                prm.setString(2, "");
                prm.setString(3, "");
                prm.setString(4, cvth.Unicode2ASCII("ยอดขายเฉพาะ Delivery"));
                prm.setString(5, comname);
                prm.executeUpdate();
                ...
                prm.setString(2, "");
                prm.setString(3, "");
                prm.setString(4, cvth.Unicode2ASCII("ยอดขายเฉพาะ Pinto"));
                prm.setString(5, comname);
                prm.executeUpdate();
                ...
                prm.setString(2, "");
                prm.setString(3, "");
                prm.setString(4, cvth.Unicode2ASCII("จำนวนลูกค้า"));
                prm.setString(5, comname);
                prm.executeUpdate();
                ...
                TSum5 = 0;
                //Data 1 From rj file
                String sql2 = "SELECT rjno,rjline,dept,account,sub,descname"
                        + ",d.dept as PGroupCode,b.code as BranchCode,b.btype as BtypeCode,b.barea as BAreacode"
                        ...
                        + ",sum(mac1) as mac1,sum(mac2) as mac2,sum(mac3) as mac3,sum(total) as total "
                        + "FROM drjfile d "
                        + "left join branfile b on d.brcode = b.code "
                        + "left join groupfile gf on d.dept = gf.groupcode "
                        + "where "
                ...
                if (rs2.getRow() > 0) {
                    do {
                        BranRec = 0;
                        BranRec = (BranRec * 3) + 3;
                        Branfield = "bran" + (BranRec - 2);
                        Branfield2 = "bran" + (BranRec - 1);
                        Branfield3 = "bran" + BranRec;
                        TotField = "bran" + (TotRec + 1);
                        if (rs2.getInt("rjline") <= 50) {
                            TRjLine = rs2.getInt("rjline");
                            TAmount = rs2.getDouble("total");
                            TSum5 += rs2.getDouble("total");
                            String sqlupdate = "update tempdailysale set " + Branfield + " = ?  where tque = ? and comname = ?";
                            PreparedStatement prm2 = (PreparedStatement) db.con.prepareStatement(sqlupdate);
                            prm2.setDouble(1, TAmount);
                            prm2.setInt(2, TRjLine);
                ...
                //Data (2) ยอดของเสีย
                String sqlStock = "SELECT pdesc,pprice11,punit1,pgroup,d.r_pcode as pcode,sum(r_amount) "
                        ...
                        + "group by pgroup "
                        + "having pgroup is not null "
                        + "order by pgroup ";

                ResultSet rsStock = null;
                BranRec = 0;
                TempKey = "";
                Statement stmtStock = (Statement) dbUtility.con.createStatement();
                rsStock = stmtStock.executeQuery(sqlStock);
                rsStock.first();
                if (rsStock.getRow() > 0) {
                    do {
                        BranRec = 0;
                        ...
                        Branfield3 = "bran" + BranRec;
                        TotField = "bran" + (TotRec + 1);
                        String TempDept = rsStock.getString("pgroup").substring(2, 4);
                        TAmount = rsStock.getDouble("sum(r_amount)");
                        System.out.println(rsStock.getString("pgroup") + "...." + TempDept + "....." + TAmount);
                        String sqlupdate = "update tempdailysale set " + Branfield2 + " = ?  where tdept=? and comname = ?";
                        PreparedStatement prm2 = (PreparedStatement) db.con.prepareStatement(sqlupdate);
                        prm2.setDouble(1, TAmount);
                        prm2.setString(2, TempDept);
                        prm2.setString(3, comname);
                        prm2.executeUpdate();
                    } while (rsStock.next());
                }
                rsStock.close();
                //(3) % ของเสีย
                String Tdaily = "select * from tempdailysale order by tque";
                ResultSet rsTdaily = null;
                Statement stmtTdaily = (Statement) dbUtility.con.createStatement();
                rsTdaily = stmtTdaily.executeQuery(Tdaily);

                while (rsTdaily.next()) {
                    if (rsTdaily.getInt("tque") < 11) {
                        TSum1 += rsTdaily.getDouble(Branfield2);
                    } else if (rsTdaily.getInt("tque") > 11 && rsTdaily.getInt("tque") < 22) {
                        TSum2 += rsTdaily.getDouble(Branfield2);
                    } else if (rsTdaily.getInt("tque") > 22 && rsTdaily.getInt("tque") < 30) {
                        TSum3 += rsTdaily.getDouble(Branfield2);
                    } else if (rsTdaily.getInt("tque") > 30 && rsTdaily.getInt("tque") < 43) {
                        TSum4 += rsTdaily.getDouble(Branfield2);
                    }
                }
                rsTdaily.close();

                TRjLine = 11;
                String sqlupdate = "update tempdailysale set " + Branfield2 + " = ?  where tque = ? and comname = ?";
                PreparedStatement prm2 = (PreparedStatement) db.con.prepareStatement(sqlupdate);
                ...
                TRjLine = 22;
                sqlupdate = "update tempdailysale set " + Branfield2 + " = ?  where tque = ? and comname = ?";
                prm2 = (PreparedStatement) db.con.prepareStatement(sqlupdate);
                prm2.setDouble(1, TSum2);
                prm2.setInt(2, TRjLine);
                prm2.setString(3, comname);
                prm2.executeUpdate();
                ...
                sqlupdate = "update tempdailysale set " + Branfield2 + " = ?  where tque = ? and comname = ?";
                prm2 = (PreparedStatement) db.con.prepareStatement(sqlupdate);
                prm2.setDouble(1, TSum1 + TSum2 + TSum3 + TSum4);
                prm2.setInt(2, TRjLine);
                prm2.setString(3, comname);
                prm2.executeUpdate();
                ...
                stmtTdaily = (Statement) dbUtility.con.createStatement();
                rsTdaily = stmtTdaily.executeQuery(Tdaily);

                while (rsTdaily.next()) {
                    if (rsTdaily.getDouble(Branfield) != 0) {
                        TRjLine = rsTdaily.getInt("tque");
                        TAmount = (rsTdaily.getDouble(Branfield2) / rsTdaily.getDouble(Branfield)) * 100;

                        sqlupdate = "update tempdailysale set " + Branfield3 + " = ?  where tque = ? and comname = ?";
                        prm2 = (PreparedStatement) db.con.prepareStatement(sqlupdate);
                        prm2.setDouble(1, TAmount);
                        prm2.setInt(2, TRjLine);
                        prm2.setString(3, comname);
                ...
                //Data (4)
                String sqlTer = "";
                sqlTer = "SELECT sum(pcust),sum(delivery),sum(pinto),sum(eatin),sum(takeaway),sum(whole) "
                        + ",b.code as BranchCode,b.btype as BtypeCode,b.barea as BAreacode"
                        + ",b.bsize as BSizecode,b.bplane as BPlancode,b.bstore as BStorecode,b.companycode as Companycode"
                        + ",b.brandcode as Brandcode,b.buscode as Bustypecode "
                        + "FROM dterminal d "
                ...
                ResultSet rsTer = null;
                TSum1 = 0;
                TSum2 = 0;
                TSum3 = 0;
                TSum4 = 0;
                Statement stmtTer = (Statement) dbUtility.con.createStatement();
                rsTer = stmtTer.executeQuery(sqlTer);
                rsTer.first();
                if (rsTer.getRow() > 0) {
                    do {
                        BranRec = 0;
                        ...
                        TSum1 = rsTer.getDouble("sum(pcust)");
                        TSum2 = rsTer.getDouble("sum(delivery)");
                        TSum3 = rsTer.getDouble("sum(pinto)");
                        TSum4 = (rsTer.getDouble("sum(eatin)") + rsTer.getDouble("sum(takeaway)") + rsTer.getDouble("sum(whole)"));

                        TRjLine = 51;
                        sqlupdate = "update tempdailysale set " + Branfield + " = ?  where tque = ? and comname = ?";
                        prm2 = (PreparedStatement) db.con.prepareStatement(sqlupdate);
                        prm2.setDouble(1, TSum4);
                        prm2.setInt(2, TRjLine);
                        prm2.setString(3, comname);
                ...
                sql = "SELECT b.*"
                        ...
                        + ",b.brandcode as Brandcode,b.buscode as Bustypecode "
                        + "FROM branfile b "
                        + "inner join drjfile df on b.code=df.brcode and rjline=1 "
                        ...
                        + "where "
                        + "df.tdate>= '" + d1 + "' and df.tdate<='" + d2 + "' "
                        + "and b.code >= '" + cvth.Unicode2ASCII(branch1) + "' and b.code <= '" + branch2 + "' "
                        ...
                        + "group by " + this.code + " order by " + this.code + " ";
                BranArray = new String[100];
                ...
                if (TotRec <= 33) {
                    ...
                    prm.setString(5, comname);
                    prm.executeUpdate();
                    //Start Input Data To Tempdailysale..........................................
                    //Data 1 From rj file
                    String sql2 = "SELECT rjno,rjline,dept,account,sub,descname"
                            + ",d.dept as PGroupCode,b.code as BranchCode,b.btype as BtypeCode,b.barea as BAreacode"
                            + ",b.bsize as BSizecode,b.bplane as BPlancode,b.bstore as BStorecode,b.companycode as Companycode"
                    ...
                    if (rs2.getRow() > 0) {
                        do {
                            if (getIndex(rs2.getString(code)) >= 0) {
                                if (!TempKey.equals(rs2.getString(code))) {
                                    TempKey = rs2.getString(code);
                                    BranRec = getIndex(TempKey);
                                    BranRec = (BranRec * 3) + 3;
                                    Branfield = "bran" + (BranRec - 2);
                                    Branfield2 = "bran" + (BranRec - 1);
                                    Branfield3 = "bran" + BranRec;
                    ...
                    String sqlStock = "SELECT pdesc,pprice11,punit1,pgroup,d.r_pcode as pcode,sum(r_amount) "
                            ...
                            + "and b.buscode >= '" + cvth.Unicode2ASCII(bustype1) + "' and b.buscode <= '" + cvth.Unicode2ASCII(bustype2) + "' "
                            + "and locate(dayofweek(d.r_date),'" + strday + "')>0 "
                            + "group by " + this.code + ",pgroup "
                            + "having pgroup is not null "
                            + "order by " + this.code + ",pgroup ";
                    ...
                    if (rsStock.getRow() > 0) {
                        do {
                            if (getIndex(rsStock.getString(code)) >= 0) {
                                if (!TempKey.equals(rsStock.getString(code))) {
                                    TempKey = rsStock.getString(code);
                                    BranRec = getIndex(TempKey);
                                    BranRec = (BranRec * 3) + 3;
                                    Branfield = "bran" + (BranRec - 2);
                                    Branfield2 = "bran" + (BranRec - 1);
                    ...
                    if (rsTer.getRow() > 0) {
                        do {
                            if (getIndex(rsTer.getString(code)) >= 0) {
                                if (!TempKey.equals(rsTer.getString(code))) {
                                    TempKey = rsTer.getString(code);
                                    BranRec = getIndex(TempKey);
                                    BranRec = (BranRec * 3) + 3;
                                    Branfield = "bran" + (BranRec - 2);
                                    Branfield2 = "bran" + (BranRec - 1);
    ...
    private int getBranchcount(String sql) {
        ...
        try {
            ...
            while (rs.next()) {
                row++;
                BranArray[row - 1] = rs.getString(code);
            }
    ...
    private int getIndex(String TempKey) {
        int retval = -1;
        for (int i = 0; i < BranArray.length; i++) {
            if (TempKey.equals(BranArray[i])) {
                retval = i;
            }
        }
        return retval;
