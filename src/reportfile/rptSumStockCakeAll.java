...
import reportModel.reportSumStockCakeAllModel;
 ...
 * @author s386
 */
public class rptSumStockCakeAll extends javax.swing.JDialog {

    /**
     * Creates new form rptSumStockCakeAll
     */
    ...
    String frmName = "rptSumStockCakeAll";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    public rptSumStockCakeAll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumStockCakeAll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumStockCakeAll dialog = new rptSumStockCakeAll(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
            ...
            TableColumn tc2 = new TableColumn(0,150);
            tc2.setHeaderValue("Group");
            TableColumn tc3 = new TableColumn(1,100);
            tc3.setHeaderValue("รหัสสินค้า (PLU)");
            TableColumn tc4 = new TableColumn(2,200);
            tc4.setHeaderValue("ชื่อสินค้า / รายการ");
            TableColumn tc5 = new TableColumn(3,100);
           ...
           sql = "SELECT s_bran,name,pdesc,punit1,pgroup,d.pcode as pcode,adjeod"
            ...
            else
            {
                sql = "SELECT s_bran,name,pdesc,punit1,pgroup,d.pcode as pcode,adjeod"
                        ...
                        + "and p.pstock = 'Y' "
                        + "and ((Bod<>0) or (PBuy<>0) or (Rec<>0) or (TFR<>0) or (WID<>0) or (Sal<>0) or (RET<>0) or (PRET<>0) or (RFN<>0) or (ADJ<>0) or (EOD<>0) ) "
                        +"group by pgroup,pcode order by pgroup,pcode";
            }
            reportSumStockCakeAllModel treemodel = new reportSumStockCakeAllModel(sql);
