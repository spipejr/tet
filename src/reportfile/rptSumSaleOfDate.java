...
import reportModel.reportSumSaleOfDateModel;
 ...
 * @author s386
 */
public class rptSumSaleOfDate extends javax.swing.JDialog {

    /**
     * Creates new form rptSumSaleOfDate
     */
    ...
    String frmName = "rptSumSaleOfDate";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition="";
    public rptSumSaleOfDate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumSaleOfDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumSaleOfDate dialog = new rptSumSaleOfDate(new javax.swing.JFrame(), true);
...
//        tcm.getColumn(30).setCellRenderer(r);
        ...
        tbl.setRowHeight(24);
            ...
            sql = "SELECT s_date,punit1,s_price,pdesc,s_pcode,pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        ...
                        +"group by "+code+",s_date,s_pcode order by "+code+",s_date,pgroup,s_pcode";
            ...
            reportSumSaleOfDateModel treemodel = new reportSumSaleOfDateModel(sql,code,name);
