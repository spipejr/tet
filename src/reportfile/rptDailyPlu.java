 ...
 * @author s386
 */
public class rptDailyPlu extends javax.swing.JDialog {
    ...
    public rptDailyPlu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptDailyPlu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptDailyPlu dialog = new rptDailyPlu(new javax.swing.JFrame(), true);
    ...
    private void inittbl() {
        try {
            ...
            reportDailyPluModel treemodel = new reportDailyPluModel(sql, code, name);
        ...
        try {
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                ...
                if (TotRec > 0 && TotRec <= 100) {
                    ...
                    sql = "SELECT pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
