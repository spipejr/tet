...
import reportModel.reportRjfileModel;
 ...
 * @author s386
 */
public class rptRjfile extends javax.swing.JDialog {
    ...
    String frmName = "rptRjfile";
    String condition = "";
    ThaiUtilities cvth = new ThaiUtilities();
    public rptRjfile(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptRjfile dialog = new rptRjfile(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
            ...
            TableColumn tc3 = new TableColumn(3,50);
            tc3.setHeaderValue("DEPT");
            TableColumn tc4 = new TableColumn(4,80);
            tc4.setHeaderValue("Acc-No");
            TableColumn tc5 = new TableColumn(5,80);
            tc5.setHeaderValue("Sub-Acc");
            TableColumn tc6 = new TableColumn(6,250);
            tc6.setHeaderValue("Description");
            TableColumn tc7 = new TableColumn(7,100);
            tc7.setHeaderValue("Mac1");
            TableColumn tc8 = new TableColumn(8,100);
            tc8.setHeaderValue("Mac2");
            TableColumn tc9 = new TableColumn(9,100);
            tc9.setHeaderValue("Mac3");
            TableColumn tc10 = new TableColumn(10,100);
            tc10.setHeaderValue("รวมทุกเครื่อง");
            TableColumn tc11 = new TableColumn(1,100);
            tc11.setHeaderValue("วันที่");
...
//            tcm.addColumn(tc31);
        ...
        tbl.setRowHeight(24);
            ...
            {
            sql = "SELECT name,d.* FROM drjfile d inner join branfile b on d.brcode = b.code "
            ...
            reportRjfileModel treemodel = new reportRjfileModel(sql);
