...
import reportModel.reportTempDailySale2Model;
 ...
 * @author s386
 */
public class rptDailyPluSum2 extends javax.swing.JDialog {

    /**
     * Creates new form rptDailyPluSum2
     */
    ...
    String frmName = "rptDailyPluSum2";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();
    public rptDailyPluSum2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptDailyPluSum2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptDailyPluSum2 dialog = new rptDailyPluSum2(new javax.swing.JFrame(), true);
    ...
    // End of variables declaration//GEN-END:variables
        ...
        try {
            ...
            TableColumn tc5 = new TableColumn(6, 80);
            ...
            TableColumn tc15 = new TableColumn(14, 80);
            tc15.setHeaderValue("bran");
            TableColumn tc16 = new TableColumn(15, 80);
            tc16.setHeaderValue("bran");
            TableColumn tc17 = new TableColumn(16, 80);
            tc17.setHeaderValue("bran");
            TableColumn tc18 = new TableColumn(17, 80);
            tc18.setHeaderValue("bran");
            TableColumn tc19 = new TableColumn(18, 80);
            tc19.setHeaderValue("bran");
            TableColumn tc20 = new TableColumn(19, 80);
            tc20.setHeaderValue("bran");
            TableColumn tc21 = new TableColumn(20, 80);
            tc21.setHeaderValue("bran");
            TableColumn tc22 = new TableColumn(21, 80);
            tc22.setHeaderValue("bran");
            TableColumn tc23 = new TableColumn(22, 80);
            tc23.setHeaderValue("bran");
            TableColumn tc24 = new TableColumn(23, 80);
            tc24.setHeaderValue("bran");
            TableColumn tc25 = new TableColumn(24, 80);
            tc25.setHeaderValue("bran");
            TableColumn tc26 = new TableColumn(25, 80);
            tc26.setHeaderValue("bran");
            TableColumn tc27 = new TableColumn(26, 80);
            tc27.setHeaderValue("bran");
            TableColumn tc28 = new TableColumn(27, 80);
            tc28.setHeaderValue("bran");
            TableColumn tc29 = new TableColumn(28, 80);
            tc29.setHeaderValue("bran");
            TableColumn tc30 = new TableColumn(29, 80);
            tc30.setHeaderValue("bran");
            TableColumn tc31 = new TableColumn(30, 80);
            tc31.setHeaderValue("bran");
            TableColumn tc32 = new TableColumn(31, 80);
            tc32.setHeaderValue("bran");
            TableColumn tc33 = new TableColumn(32, 80);
            tc33.setHeaderValue("bran");
            TableColumn tc34 = new TableColumn(33, 80);
            tc34.setHeaderValue("bran");
            TableColumn tc35 = new TableColumn(34, 80);
            tc35.setHeaderValue("bran");
            TableColumn tc36 = new TableColumn(35, 80);
            tc36.setHeaderValue("bran");
            TableColumn tc37 = new TableColumn(36, 80);
            tc37.setHeaderValue("bran");
            TableColumn tc38 = new TableColumn(37, 80);
            tc38.setHeaderValue("bran");
            TableColumn tc39 = new TableColumn(38, 80);
            tc39.setHeaderValue("bran");
            TableColumn tc40 = new TableColumn(39, 80);
            tc40.setHeaderValue("bran");
            TableColumn tc41 = new TableColumn(40, 80);
            tc41.setHeaderValue("bran");
            TableColumn tc42 = new TableColumn(41, 80);
            tc42.setHeaderValue("bran");
            TableColumn tc43 = new TableColumn(42, 80);
            tc43.setHeaderValue("bran");
            TableColumn tc44 = new TableColumn(43, 80);
            tc44.setHeaderValue("bran");
            TableColumn tc45 = new TableColumn(44, 80);
            tc45.setHeaderValue("bran");
            TableColumn tc46 = new TableColumn(45, 80);
            tc46.setHeaderValue("bran");
            TableColumn tc47 = new TableColumn(46, 80);
            tc47.setHeaderValue("bran");
            TableColumn tc48 = new TableColumn(47, 80);
            tc48.setHeaderValue("bran");
            TableColumn tc49 = new TableColumn(48, 80);
            tc49.setHeaderValue("bran");
            TableColumn tc50 = new TableColumn(49, 80);
            tc50.setHeaderValue("bran");
            TableColumn tc51 = new TableColumn(50, 80);
            tc51.setHeaderValue("bran");
            TableColumn tc52 = new TableColumn(51, 80);
            tc52.setHeaderValue("bran");
            TableColumn tc53 = new TableColumn(52, 80);
            tc53.setHeaderValue("bran");
            TableColumn tc54 = new TableColumn(53, 80);
            tc54.setHeaderValue("bran");
            TableColumn tc55 = new TableColumn(54, 80);
            tc55.setHeaderValue("bran");
            TableColumn tc56 = new TableColumn(55, 80);
            tc56.setHeaderValue("bran");
            TableColumn tc57 = new TableColumn(56, 80);
            tc57.setHeaderValue("bran");
            TableColumn tc58 = new TableColumn(57, 80);
            tc58.setHeaderValue("bran");
            TableColumn tc59 = new TableColumn(58, 80);
            tc59.setHeaderValue("bran");
            TableColumn tc60 = new TableColumn(59, 80);
            tc60.setHeaderValue("bran");
            TableColumn tc61 = new TableColumn(60, 80);
            tc61.setHeaderValue("bran");
            TableColumn tc62 = new TableColumn(61, 80);
            tc62.setHeaderValue("bran");
            TableColumn tc63 = new TableColumn(62, 80);
            tc63.setHeaderValue("bran");
            TableColumn tc64 = new TableColumn(63, 80);
            tc64.setHeaderValue("bran");
            TableColumn tc65 = new TableColumn(64, 80);
            tc65.setHeaderValue("bran");
            TableColumn tc66 = new TableColumn(65, 80);
            tc66.setHeaderValue("bran");
            TableColumn tc67 = new TableColumn(66, 80);
            tc67.setHeaderValue("bran");
            TableColumn tc68 = new TableColumn(67, 80);
            tc68.setHeaderValue("bran");
            TableColumn tc69 = new TableColumn(68, 80);
            tc69.setHeaderValue("bran");
            TableColumn tc70 = new TableColumn(69, 80);
            tc70.setHeaderValue("bran");
            TableColumn tc71 = new TableColumn(70, 80);
            tc71.setHeaderValue("bran");
            TableColumn tc72 = new TableColumn(71, 80);
            tc72.setHeaderValue("bran");
            TableColumn tc73 = new TableColumn(72, 80);
            tc73.setHeaderValue("bran");
            TableColumn tc74 = new TableColumn(73, 80);
            tc74.setHeaderValue("bran");
            TableColumn tc75 = new TableColumn(74, 80);
            tc75.setHeaderValue("bran");
            TableColumn tc76 = new TableColumn(75, 80);
            tc76.setHeaderValue("bran");
            TableColumn tc77 = new TableColumn(76, 80);
            tc77.setHeaderValue("bran");
            TableColumn tc78 = new TableColumn(77, 80);
            tc78.setHeaderValue("bran");
            TableColumn tc79 = new TableColumn(78, 80);
            tc79.setHeaderValue("bran");
            TableColumn tc80 = new TableColumn(79, 80);
            tc80.setHeaderValue("bran");
            TableColumn tc81 = new TableColumn(80, 80);
            tc81.setHeaderValue("bran");
            TableColumn tc82 = new TableColumn(81, 80);
            tc82.setHeaderValue("bran");
            TableColumn tc83 = new TableColumn(82, 80);
            tc83.setHeaderValue("bran");
            TableColumn tc84 = new TableColumn(83, 80);
            tc84.setHeaderValue("bran");
            TableColumn tc85 = new TableColumn(84, 80);
            tc85.setHeaderValue("bran");
            TableColumn tc86 = new TableColumn(85, 80);
            tc86.setHeaderValue("bran");
            TableColumn tc87 = new TableColumn(86, 80);
            tc87.setHeaderValue("bran");
            TableColumn tc88 = new TableColumn(87, 80);
            tc88.setHeaderValue("bran");
            TableColumn tc89 = new TableColumn(88, 80);
            tc89.setHeaderValue("bran");
            TableColumn tc90 = new TableColumn(89, 80);
            tc90.setHeaderValue("bran");
            TableColumn tc91 = new TableColumn(90, 80);
            tc91.setHeaderValue("bran");
            TableColumn tc92 = new TableColumn(91, 80);
            tc92.setHeaderValue("bran");
            TableColumn tc93 = new TableColumn(92, 80);
            tc93.setHeaderValue("bran");
            TableColumn tc94 = new TableColumn(93, 80);
            tc94.setHeaderValue("bran");
            TableColumn tc95 = new TableColumn(94, 80);
            tc95.setHeaderValue("bran");
            TableColumn tc96 = new TableColumn(95, 80);
            tc96.setHeaderValue("bran");
            TableColumn tc97 = new TableColumn(96, 80);
            tc97.setHeaderValue("bran");
            TableColumn tc98 = new TableColumn(97, 80);
            tc98.setHeaderValue("bran");
            TableColumn tc99 = new TableColumn(98, 80);
            tc99.setHeaderValue("bran");
            TableColumn tc100 = new TableColumn(99, 80);
            tc100.setHeaderValue("bran");
            TableColumn tc101 = new TableColumn(100, 80);
            tc101.setHeaderValue("bran");
            TableColumn tc102 = new TableColumn(101, 80);
            tc102.setHeaderValue("bran");
            TableColumn tc103 = new TableColumn(102, 80);
            tc103.setHeaderValue("bran");
            TableColumn tc104 = new TableColumn(103, 80);
            tc104.setHeaderValue("bran");
            TableColumn tc105 = new TableColumn(104, 80);
            tc105.setHeaderValue("bran");
            TableColumn tc106 = new TableColumn(105, 80);
            ...
            tcm.getColumn(3).setCellRenderer(FormatCell.r());
            ...
            tcm.getColumn(105).setCellRenderer(FormatCell.color1());
            ...
            reportTempDailySale2Model treemodel = new reportTempDailySale2Model(sql, code, name);
            ...
            if (!dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                if (!this.code.equals("All")) {
                    ...
                    if (chkcol <= 100) {
                        ...
                        while (rs.next()) {
                            rec += 1;
                            tbl.getColumnModel().getColumn(rec).setHeaderValue(cvth.ASCII2Unicode(rs.getString(this.code)) + "-" + cvth.ASCII2Unicode(rs.getString(this.name)));
                        }
                        rec += 1;
                        tbl.getColumnModel().getColumn(rec).setHeaderValue("Total");
                        tbl.getColumnModel().getColumn(rec).setCellRenderer(FormatCell.color2());
                        int temprec = 105 - rec;
                        for (int i = rec + 1; i <= 105; i++) {
                            TableColumn tc = tbl.getColumnModel().getColumn(rec + 1);
                            tbl.removeColumn(tc);
                        }
                    } else {
                        for (int i = 5; i <= 105; i++) {
                            TableColumn tc = tbl.getColumnModel().getColumn(5);
                            tbl.removeColumn(tc);
                        }
                    }
                } else {
                    tbl.getColumnModel().getColumn(6).setHeaderValue("Total");
                    tbl.getColumnModel().getColumn(6).setCellRenderer(FormatCell.color2());
                    for (int i = 7; i <= 105; i++) {
                ...
                if (!this.code.equals("All")) {
                    ...
                    if (chkcol <= 100) {
                        ...
                        while (rs.next()) {
                            rec += 1;
                            tbl.getColumnModel().getColumn(rec).setHeaderValue(rs.getString(this.code) + "-" + rs.getString(this.name));
                        }
                        rec += 1;
                        tbl.getColumnModel().getColumn(rec).setHeaderValue("Total");
                        tbl.getColumnModel().getColumn(rec).setCellRenderer(FormatCell.color2());
        ...
        try {
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                ...
                if (this.code.equals("All")) {
                    ...
                    String sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                    ...
                    while (rs2.next()) {
                        ...
                        if (!chkTemp(TempCode)) {
                            ...
                            String sqlupdate = "update tempdailysale set " + Branfield + " = ?," + TotField + "=" + TotField + "+?  where tcode = ? and comname = ?";
                    ...
                    String sqlselecttemp = "select * from tempdailysale where comname = '"+comname+"' group by tgroup";
            ResultSet rs4 = null;
            Statement stmt4 = (Statement) dbUtility.con.createStatement();
            rs4 = stmt4.executeQuery(sqlselecttemp);
             while(rs4.next())
             {
                 TempBran = rs4.getString("tgroup");
                 TBranName = rs4.getString("tname");
                 
                 String sql3 = "select * from budfastival d "
                ...
                while(rs5.next())
                {
                    ...
                    if (TotRec <= 100) {
                        ...
                        while (rs.next()) {
                            ...
                            Branfield = "bran" + BranRec;
                            TotField = "bran" + (TotRec + 1);
                            String sql2 = "";
                            if (this.code.equals("BranchCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        + ",b.code as BranchCode,b.btype as BtypeCode,b.barea as BAreacode"
                                        ...
                                        + "t.plugroup = '" + tfast +"' "
                                        + "and d.s_date>= '" + d1 + "' and d.s_date<='" + d2 + "' "
                                        + "and d.s_bran >= '" + TempBran + "' and d.s_bran <= '" + TempBran + "' "
                                        + "and b.btype >= '" + btype1 + "' and b.btype <= '" + btype2 + "' "
                                        + "and b.barea >= '" + barea1 + "' and b.barea <= '" + barea2 + "' "
                                        + "and b.bsize >= '" + bsize1 + "' and b.bsize <= '" + bsize2 + "' "
                                        + "and b.bplane >= '" + bplan1 + "' and b.bplane <= '" + bplan2 + "' "
                                        ...
                                        + "and b.buscode >= '" + bustype1 + "' and b.buscode <= '" + bustype2 + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                        + "group by " + this.code + ",d.s_pcode "
                                        + "order by " + this.code + ",d.s_pcode";


                            } else if (this.code.equals("BtypeCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and d.s_date>= '" + d1 + "' and d.s_date<='" + d2 + "' "
                                        + "and d.s_bran >= '" + branch1 + "' and d.s_bran <= '" + branch2 + "' "
                                        + "and b.btype >= '" + TempBran + "' and b.btype <= '" + TempBran + "' "
                                        + "and b.barea >= '" + barea1 + "' and b.barea <= '" + barea2 + "' "
                                        + "and b.bsize >= '" + bsize1 + "' and b.bsize <= '" + bsize2 + "' "
                                        + "and b.bplane >= '" + bplan1 + "' and b.bplane <= '" + bplan2 + "' "
                                        + "and b.bstore >= '" + bstore1 + "' and b.bstore <= '" + bstore2 + "' "
                            ...
                            } else if (this.code.equals("BAreaCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and d.s_bran >= '" + branch1 + "' and d.s_bran <= '" + branch2 + "' "
                                        + "and b.btype >= '" + btype1 + "' and b.btype <= '" + btype2 + "' "
                                        + "and b.barea >= '" + TempBran + "' and b.barea <= '" + TempBran + "' "
                                        + "and b.bsize >= '" + bsize1 + "' and b.bsize <= '" + bsize2 + "' "
                                        + "and b.bplane >= '" + bplan1 + "' and b.bplane <= '" + bplan2 + "' "
                                        + "and b.bstore >= '" + bstore1 + "' and b.bstore <= '" + bstore2 + "' "
                                        + "and b.companycode >= '" + company1 + "' and b.companycode <= '" + company2 + "' "
                            ...
                            } else if (this.code.equals("BSizeCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and b.btype >= '" + btype1 + "' and b.btype <= '" + btype2 + "' "
                                        + "and b.barea >= '" + barea1 + "' and b.barea <= '" + barea2 + "' "
                                        + "and b.bsize >= '" + TempBran + "' and b.bsize <= '" + TempBran + "' "
                                        + "and b.bplane >= '" + bplan1 + "' and b.bplane <= '" + bplan2 + "' "
                                        + "and b.bstore >= '" + bstore1 + "' and b.bstore <= '" + bstore2 + "' "
                                        + "and b.companycode >= '" + company1 + "' and b.companycode <= '" + company2 + "' "
                                        + "and b.brandcode >= '" + brand1 + "' and b.brandcode <= '" + brand2 + "' "
                            ...
                            }else if (this.code.equals("BPlanCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and b.barea >= '" + barea1 + "' and b.barea <= '" + barea2 + "' "
                                        + "and b.bsize >= '" + bsize1 + "' and b.bsize <= '" + bsize2 + "' "
                                        + "and b.bplane >= '" + TempBran + "' and b.bplane <= '" + TempBran + "' "
                                        + "and b.bstore >= '" + bstore1 + "' and b.bstore <= '" + bstore2 + "' "
                                        + "and b.companycode >= '" + company1 + "' and b.companycode <= '" + company2 + "' "
                                        + "and b.brandcode >= '" + brand1 + "' and b.brandcode <= '" + brand2 + "' "
                                        + "and b.buscode >= '" + bustype1 + "' and b.buscode <= '" + bustype2 + "' "
                            ...
                            }else if (this.code.equals("BStoreCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and b.bsize >= '" + bsize1 + "' and b.bsize <= '" + bsize2 + "' "
                                        + "and b.bplane >= '" + bplan1 + "' and b.bplane <= '" + bplan2 + "' "
                                        + "and b.bstore >= '" + TempBran + "' and b.bstore <= '" + TempBran + "' "
                                        + "and b.companycode >= '" + company1 + "' and b.companycode <= '" + company2 + "' "
                                        + "and b.brandcode >= '" + brand1 + "' and b.brandcode <= '" + brand2 + "' "
                                        + "and b.buscode >= '" + bustype1 + "' and b.buscode <= '" + bustype2 + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                            ...
                            }else if (this.code.equals("CompanyCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and b.bplane >= '" + bplan1 + "' and b.bplane <= '" + bplan2 + "' "
                                        + "and b.bstore >= '" + bstore1 + "' and b.bstore <= '" + bstore2 + "' "
                                        + "and b.companycode >= '" + TempBran + "' and b.companycode <= '" + TempBran + "' "
                                        + "and b.brandcode >= '" + brand1 + "' and b.brandcode <= '" + brand2 + "' "
                                        + "and b.buscode >= '" + bustype1 + "' and b.buscode <= '" + bustype2 + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                        + "group by " + this.code + ",d.s_pcode "
                            ...
                            }else if (this.code.equals("BrandCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and b.bstore >= '" + bstore1 + "' and b.bstore <= '" + bstore2 + "' "
                                        + "and b.companycode >= '" + company1 + "' and b.companycode <= '" + company2 + "' "
                                        + "and b.brandcode >= '" + TempBran + "' and b.brandcode <= '" + TempBran + "' "
                                        + "and b.buscode >= '" + bustype1 + "' and b.buscode <= '" + bustype2 + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                        + "group by " + this.code + ",d.s_pcode "
                                        + "order by " + this.code + ",d.s_pcode";
                            ...
                            }else if (this.code.equals("BustypeCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        ...
                                        + "and b.companycode >= '" + company1 + "' and b.companycode <= '" + company2 + "' "
                                        + "and b.brandcode >= '" + brand1 + "' and b.brandcode <= '" + brand2 + "' "
                                        + "and b.buscode >= '" + TempBran + "' and b.buscode <= '" + TempBran + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                        + "group by " + this.code + ",d.s_pcode "
                                        + "order by " + this.code + ",d.s_pcode";
             ...
             while(rs4.next())
             {
                    ...
                    if(!chkTemp(TempCode))
                       {
                        ...
                        JOptionPane.showMessageDialog(this, "จำนวนสาขามากกว่า 100 สาขา ไม่สามาแสดงได้... กรุณาแสดงทีละกลุ่ม");
                    }
                ...
                if (this.code.equals("All")) {
                    ...
                    String sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                            ...
                            + "left join company com on b.companycode = com.code "
                            + "where "
                            + "t.plugroup = '" + cvth.Unicode2ASCII(tfast) +"' "
                            + "and d.s_date>= '" + d1 + "' and d.s_date<='" + d2 + "' "
            ...
            rs4 = stmt4.executeQuery(sqlselecttemp);
             while(rs4.next())
             {
                 ...
                 String sql3 = "select * from budfastival d "
                        ...
                        + "left join company com on b.companycode = com.code "
                        +"where " 
                        +"plugroup =  '"+cvth.Unicode2ASCII(tfast)+"'";
                        ...
                        while (rs.next()) {
                            ...
                            if (this.code.equals("BranchCode")) {
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "t.plugroup = '" + cvth.Unicode2ASCII(tfast) +"' "
                                        + "and d.s_date>= '" + d1 + "' and d.s_date<='" + d2 + "' "
                                        + "and d.s_bran >= '" + cvth.Unicode2ASCII(TempBran) + "' and d.s_bran <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.btype >= '" + cvth.Unicode2ASCII(btype1) + "' and b.btype <= '" + cvth.Unicode2ASCII(btype2) + "' "
                                        + "and b.barea >= '" + cvth.Unicode2ASCII(barea1) + "' and b.barea <= '" + cvth.Unicode2ASCII(barea2) + "' "
                                        + "and b.bsize >= '" + cvth.Unicode2ASCII(bsize1) + "' and b.bsize <= '" + cvth.Unicode2ASCII(bsize2) + "' "
                                        + "and b.bplane >= '" + cvth.Unicode2ASCII(bplan1) + "' and b.bplane <= '" + cvth.Unicode2ASCII(bplan2) + "' "
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and d.s_date>= '" + d1 + "' and d.s_date<='" + d2 + "' "
                                        + "and d.s_bran >= '" + cvth.Unicode2ASCII(branch1) + "' and d.s_bran <= '" + cvth.Unicode2ASCII(branch2) + "' "
                                        + "and b.btype >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.btype <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.barea >= '" + cvth.Unicode2ASCII(barea1) + "' and b.barea <= '" + cvth.Unicode2ASCII(barea2) + "' "
                                        + "and b.bsize >= '" + cvth.Unicode2ASCII(bsize1) + "' and b.bsize <= '" + cvth.Unicode2ASCII(bsize2) + "' "
                                        + "and b.bplane >= '" + cvth.Unicode2ASCII(bplan1) + "' and b.bplane <= '" + cvth.Unicode2ASCII(bplan2) + "' "
                                        + "and b.bstore >= '" + cvth.Unicode2ASCII(bstore1) + "' and b.bstore <= '" + cvth.Unicode2ASCII(bstore2) + "' "
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and d.s_bran >= '" + cvth.Unicode2ASCII(branch1) + "' and d.s_bran <= '" + cvth.Unicode2ASCII(branch2) + "' "
                                        + "and b.btype >= '" + cvth.Unicode2ASCII(btype1) + "' and b.btype <= '" + cvth.Unicode2ASCII(btype2) + "' "
                                        + "and b.barea >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.barea <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.bsize >= '" + cvth.Unicode2ASCII(bsize1) + "' and b.bsize <= '" + cvth.Unicode2ASCII(bsize2) + "' "
                                        + "and b.bplane >= '" + cvth.Unicode2ASCII(bplan1) + "' and b.bplane <= '" + cvth.Unicode2ASCII(bplan2) + "' "
                                        + "and b.bstore >= '" + cvth.Unicode2ASCII(bstore1) + "' and b.bstore <= '" + cvth.Unicode2ASCII(bstore2) + "' "
                                        + "and b.companycode >= '" + cvth.Unicode2ASCII(company1) + "' and b.companycode <= '" + cvth.Unicode2ASCII(company2) + "' "
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and b.btype >= '" + cvth.Unicode2ASCII(btype1) + "' and b.btype <= '" + cvth.Unicode2ASCII(btype2) + "' "
                                        + "and b.barea >= '" + cvth.Unicode2ASCII(barea1) + "' and b.barea <= '" + cvth.Unicode2ASCII(barea2) + "' "
                                        + "and b.bsize >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.bsize <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.bplane >= '" + cvth.Unicode2ASCII(bplan1) + "' and b.bplane <= '" + cvth.Unicode2ASCII(bplan2) + "' "
                                        + "and b.bstore >= '" + cvth.Unicode2ASCII(bstore1) + "' and b.bstore <= '" + cvth.Unicode2ASCII(bstore2) + "' "
                                        + "and b.companycode >= '" + cvth.Unicode2ASCII(company1) + "' and b.companycode <= '" + cvth.Unicode2ASCII(company2) + "' "
                                        + "and b.brandcode >= '" + cvth.Unicode2ASCII(brand1) + "' and b.brandcode <= '" + cvth.Unicode2ASCII(brand2) + "' "
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and b.barea >= '" + cvth.Unicode2ASCII(barea1) + "' and b.barea <= '" + cvth.Unicode2ASCII(barea2) + "' "
                                        + "and b.bsize >= '" + cvth.Unicode2ASCII(bsize1) + "' and b.bsize <= '" + cvth.Unicode2ASCII(bsize2) + "' "
                                        + "and b.bplane >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.bplane <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.bstore >= '" + cvth.Unicode2ASCII(bstore1) + "' and b.bstore <= '" + cvth.Unicode2ASCII(bstore2) + "' "
                                        + "and b.companycode >= '" + cvth.Unicode2ASCII(company1) + "' and b.companycode <= '" + cvth.Unicode2ASCII(company2) + "' "
                                        + "and b.brandcode >= '" + cvth.Unicode2ASCII(brand1) + "' and b.brandcode <= '" + cvth.Unicode2ASCII(brand2) + "' "
                                        + "and b.buscode >= '" + cvth.Unicode2ASCII(bustype1) + "' and b.buscode <= '" + cvth.Unicode2ASCII(bustype2) + "' "
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and b.bsize >= '" + cvth.Unicode2ASCII(bsize1) + "' and b.bsize <= '" + cvth.Unicode2ASCII(bsize2) + "' "
                                        + "and b.bplane >= '" + cvth.Unicode2ASCII(bplan1) + "' and b.bplane <= '" + cvth.Unicode2ASCII(bplan2) + "' "
                                        + "and b.bstore >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.bstore <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.companycode >= '" + cvth.Unicode2ASCII(company1) + "' and b.companycode <= '" + cvth.Unicode2ASCII(company2) + "' "
                                        + "and b.brandcode >= '" + cvth.Unicode2ASCII(brand1) + "' and b.brandcode <= '" + cvth.Unicode2ASCII(brand2) + "' "
                                        + "and b.buscode >= '" + cvth.Unicode2ASCII(bustype1) + "' and b.buscode <= '" + cvth.Unicode2ASCII(bustype2) + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and b.bplane >= '" + cvth.Unicode2ASCII(bplan1) + "' and b.bplane <= '" + cvth.Unicode2ASCII(bplan2) + "' "
                                        + "and b.bstore >= '" + cvth.Unicode2ASCII(bstore1) + "' and b.bstore <= '" + cvth.Unicode2ASCII(bstore2) + "' "
                                        + "and b.companycode >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.companycode <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.brandcode >= '" + cvth.Unicode2ASCII(brand1) + "' and b.brandcode <= '" + cvth.Unicode2ASCII(brand2) + "' "
                                        + "and b.buscode >= '" + cvth.Unicode2ASCII(bustype1) + "' and b.buscode <= '" + cvth.Unicode2ASCII(bustype2) + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                        + "group by " + this.code + ",d.s_pcode "
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and b.bstore >= '" + cvth.Unicode2ASCII(bstore1) + "' and b.bstore <= '" + cvth.Unicode2ASCII(bstore2) + "' "
                                        + "and b.companycode >= '" + cvth.Unicode2ASCII(company1) + "' and b.companycode <= '" + cvth.Unicode2ASCII(company2) + "' "
                                        + "and b.brandcode >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.brandcode <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and b.buscode >= '" + cvth.Unicode2ASCII(bustype1) + "' and b.buscode <= '" + cvth.Unicode2ASCII(bustype2) + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                        + "group by " + this.code + ",d.s_pcode "
                                        + "order by " + this.code + ",d.s_pcode";
                                ...
                                sql2 = "SELECT pque,pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        ...
                                        + "and b.companycode >= '" + cvth.Unicode2ASCII(company1) + "' and b.companycode <= '" + cvth.Unicode2ASCII(company2) + "' "
                                        + "and b.brandcode >= '" + cvth.Unicode2ASCII(brand1) + "' and b.brandcode <= '" + cvth.Unicode2ASCII(brand2) + "' "
                                        + "and b.buscode >= '" + cvth.Unicode2ASCII(TempBran) + "' and b.buscode <= '" + cvth.Unicode2ASCII(TempBran) + "' "
                                        + "and locate(dayofweek(d.s_date),'" + strday + "')>0 "
                                        + "group by " + this.code + ",d.s_pcode "
                                        + "order by " + this.code + ",d.s_pcode";
    ...
    private void setTxt() {
        ...
        lbldate1.setText(plu);
        condition = this.getTitle() + " Date(1) : " + date + " Fastival : " + plu;
    }
