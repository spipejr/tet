...
import reportModel.reportSumRjfileModel;
 ...
 * @author s386
 */
public class rptSumRjfile extends javax.swing.JDialog {

    /**
     * Creates new form rptSumRjfile
     */
    ...
    String frmName = "rptSumRjfile";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition="";
    public rptSumRjfile(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumRjfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumRjfile dialog = new rptSumRjfile(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
            ...
            TableColumn tc6 = new TableColumn(5,200);
...
//            tcm.addColumn(tc31);
        ...
        tbl.setRowHeight(24);
            ...
            {
            sql = "SELECT rjno,rjline,dept,account,sub,descname"
                        ...
                        +"group by "+code+",rjno order by "+code+",rjline";
            }
            else
            {
               sql = "SELECT rjno,rjline,dept,account,sub,descname"
            ...
            reportSumRjfileModel treemodel = new reportSumRjfileModel(sql,code,name);
