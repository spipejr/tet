...
import reportModel.reportSumCuponModel;
 ...
 * @author s386
 */
public class rptPromotion extends javax.swing.JDialog {

    /**
     * Creates new form rptPromotion
     */
    ...
    String frmName = "rptPromotion";
    String condition = "";
    ThaiUtilities cvth = new ThaiUtilities();

    public rptPromotion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptPromotion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptPromotion dialog = new rptPromotion(new javax.swing.JFrame(), true);
...
private void inittbl() {
        try {
            ...
            tc3.setHeaderValue("รหัสโปรโมชั่น");
            TableColumn tc4 = new TableColumn(4, 200);
            tc4.setHeaderValue("ชื่อโปรโมชั่น");
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                sql = "SELECT sum(pqty) as sumqty,sum(pamt) as sumamt,c.prodesc as prname,d.prcode as prcode,prtype"
                        ...
                        + "group by " + code + ",d.prtype,d.prcode order by " + code + ",d.prcode";
            } else {
                sql = "SELECT sum(pqty) as sumqty,sum(pamt) as sumamt,c.prodesc as prname,d.prcode as prcode,prtype"
                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
            ...
            reportPromotionModel treemodel = new reportPromotionModel(sql, code, name);
