...
import reportModel.reportSumSaleOfPluProductModel;
 ...
 * @author s386
 */
public class rptSumSaleOfPluProduct extends javax.swing.JDialog {
    ...
    String frmName = "rptSumSaleOfPluProduct";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    public rptSumSaleOfPluProduct(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumSaleOfPluProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumSaleOfPluProduct dialog = new rptSumSaleOfPluProduct(new javax.swing.JFrame(), true);
...
//        tcm.getColumn(30).setCellRenderer(r);
        ...
        tbl.setRowHeight(24);
            ...
            sql = "SELECT punit1,s_price,pdesc,s_pcode,pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        ...
                        +" group by s_pcode,branchcode order by  s_pcode";
            }
            else
            {
                sql = "SELECT punit1,s_price,pdesc,s_pcode,pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
            ...
            reportSumSaleOfPluProductModel treemodel = new reportSumSaleOfPluProductModel(sql,code,name);
