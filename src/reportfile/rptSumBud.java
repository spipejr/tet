...
import reportModel.reportSumBudModel;
 ...
 * @author natee
 */
public class rptSumBud extends javax.swing.JDialog {

    /**
     * Creates new form rptSumBud
     */
    ...
    String frmName = "rptSumBud";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    public rptSumBud(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
 ...
 Export2Excel test = new Export2Excel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumBud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumBud dialog = new rptSumBud(new javax.swing.JFrame(), true);
    ...
    private void inittbl()
{
    try {
        ...
        tbl.setRowHeight(24);
            ...
            {
                 sql = "SELECT "
                         + "brcode,tyear,rjno,rjline,dept,account,sub,descname,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                        + ",b.code as BranchCode,b.btype as BtypeCode,b.barea as BAreacode"
                        + ",b.bsize as BSizecode,b.bplane as BPlancode,b.bstore as BStorecode,b.companycode as Companycode"
                        + ",b.brandcode as Brandcode,b.buscode as Bustypecode"
                        + ",Sum(mon01) as mon01,Sum(mon02) as mon02,Sum(mon03) as mon03"
                         + ",Sum(mon04) as mon04,Sum(mon05) as mon05,Sum(mon06) as mon06"
                         + ",Sum(mon07) as mon07,Sum(mon08) as mon08,Sum(mon09) as mon09"
                         + ",Sum(mon10) as mon10,Sum(mon11) as mon11,Sum(mon12) as mon12,Sum(total) as total "
                        + "FROM budrjfile d "
                        ...
                        + "left join company com on b.companycode = com.code "
                        +"where " 
                        +"tyear =  '"+cvth.Unicode2ASCII(dept1)+"'"
                        ...
                        +"group by "+code+",rjno "
                        +"order by "+code+",rjline ";
            }
            reportSumBudModel treemodel = new reportSumBudModel(sql,code,name);
...
private void setTxt()
{
    ...
    condition = this.getTitle()+" Year : "+dept;
}
}
