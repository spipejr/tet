 ...
 * @author s386
 */
public class rptDailyPluSum extends javax.swing.JDialog {

    /**
     * Creates new form rptDailyPluSum
     */
    ...
    String frmName = "rptDailyPluSum";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();

    public rptDailyPluSum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptDailyPluSum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptDailyPluSum dialog = new rptDailyPluSum(new javax.swing.JFrame(), true);
    ...
    private void inittbl() {
        try {
            ...
            String sql = "select * from tempdailysale where comname = '" + comname + "' group by tdept,tgroup,tque,tcode";

            reportTempDailySaleModel treemodel = new reportTempDailySaleModel(sql, code, name);
        ...
        try {
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                ...
                if (this.code.equals("All")) {
                    ...
                    String sql2 = "SELECT pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                            ...
                            + "where "
                            + "p.pgroup >= '" + dept1 + "' and p.pgroup <= '" + dept2 + "' "
                    ...
                    if (TotRec <= 100) {
                        ...
                        while (rs.next()) {
                            ...
                            if (this.code.equals("BranchCode")) {
                                sql2 = "SELECT pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                                        + ",b.code as BranchCode,b.btype as BtypeCode,b.barea as BAreacode"
                ...
                if (this.code.equals("All")) {
                    ...
                    String sql2 = "SELECT pdesc,pprice11,punit1,pgroup,groupname,d.s_pcode as pcode,s_bran,s_dept,s_pcode,s_date,s_price,sum(s_qty),sum(s_amt)"
                            ...
                            + "left join company com on b.companycode = com.code "
                            + "where "
                            + "p.pgroup >= '" + cvth.Unicode2ASCII(dept1) + "' and p.pgroup <= '" + cvth.Unicode2ASCII(dept2) + "' "
                            + "and d.s_date>= '" + d1 + "' and d.s_date<='" + d2 + "' "
