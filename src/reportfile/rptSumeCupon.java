 ...
 * @author s386
 */
public class rptSumeCupon extends javax.swing.JDialog {
    ...
    public rptSumeCupon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    private void initComponents() {
        ...
        setTitle("รายงานสรุปยอดการแจก e-Coupon");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumeCupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumeCupon dialog = new rptSumeCupon(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
            ...
            tc3.setHeaderValue("รหัส e-Coupon");
            TableColumn tc4 = new TableColumn(3,200);
            tc4.setHeaderValue("ชื่อ e-Coupon");
        ...
        tbl.setRowHeight(24);
            ...
            {
                sql = "SELECT sum(cuquan) as sumqty,sum(cuamt*cuquan)as sumamt,c.cuname as cuname,d.cucode as cucode"
                        ...
                        + "left join ecupon c on d.cucode = c.cucode "
