...
import reportModel.reportSumMonthModel;
 ...
 * @author s386
 */
public class rptSumMonth extends javax.swing.JDialog {

    /**
     * Creates new form rptSumMonth
     */
    ...
    String frmName = "rptSumMonth";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();
    public rptSumMonth(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    private void initComponents() {
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(db_lblh1, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumMonth.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumMonth dialog = new rptSumMonth(new javax.swing.JFrame(), true);
    ...
    private void inittbl()
{
    try {
        ...
        tbl.setRowHeight(24);
            ...
            reportSumMonthModel treemodel = new reportSumMonthModel(sql,code,name);
    ...
    try {
            ...
            else
            {
                ...
                sql = "SELECT brcode,tdate,rjno,rjline,dept,account,sub,descname,sum(mac1),sum(mac2),sum(mac3),sum(total)"
                        ...
                        +"where "  
                        +" d.brcode >= '"+cvth.Unicode2ASCII(branch1)+"' and d.brcode <= '"+cvth.Unicode2ASCII(branch2)+"' "
                        ...
                        +"and month(d.tdate) = '"+TMonth+"' and year(d.tdate) = '"+date1+"' ";
            ...
            rs = stmt.executeQuery(sql);
             Tempfield = "mon"+Format.zero.format(TMonth);
             TotField = "total";   
             while(rs.next())
                {
                    if(!this.code.equals("All"))
