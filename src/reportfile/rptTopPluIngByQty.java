 ...
 * @author s386
 */
public class rptTopPluIngByQty extends javax.swing.JDialog {

    /**
     * Creates new form rptTopPluIngByQty
     */
    ...
    String frmName = "rptTopPluIngByQty";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();
    public rptTopPluIngByQty(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptTopPluIngByQty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptTopPluIngByQty dialog = new rptTopPluIngByQty(new javax.swing.JFrame(), true);
...
//            tcm.addColumn(tc31);
        ...
        tbl.setRowHeight(24);
            ...
            reportTopPluIngByQtyModel treemodel = new reportTopPluIngByQtyModel(sql,code,name);
...
private void setTxt()
{
    ...
    private void setQue() {
        try {
            ...
            String sql = "Select * From tempdailysale Where comname = '"+comname+"' order by tgroup,bran1 desc ";
                ResultSet rs = null;
                Statement stmt = (Statement) dbUtility.con.createStatement();
                rs = stmt.executeQuery(sql);
                    while(rs.next())
