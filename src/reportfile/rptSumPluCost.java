 ...
 * @author s386
 */
public class rptSumPluCost extends javax.swing.JDialog {

    /**
     * Creates new form rptSumPluCost
     */
    ...
    String frmName = "rptSumPluCost";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    
    public rptSumPluCost(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumPluCost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumPluCost dialog = new rptSumPluCost(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
        ...
        tbl.setRowHeight(24);
            ...
            {
            sql = "SELECT pscost,pabtype,punit1,s_price,pdesc,s_pcode,pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        ...
                        + ",sum(s_qty) as s_qty,sum(s_amt) as s_amt "
                        + "FROM dplu d "
                        ...
                        +"group by "+code+",pgroup,s_pcode order by "+code+",pgroup,s_pcode";
            }
            else
            {
                sql = "SELECT pscost,pabtype,punit1,s_price,pdesc,s_pcode,pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
            ...
            reportSumPluCostModel treemodel = new reportSumPluCostModel(sql,code,name);
