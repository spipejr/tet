 ...
 * @author s386
 */
public class rptPlaceAvg extends javax.swing.JDialog {

    /**
     * Creates new form rptPlaceAvg
     */
    ...
    String frmName = "rptPlaceAvg";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();
    public rptPlaceAvg(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptPlaceAvg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptPlaceAvg dialog = new rptPlaceAvg(new javax.swing.JFrame(), true);
...
//            tcm.addColumn(tc31);
        ...
        tbl.setRowHeight(24);
            ...
            setTemp();
            String sql="select * from tempdailysale where comname = '"+comname+"' order by tgroup,tbran";
            
            reportPlacAvgModel treemodel = new reportPlacAvgModel(sql,code,name);
...
private void setTemp()
{
    try {
            ...
            if(dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8"))
            {
                ...
                sql = "SELECT count(tdate) as sumday,brcode,tdate,rjno,dept,account,sub,descname,b.tot_area,b.cost,b.charge,b.gp,b.flagecost,b.flagegp"
                        ...
                        +"and rjno = '50' "
                        +"group by brcode order by "+this.code+",brcode";
            ...
            rs = stmt.executeQuery(sql);
                while(rs.next())
                {
                  ...
                  tot_area = rs.getDouble("tot_area");
                  gp = rs.getDouble("gp");
                  sale = rs.getDouble("sumsale");
                  cust = rs.getDouble("sumday");
                  
                  if(rs.getString("flagecost")!=null)
                  {
                      Fcost = rs.getString("flagecost");
                  }
                  else
                  {
                      Fcost = "N";
                  }
                  if(rs.getString("flagegp")!=null)
                  {
                      Fgp = rs.getString("flagegp");
                  }
                  else
                  {
                      Fgp = "";
                  ...
                  if(tot_area>0)
                  {
                     b2 = cost/tot_area;
                     b3 = charge/tot_area;
                     b4 = (cost+charge)/tot_area;
                     b5 = (sale/tot_area);
                     b6 = (sale/tot_area/cust);
                     b7 = cust ;
                        if(Fgp.equals("Y"))
                        {
                            b8 = (((sale*gp/100)+(cost+charge))/cust)/(sale/cust)*100;
                        }
                        else
                        {
                            b8 = ((cost+charge)/cust)/(sale/cust)*100;
                        }
                  ...
                  String sqltemp = "insert into tempdailysale(tgroup,tname,tbran,tbranname,bran1,bran2,bran3,bran4,bran5,bran6,bran7,bran8,bran9,comname) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
