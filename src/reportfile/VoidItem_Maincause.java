 ...
 * @author march
 */
public class VoidItem_Maincause extends javax.swing.JDialog {
    ...
    public VoidItem_Maincause(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setParamiter02() {
        try {
            VoidItem_Cause vids = new VoidItem_Cause();
    ...
    private void initComponents() {
        ...
        xb_h12.setText("รายงานสรุปสาเหตุการ Void Item (Void Item Cause Report)");
        xb_h12.setName("lb_h1"); // NOI18N

        d_h13.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        d_h13.setText("(Void Item Cause)");
...
//            System.out.println(condate02);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoidItem_Maincause.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VoidItem_Maincause dialog = new VoidItem_Maincause(new javax.swing.JFrame(), true);
