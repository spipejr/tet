...
import reportModel.reportStockCakeModel;
 ...
 * @author s386
 */
public class rptStockCake extends javax.swing.JDialog {

    /**
     * Creates new form rptStockCake
     */
    ...
    String frmName = "rptStockCake";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition="";
    public rptStockCake(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptStockCake.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptStockCake dialog = new rptStockCake(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
            ...
            tc16.setHeaderValue("ตรวจนับจริง");
            TableColumn tc17 = new TableColumn(17,100);
            tc17.setHeaderValue("TUser");
            TableColumn tc18 = new TableColumn(18,100);
            tc18.setHeaderValue("หมายเหตุ");
            TableColumn tc19 = new TableColumn(1,100);
            tc19.setHeaderValue("วันที่");
        ...
        tcm.getColumn(17).setCellRenderer(FormatCell.l());
        tcm.getColumn(18).setCellRenderer(FormatCell.l());
        ...
        tbl.setRowHeight(24);
            ...
            {
            sql = "SELECT name,pdesc,punit1,pgroup,d.pcode as pcode,d.* "
                        ...
                        +"order by s_bran,s_date,pgroup,pcode";
            }
            else
            {
                sql = "SELECT name,pdesc,punit1,pgroup,d.pcode as pcode,d.* "
            ...
            reportStockCakeModel treemodel = new reportStockCakeModel(sql);
...
private void setTxt()
{
    ...
    lblplu.setText(plu);
    condition = this.getTitle()+" Date : "+date+" Dept : "+dept+" PLU : "+plu+" Branch : "+branch;
}
}
