 ...
 * @author s386
 */
public class rptTopSaleByQty extends javax.swing.JDialog {

    /**
     * Creates new form rptTopSaleByQty
     */
    public static String date1 = "",date2 ="",dept1="",dept2="",plu1="",plu2="",branch1="",branch2="",btype1="",btype2=""
            ...
            ,company1="",company2="",brand1="",brand2="",bustype1="",bustype2="",code="",name="",strqty="",stramt="";
    public static int top = 1;
    private Font fontbold = new Font("Norasi", Font.BOLD, 14);
    private Font fontplain = new Font("Norasi", Font.PLAIN, 14);
    String frmName = "rptTopSaleByQty";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    public rptTopSaleByQty(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptTopSaleByQty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptTopSaleByQty dialog = new rptTopSaleByQty(new javax.swing.JFrame(), true);
    ...
    try {
        ...
        tbl.setRowHeight(24);
            ...
            sql = "SELECT punit1,s_price,pdesc,s_pcode,pgroup,(0"+strqty+") as sumqty,(0"+stramt+") as sumamt"
                        ...
                        +"group by "+code+",PGroupCode,s_pcode order by "+code+",PGroupCode,sumqty desc";
            }
            else
            {
                sql = "SELECT punit1,s_price,pdesc,s_pcode,pgroup,(0"+strqty+") as sumqty,(0"+stramt+") as sumamt"
            ...
            reportTopSaleByQtyModel treemodel = new reportTopSaleByQtyModel(sql,code,name,top);
