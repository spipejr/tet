 ...
 * @author s386
 */
public class rptSumPluIngByPlu extends javax.swing.JDialog {
    ...
    public rptSumPluIngByPlu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumPluIngByPlu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumPluIngByPlu dialog = new rptSumPluIngByPlu(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
            ...
            tc4.setHeaderValue("รหัสวัตถุดิบ");
            TableColumn tc5 = new TableColumn(4,130);
            tc5.setHeaderValue("ชื่อวัตถุดิบ");
