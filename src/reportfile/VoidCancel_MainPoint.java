 ...
 * @author march
 */
public class VoidCancel_MainPoint extends javax.swing.JDialog {
    ...
    public VoidCancel_MainPoint(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setParamiter02() {
        try {
            VoidCancel_Point vids = new VoidCancel_Point();
    ...
    private void initComponents() {
        ...
        xb_h12.setText("รายงานการ Void(นอก) แบบสรุป (Void Conclude Report)");
        xb_h12.setName("lb_h1"); // NOI18N

        d_h13.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        d_h13.setText("(Void Conclude)");
...
//            System.out.println(condate02);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoidCancel_MainPoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VoidCancel_MainPoint dialog = new VoidCancel_MainPoint(new javax.swing.JFrame(), true);
