 ...
 * @author s386
 */
public class rptSumCupon extends javax.swing.JDialog {
    ...
    public rptSumCupon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumCupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumCupon dialog = new rptSumCupon(new javax.swing.JFrame(), true);
