 ...
 * @author march
 */
public class VoidCancel_MainCause extends javax.swing.JDialog {
    ...
    public VoidCancel_MainCause(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        txtdate1.setText(DateFmt.format(date));
        txtdate2.setText(DateFmt.format(date));
    }
    String condate001 = "", condate002 = "", bran1 = "", bran2 = "", area1 = "", area2 = "", gradr1 = "", grade2 = "", dateshow1 = "", dateshow2 = "";

    public void setParamiter02() {
        try {
            VoidCancel_Cause vids = new VoidCancel_Cause();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(775, 474));
        ...
        xb_h12.setText("รายงานสรุปสาเหตุการ Void(นอก) (Void Cause Report)");
        xb_h12.setName("lb_h1"); // NOI18N

        d_h13.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        d_h13.setText("(Void Cause)");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jPanel23, javax.swing.GroupLayout.DEFAULT_SIZE, 529, Short.MAX_VALUE)
...
//            System.out.println(condate02);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        setParamiter02();
        VoidItem_Cause vipc = new VoidItem_Cause(new NimbusFrame(), true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoidCancel_MainCause.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VoidCancel_MainCause dialog = new VoidCancel_MainCause(new javax.swing.JFrame(), true);
