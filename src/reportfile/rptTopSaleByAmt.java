...
import reportModel.reportTopSaleByAmtModel;
import reportModel.reportTopSaleByQtyModel;
 ...
 * @author s386
 */
public class rptTopSaleByAmt extends javax.swing.JDialog {

    /**
     * Creates new form rptTopSaleByAmt
     */
    public static String date1 = "", date2 = "", dept1 = "", dept2 = "", plu1 = "", plu2 = "", branch1 = "", branch2 = "", btype1 = "", btype2 = "", barea1 = "", barea2 = "", bsize1 = "", bsize2 = "", bplan1 = "", bplan2 = "", bstore1 = "", bstore2 = "", strday = "", company1 = "", company2 = "", brand1 = "", brand2 = "", bustype1 = "", bustype2 = "", code = "", name = "", strqty = "", stramt = "";
    public static int top = 1;
    private Font fontbold = new Font("Norasi", Font.BOLD, 14);
    private Font fontplain = new Font("Norasi", Font.PLAIN, 14);
    String frmName = "rptTopSaleByAmt";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";

    public rptTopSaleByAmt(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptTopSaleByAmt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptTopSaleByAmt dialog = new rptTopSaleByAmt(new javax.swing.JFrame(), true);
...
private void inittbl() {
        try {
            ...
            TableColumn tc4 = new TableColumn(2, 50);
            tc4.setHeaderValue("ลำดับ");
            TableColumn tc5 = new TableColumn(3, 80);
            tc5.setHeaderValue("รหัสสินค้า");
            TableColumn tc6 = new TableColumn(4, 200);
            tc6.setHeaderValue("ชื่อสินค้า");
            TableColumn tc7 = new TableColumn(5, 100);
            tc7.setHeaderValue("ราคาขาย");
            TableColumn tc8 = new TableColumn(6, 100);
            tc8.setHeaderValue("หน่วย");
            TableColumn tc9 = new TableColumn(7, 100);
            tc9.setHeaderValue("จำนวนขาย");
            TableColumn tc10 = new TableColumn(8, 100);
            tc10.setHeaderValue("จำนวนเงิน");
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                sql = "SELECT punit1,s_price,pdesc,s_pcode,pgroup,(0" + strqty + ") as sumqty,(0" + stramt + ") as sumamt"
                        ...
                        + "group by " + code + ",PGroupCode,s_pcode order by " + code + ",PGroupCode,sumamt desc";
            } else {
                sql = "SELECT punit1,s_price,pdesc,s_pcode,pgroup,(0" + strqty + ") as sumqty,(0" + stramt + ") as sumamt"
                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
            ...
            reportTopSaleByAmtModel treemodel = new reportTopSaleByAmtModel(sql, code, name, top);
