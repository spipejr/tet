...
import static reportfile.VoidItem_Point.area1;
import static reportfile.VoidItem_Point.area2;
import static reportfile.VoidItem_Point.bran1;
import static reportfile.VoidItem_Point.bran2;
import static reportfile.VoidItem_Point.cash1;
import static reportfile.VoidItem_Point.cash2;
import static reportfile.VoidItem_Point.condate001;
import static reportfile.VoidItem_Point.condate002;
import static reportfile.VoidItem_Point.dateshow1;
import static reportfile.VoidItem_Point.dateshow2;
import static reportfile.VoidItem_Point.grade2;
import static reportfile.VoidItem_Point.gradr1;
import utilititiesfunction.Export2Excel;

public class VoidItem_Cause extends javax.swing.JDialog {
    ...
    public VoidItem_Cause(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void loadtable() {
        ...
        String sql = "SELECT vms.voidcode,vms.voidmsg,S_Bran,bf.Name as BranName,count(voidcode) as Sumall1\n"
                + "from s_void sv \n"
                + "left join voidmessage vms on substring_index(r_voidmsg,'-',1) = vms.voidcode\n"
                ...
                + "where voidcode>='0' and voidcode<='5'\n"
                + "and S_bran>='" + bran1 + "' and s_bran<='" + bran2 + "'\n"
                + "and BArea>='" + area1 + "' and BArea<='" + area2 + "'\n"
                + "and voidgroup>='" + vgroup1 + "' and voidgroup<='" + grade2 + "'\n"
                + "and S_Date>='" + condate001 + "' and S_Date<='" + condate002 + "'\n"
                + "group by S_Bran,voidmsg\n"
                + "order by voidcode";
        try {
            ...
            while (rs.next()) {
                Object[] row;
                row = new Object[5];
                row[0] = rs.getString("voidcode");
                row[1] = cvth.ASCII2Unicode(rs.getString("voidmsg"));
                row[2] = rs.getString("S_Bran");
                row[3] = cvth.ASCII2Unicode(rs.getString("BranName"));
                row[4] = rs.getString("sumall1");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("รายงานการสาเหตุการ Void Item");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoidItem_Cause.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VoidItem_Cause dialog = new VoidItem_Cause(new javax.swing.JFrame(), true);
