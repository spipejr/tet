 ...
 * @author s386
 */
public class rptSumPoint extends javax.swing.JDialog {
    ...
    public rptSumPoint(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumPoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumPoint dialog = new rptSumPoint(new javax.swing.JFrame(), true);
...
private void inittbl()
{
    try {
        ...
        tbl.setRowHeight(24);
            ...
            {
                sql = "SELECT sum(cuqty),sum(cuamt),c.cuname as cuname,d.cucode as cucode"
                        ...
                        + "left join cupon c on d.cucode = c.cucode "
                        ...
                        +"and d.cucode >= '"+plu1+"' and d.cucode <= '"+plu2+"' "
                        ...
                        +"group by "+code+",d.cucode order by "+code+",d.cucode";
            }
            else
            {
               sql = "SELECT sum(cuqty) as sumqty,sum(cuamt) as sumamt,c.cuname as cuname,d.cucode as cucode"
                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                        + ",bf.brandname as Brandname,bust.busname as Bustypename"
                        + ",b.code as BranchCode,b.btype as BtypeCode,b.barea as BAreacode"
                        ...
                        +"where " 
                        +"d.t_date>= '"+d1+"' and d.t_date<='"+d2+"' "
                       +"and d.cucode >= '"+cvth.Unicode2ASCII(plu1)+"' and d.cucode <= '"+cvth.Unicode2ASCII(plu2)+"' "
            ...
            reportSumCuponModel treemodel = new reportSumCuponModel(sql,code,name);
...
private void setTxt()
{
    ...
    condition = this.getTitle()+" Date : "+date+" CouponCode : "+plu;
}
}
