 ...
 * @author s386
 */
public class rptSumSTranSet extends javax.swing.JDialog {

    /**
     * Creates new form rptSumPluIng
     */
    ...
    String frmName = "rptSumPluIng";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();

    public rptSumSTranSet(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    private void initComponents() {
        ...
        setTitle("รายงานสรุปรายการสินค้าจัดชุด");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumSTranSet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumSTranSet dialog = new rptSumSTranSet(new javax.swing.JFrame(), true);
...
//            tcm.addColumn(tc31);
            ...
            reportSumPluIngModel treemodel = new reportSumPluIngModel(sql, code, name);
    ...
    private void setTemp() {
        try {
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                ...
                sql = "SELECT S_Bran,S_Date,r_psubcode,r_price,Sum(r_qty) as r_qty,Sum(r_unittotalamount) as r_amount,pgroup,punit1,groupname,pdesc"
                        ...
                        + "left join product p on p.pcode = d.r_psubcode "
                        + "left join groupfile g on g.groupcode = p.pgroup "
                        + "where "
                ...
                if (!this.code.equals("All")) {
                    sql += "group by " + this.code + ",r_psubcode";
                } else {
                    sql += "group by r_psubcode";
                }
                ResultSet rs = null;
                ...
                while (rs.next()) {
                    ...
                    TCode = rs.getString("r_psubcode");
                    TQty = rs.getDouble("r_qty");
                    TSCode = rs.getString("r_psubcode");
                    TSPName = PUtility.SeekProductName(TCode);// rs.getString("pdesc"); 
                    TSPrice = rs.getDouble("r_price");
                    TSUnit = PUtility.SeekProductUnit(TCode);// rs.getString("punit1");
                    TSBran1 = rs.getDouble("r_qty");
                    TSBran2 = rs.getDouble("r_amount");
                    TSDept = PUtility.SeekProductGroup(TCode);// rs.getString("pgroup");
                    TSDeptName = PUtility.SeekGroupName(TSDept);// rs.getString("groupname");

                    if (!chkTemp(TSGroup, TSCode, comname)) {
                        //insert data
                        String sqltemp = "Insert Into tempdailysale (TGroup,TName,TCode,TPName,TDept,TDeptName,TPrice,TUnit,Bran1,Bran2,comname) "
                                + "Values (?,?,?,?,?,?,?,?,?,?,?)";
