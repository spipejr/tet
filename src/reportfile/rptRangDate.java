 ...
 * @author s386
 */
public class rptRangDate extends javax.swing.JDialog {

    /**
     * Creates new form rptRangDate
     */
    ...
    String frmName = "rptRangDate";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    dbUtility db = new dbUtility();
    public rptRangDate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptRangDate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptRangDate dialog = new rptRangDate(new javax.swing.JFrame(), true);
    ...
    private void inittbl()
{
    try {
            ...
            TableColumn tc6 = new TableColumn(5,120);
        ...
        tbl.setRowHeight(24);
            ...
            reportRangDateModel treemodel = new reportRangDateModel(sql,code,name);
    ...
    private void setcolumn()
    {
        ...
        tbl.getColumnModel().getColumn(4).setHeaderValue(tbl.getColumnModel().getColumn(4).getHeaderValue()+" "+Format.dateFmtShow.format(d1)+" - "+Format.dateFmtShow.format(d2));
        tbl.getColumnModel().getColumn(5).setHeaderValue(tbl.getColumnModel().getColumn(5).getHeaderValue()+" "+Format.dateFmtShow.format(d3)+" - "+Format.dateFmtShow.format(d4));
    ...
    try {
            ...
            rs = stmt.executeQuery(sql);
             ...
             while(rs.next())
                {
                   ...
                   if(TempKey2>0 && TempKey2<=50 || TempKey2==82)
                   {
             ...
             sql = "SELECT brcode,tdate,rjno,rjline,dept,account,sub,descname,sum(mac1),sum(mac2),sum(mac3),sum(total)"
                        ...
                        +"and b.brandcode >= '"+brand1+"' and b.brandcode <= '"+brand2+"' "
                        +"and b.buscode >= '"+bustype1+"' and b.buscode <= '"+bustype2+"' "
                        +"and locate(dayofweek(d.tdate),'"+strday2+"')>0 ";
                        if(!this.code.equals("All"))
                        {
