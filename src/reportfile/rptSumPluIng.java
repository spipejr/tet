 ...
 * @author s386
 */
public class rptSumPluIng extends javax.swing.JDialog {
    ...
    public rptSumPluIng(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumPluIng.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumPluIng dialog = new rptSumPluIng(new javax.swing.JFrame(), true);
