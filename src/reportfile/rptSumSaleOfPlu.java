 ...
 * @author s386
 */
public class rptSumSaleOfPlu extends javax.swing.JDialog {
    ...
    String frmName = "rptSumSaleOfPlu";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    public rptSumSaleOfPlu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumSaleOfPlu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumSaleOfPlu dialog = new rptSumSaleOfPlu(new javax.swing.JFrame(), true);
...
//        tcm.getColumn(30).setCellRenderer(r);
        ...
        tbl.setRowHeight(24);
            ...
            reportSumSaleOfPluModel treemodel = new reportSumSaleOfPluModel(sql,code,name);
