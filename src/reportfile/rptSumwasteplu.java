...
import reportModel.reportSumWasteOfPluModel;
 ...
 * @author s386
 */
public class rptSumwasteplu extends javax.swing.JDialog {

    /**
     * Creates new form rptSumSaleOfPlu
     */
    ...
    String frmName = "rptSumwasteplu";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";

    public rptSumwasteplu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumwasteplu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumwasteplu dialog = new rptSumwasteplu(new javax.swing.JFrame(), true);
...
private void inittbl() {
        try {
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                sql = "SELECT punit1,pdesc,r_pcode,pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        ...
                        + "r_cost, sum(r_qty) as qty,sum(r_amount) as amt "
                        + "FROM prolost d "
                        ...
                        + "and d.r_pcode >= '" + plu1 + "' and d.r_pcode <= '" + plu2 + "' "
                        ...
                        + "group by " + code + ",r_pcode order by " + code + ",pgroup,r_pcode";
            } else {
                sql = "SELECT punit1,pdesc,r_pcode,pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                        + ",bf.brandname as Brandname,bust.busname as Bustypename,gf.groupname as PGroupName"
                        ...
                        + "and d.r_pcode >= '" + cvth.Unicode2ASCII(plu1) + "' and d.r_pcode <= '" + cvth.Unicode2ASCII(plu2) + "' "
            ...
            reportSumWasteOfPluModel treemodel = new reportSumWasteOfPluModel(sql, code, name);
