...
import reportModel.reportPromotionAllModel;
import reportModel.reportPromotionModel;
 ...
 * @author s386
 */
public class rptPromotionAll extends javax.swing.JDialog {

    /**
     * Creates new form rptPromotionAll
     */
    public static String date1 = "", date2 = "", dept1 = "", dept2 = "", plu1 = "", plu2 = "", branch1 = "", branch2 = "", btype1 = "", btype2 = "", barea1 = "", barea2 = "", bsize1 = "", bsize2 = "", bplan1 = "", bplan2 = "", bstore1 = "", bstore2 = "", strday = "", company1 = "", company2 = "", brand1 = "", brand2 = "", bustype1 = "", bustype2 = "", code = "", name = "", strtype = "";
    private Font fontbold = new Font("Norasi", Font.BOLD, 14);
    private Font fontplain = new Font("Norasi", Font.PLAIN, 14);
    String frmName = "rptPromotionAll";
    String condition = "";
    ThaiUtilities cvth = new ThaiUtilities();

    public rptPromotionAll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptPromotionAll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptPromotionAll dialog = new rptPromotionAll(new javax.swing.JFrame(), true);
...
private void inittbl() {
        try {
            ...
            TableColumn tc7 = new TableColumn(2, 40);
            tc7.setHeaderValue("Type");
            TableColumn tc3 = new TableColumn(3, 100);
            tc3.setHeaderValue("รหัสบัตรคูปอง");
            TableColumn tc4 = new TableColumn(4, 200);
            tc4.setHeaderValue("ชื่อบัตรคูปอง");
            TableColumn tc8 = new TableColumn(5, 100);
            tc8.setHeaderValue("รหัสสินค้า");
            TableColumn tc9 = new TableColumn(6, 200);
            tc9.setHeaderValue("รายละเอียดสินค้า");
            TableColumn tc5 = new TableColumn(7, 100);
            tc5.setHeaderValue("จำนวน");
            TableColumn tc6 = new TableColumn(8, 100);
            tc6.setHeaderValue("จำนวนเงิน");
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                sql = "SELECT d.pcode as pcode,p.pdesc as pdesc,sum(pqty) as sumqty,sum(pamt) as sumamt,c.prodesc as prname,d.prcode as prcode,prtype"
                        ...
                        + "left join protab c on d.prcode = c.procode "
                        ...
                        + "and d.prcode >= '" + plu1 + "' and d.prcode <= '" + plu2 + "' "
                        ...
                        + "and locate(d.prtype,'" + strtype + "')>0 "
                        + "group by " + code + ",d.prcode,d.pcode order by " + code + ",d.prcode,d.pcode";
            } else {
                sql = "SELECT d.pcode as pcode,p.pdesc as pdesc,sum(pqty) as sumqty,sum(pamt) as sumamt,c.prodesc as prname,d.prcode as prcode,prtype"
                        + ",b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        + ",si.name as BSizename,pl.name as BPlanname,st.name as BStorename,com.name as Companyname"
                        ...
                        + "where "
                        + "d.s_date>= '" + d1 + "' and d.s_date<='" + d2 + "' "
                        + "and d.prcode >= '" + cvth.Unicode2ASCII(plu1) + "' and d.prcode <= '" + cvth.Unicode2ASCII(plu2) + "' "
            ...
            reportPromotionAllModel treemodel = new reportPromotionAllModel(sql, code, name);
    ...
    private void setTxt() {
        ...
        condition = this.getTitle() + " Date : " + date + " Code : " + branch;
    }
}
