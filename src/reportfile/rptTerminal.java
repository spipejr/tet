...
import reportModel.reportTerminalBean;
import reportModel.reportTerminalModel;
 ...
 * @author s386
 */
public class rptTerminal extends javax.swing.JDialog {

    /**
     * Creates new form rptTerminal
     */
    ...
    String frmName = "rptTerminal";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    public rptTerminal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptTerminal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptTerminal dialog = new rptTerminal(new javax.swing.JFrame(), true);
...
//        r.setBackground(new Color(190,253,207));
        ...
        tbl.setRowHeight(24);
            ...
            {
                sql = "SELECT drj.total as total,sum(nrefund) as nre,ds_bran,name,dayname(t_date) as tday,t_date,"
                        + "sum(deptsum) as deptsum,sum(service) as service,sum(dsales) as dsales,sum(cash) as cash,"
                        + "sum(cramount) as misc,sum(cupon) as cupon,sum(ar) as ar,sum(salevat) as salevat,"
                        ...
                        +" FROM dterminal as d inner join branfile as b on d.s_bran = b.code "
                            + "inner join drjfile as drj "
                            + "on drj.brcode=d.s_bran and drj.tdate = d.t_date "
                            +"left join dcredit as dcr  on dcr.s_date=d.t_date and dcr.s_bran=d.s_bran and macno=t_macno "
                        +"where " 
                        ...
                        +"and drj.rjno = '53' "
                        +"group by d.s_bran,t_date order by d.s_bran,t_date";
            }
            else
            {
                    sql = "SELECT drj.total as total,sum(nrefund) as nre,d.s_bran,name,dayname(t_date) as tday,t_date,"
                        + "sum(deptsum) as deptsum,sum(service) as service,sum(dsales) as dsales,sum(cash) as cash,"
                        + "sum(cramount) as misc,sum(cupon) as cupon,sum(ar) as ar,sum(salevat) as salevat,"
                        + "sum(SaleNon) as SaleNon,sum(SVat) as SVat,sum(cust) as cust,sum(pcust) as pcust,"
                        + "sum(void) as void,sum(refund) as refund,"
            ...
            reportTerminalModel treemodel = new reportTerminalModel(sql);
