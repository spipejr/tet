...
import reportModel.reportSumWasteOfDeptModel;
 ...
 * @author s386
 */
public class rptSumwastedept extends javax.swing.JDialog {
    ...
    public rptSumwastedept(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumwastedept.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumwastedept dialog = new rptSumwastedept(new javax.swing.JFrame(), true);
...
private void inittbl() {
        try {
            ...
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                sql = "SELECT pgroup,b.name as branchname,bt.btname as Btypename,ar.name as BAreaname"
                        ...
                        + "sum(r_qty) as qty,sum(r_amount) as amt "
                        + "FROM prolost d "
            ...
            reportSumWasteOfDeptModel treemodel = new reportSumWasteOfDeptModel(sql, code, name);
