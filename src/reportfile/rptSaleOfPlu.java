 ...
 *
 *
 * Created on Oct 29, 2012, 3:06:29 PM
 */
package reportfile;
 ...
 * @author natee
 */
public class rptSaleOfPlu extends javax.swing.JDialog {

    /** Creates new form rptSaleOfPlu */
    ...
    String frmName = "rptSaleOfPlu";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
   
    public rptSaleOfPlu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSaleOfPlu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSaleOfPlu dialog = new rptSaleOfPlu(new javax.swing.JFrame(), true);
    ...
    private void inittbl()
{
    try {
            ...
            TableColumn tc19 = new TableColumn(19,100);
...
//        tcm.getColumn(30).setCellRenderer(r);
        ...
        tbl.setRowHeight(24);
            ...
            {
            sql = "SELECT d.*,pdesc,punit1,pprice11,name,pgroup FROM dplu d left join product p on d.s_pcode = p.pcode "
                        +"left join branfile b "
                        +"on d.s_bran = b.code "
                        +"where " 
                        ...
                        +"order by d.s_bran,d.s_date,d.s_pcode";
            }
            else
            {
                sql = "SELECT d.*,pdesc,punit1,pprice11,name,pgroup FROM dplu d left join product p on d.s_pcode = p.pcode "
            ...
            reportSaleOfPluModel treemodel = new reportSaleOfPluModel(sql);
