 ...
 * @author s386
 */
public class rptSumTerminal extends javax.swing.JDialog {

    /**
     * Creates new form rptSumTerminal
     */
    ...
    String frmName = "rptSumTerminal";
    ThaiUtilities cvth = new ThaiUtilities();
    private String condition = "";
    public rptSumTerminal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        inittbl();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptSumTerminal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptSumTerminal dialog = new rptSumTerminal(new javax.swing.JFrame(), true);
...
//            tcm.addColumn(tc31);
        ...
        tbl.setRowHeight(24);
            ...
            reportSumTerminalModel treemodel = new reportSumTerminalModel(sql,code,name);
