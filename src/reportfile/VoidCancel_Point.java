 ...
 * @author march
 */
public class VoidCancel_Point extends javax.swing.JDialog {
    ...
    public VoidCancel_Point(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("รายงานการ Void (นอก) แบบสรุป");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VoidCancel_Point.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VoidCancel_Point dialog = new VoidCancel_Point(new javax.swing.JFrame(), true);
