...
public class dBrows_ExcelStampProRedeem extends javax.swing.JDialog {
...
//    String StampProname = "";
    ...
    public dBrows_ExcelStampProRedeem(java.awt.Frame parent, boolean modal, JTable tblExcel) {
        super(parent, modal);
        initComponents();
...
//            ProcessLoadDataSheet1(createNewTable(tblExcel));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dBrows_ExcelStampProRedeem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dBrows_ExcelStampProRedeem dialog = new dBrows_ExcelStampProRedeem(new javax.swing.JFrame(), true, null);
        ...
        try {
            ...
            if (rs.getRow() != 0) {
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    do {
                        ProcessLoadDataSheet2(rs.getString("sr.sr_campaign"), rs.getString("sr.sr_code"));
                        ProcessLoadDataSheet3(rs.getString("sr.sr_campaign"), rs.getString("sr.sr_code"));
                        ProcessLoadDataSheet4(rs.getString("sr.sr_campaign"), rs.getString("sr.sr_code"));
                        ProcessLoadDataSheet5(rs.getString("sr.sr_campaign"), rs.getString("sr.sr_code"));
    ...
    private void ProcessLoadDataSheet2(String Campaign, String Promotion) {
        ...
        try {
            String sql = "select * from stampredeem_linkbgroup sg "
                    + "left join branchgroup bg on sg.bgcode = bg.bgroupcode  "
                    + "left join stampredeem sr on sg.sr_code = sr.sr_code and sg.s_code = sr.sr_campaign "
                    + "left join stampcampaign s on sr.sr_campaign = s.s_campaigncode "
                    + "where sg.s_code  ='" + Campaign + "' and sg.sr_code ='" + Promotion + "' "
                    + "order by sg.s_code, sg.sr_code,sg.bgcode;";
            ...
            if (rs.getRow() != 0) {
                ...
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    do {
                        Code = cvth.ASCII2Unicode(rs.getString("sr.sr_campaign")) + cvth.ASCII2Unicode(rs.getString("sr.sr_code"));
                        if (!tmpCode.equals(Code)) {
                            modelFixBGroup.addRow(new Object[]{
                                "แสตมป์แคมเปญ : " + cvth.ASCII2Unicode(rs.getString("sr.sr_campaign")) + " - " + cvth.ASCII2Unicode(rs.getString("s.s_campaignname")) + "  แสตมป์โปรโมชั่น : "
                                + cvth.ASCII2Unicode(rs.getString("sr.sr_code")) + " - " + cvth.ASCII2Unicode(rs.getString("sr.sr_name"))
                            });
                        }
                        modelFixBGroup.addRow(new Object[]{
                        ...
                        tmpCode = cvth.ASCII2Unicode(rs.getString("sr.sr_campaign")) + cvth.ASCII2Unicode(rs.getString("sr.sr_code"));
                    } while (rs.next());
                } else {
                    do {
                        Code = rs.getString("sr.sr_campaign") + rs.getString("sr.sr_code");
                        if (!tmpCode.equals(Code)) {
                            modelFixBGroup.addRow(new Object[]{
                                "แสตมป์แคมเปญ : " + rs.getString("sr.sr_campaign") + " - " + rs.getString("s.s_campaignname") + "  แสตมป์โปรโมชั่น : "
                                + rs.getString("sr.sr_code") + " - " + rs.getString("sr.sr_name")
                            });
                        }
                        modelFixBGroup.addRow(new Object[]{
    ...
    private void SaveExcel() {
        ...
        String alert_save = "มีไฟล์ข้อมูลชื่อนี้อยู่แล้ว คุณต้องการบันทึกรายการนี้หรือไม่...?";
        try {
            f = new File(new File("StamPromotionRedeem.xls").getCanonicalPath());
            chooser.setSelectedFile(f);
            chooser.setFileFilter(new JRSingleSheetXlsSaveContributor(Locale.ENGLISH, null));
            int confirm2 = chooser.showSaveDialog(this);
            if (confirm2 == JFileChooser.APPROVE_OPTION) {
    ...
    private void ProcessLoadDataSheet3(String Campaign, String Promotion) {
        ...
        try {
            String sql = "select * from stampredeem_linkbranch sb "
                    ...
                    + "left join stampredeem sr on sb.sr_code = sr.sr_code and sb.s_code = sr.sr_campaign "
                    + "left join stampcampaign s on sr.sr_campaign = s.s_campaigncode "
                    + "where sb.s_code  ='" + Campaign + "' and sb.sr_code ='" + Promotion + "' "
                    + "order by sb.s_code, sb.sr_code,sb.bcode ";
            PreparedStatement pre = dbUtility.con.prepareStatement(sql);
            ResultSet rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void ProcessLoadDataSheet4(String Campaign, String Promotion) {
        ...
        try {
            String sql = "select * from stampredeem_linkplu lp "
                    + "left join product p on lp.pcode = p.pcode "
                    + "left join stampredeem sr on lp.sr_code = sr.sr_code and lp.s_code = sr.sr_campaign "
                    + "left join stampcampaign s on sr.sr_campaign = s.s_campaigncode "
                    + "where lp.s_code  ='" + Campaign + "' and lp.sr_code ='" + Promotion + "' "
                    + "order by lp.s_code, lp.sr_code, lp.pcode";
            PreparedStatement pre = dbUtility.con.prepareStatement(sql);
            ResultSet rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void ProcessLoadDataSheet5(String Campaign, String Promotion) {
        ...
        try {
            String sql = "select * from stampredeem_exceptdate sd "
                    + "left join stampredeem sr on sd.sr_code = sr.sr_code and sd.s_code = sr.sr_campaign "
                    + "left join stampcampaign s on sr.sr_campaign = s.s_campaigncode "
                    + "where sd.s_code  ='" + Campaign + "' and sd.sr_code ='" + Promotion + "' "
                    + "order by sd.s_code, sd.sr_code,sd.exp_date";
            PreparedStatement pre = dbUtility.con.prepareStatement(sql);
            ResultSet rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
