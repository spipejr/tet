 ...
 * @author s386
 */
public class rptEStampGive extends javax.swing.JDialog {
    ...
    public rptEStampGive(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        ProcessPrint();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptEStampGive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                rptEStampGive dialog = new rptEStampGive(new javax.swing.JFrame(), true);
...
//            String sql = "";
            if (dbutility.dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                Seek = "SELECT concat(sb.stamp_barcode) as barcode,"
                        ...
                        + "concat(sb.stamp_promotion,' ', sc.sp_name) as promotion , "
                        + "concat(sb.use_branch,' ', b.name) as branch , "
                        + "use_billno, sb.use_date , sb.use_time, sb.stamp_point as point "
                        + "FROM stamptran sb "
                ...
                Seek = "SELECT "
                        ...
                        + "sb.use_billno,sb.use_date ,sb.use_time,"
                        + "sb.stamp_point as point "
                        + "FROM stamptran sb "
                        + "left join branfile b on sb.use_branch = b.code "
                        + "left join stampcampaign c on sb.stamp_campaign = c.s_campaigncode "
                        + "left join stamppromotion sc on sb.stamp_promotion = sc.sp_code "
            ...
            reportEStampGive treemodel = new reportEStampGive(Seek, code);
    ...
    private void setTxt() {
        ...
        this.setTitle("รายงานการแจก E-Stamp Point ");
        condition = "รายงานการแจก E-Stamp Point  " + " Date : " + date;
    }

    private void ProcessPrint() {
        formatStamp f = new formatStamp();
//        String _date1 = f.convertDateshowToSQL(date1);
//        String _date2 = f.convertDateshowToSQL(date2);
        try {
            getLanguage lang = new getLanguage();
...
//            parm.put("com2", company2);
            ...
            String frmName = "rptEStampGive_en1";
            String rptName = "rptEStampGive_en1";
    ...
    private void insertToTemp() {
        ...
        try {
            ...
            if (dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                sql1 = "SELECT concat(sb.stamp_barcode) as barcode,"
                        + "sb.stamp_campaign, c.s_campaignname, "
                        + "concat(sb.stamp_promotion,' ', sc.sp_name) as promotion , "
                        + "concat(sb.use_branch,' ', b.name) as branch , "
                        + "sb.use_billno,sb.use_date ,sb.use_time,sb.stamp_point "
                        + "FROM stamptran sb "
                        + "left join branfile b on sb.use_branch = b.code "
                        + "left join stampcampaign c on sb.stamp_campaign = c.s_campaigncode "
                        + "left join stamppromotion sc on sb.stamp_promotion = sc.sp_code "
...
//            System.out.println("insertToTemp// " + sql1);
            PreparedStatement pre1 = dbUtility.con.prepareStatement(sql1);
    ...
    private void ProcessPrintBean() {
        try {
            ...
            ds = new JRBeanCollectionDataSource(EStamp.EStampReport.dataBeanGivePoint.getCollectionGivePoint(Seek));
            parm.put("companyName", lang.getTextCompanyReport());
            parm.put("application", new GetApplicationName().getApplicationName());
            parm.put("user", new GetUser().getUser());

            String frmName = "rptEStampGive";
            String rptName = "ES_rptGivePoint";
