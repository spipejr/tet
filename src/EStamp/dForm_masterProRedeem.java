...
public class dForm_masterProRedeem extends javax.swing.JDialog {
    ...
    public dForm_masterProRedeem(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    private void initComponents() {
        ...
        setTitle("แฟ้มข้อมูลแสตมป์โปรโมชั่นสำหรับการแลก");
        ...
        jLabel18.setText("จำนวนสินค้าที่ให้แลก");
        jLabel18.setName("D_disper"); // NOI18N
        jPanel3.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 35, 120, 30));
        ...
        jPanel3.add(txt_saleitem, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 35, 60, 30));

        jLabel17.setFont(new java.awt.Font("Norasi", 1, 14)); // NOI18N
        jLabel17.setText("จำนวนแต้มที่ใช้แลก");
        jLabel17.setName("D_disper"); // NOI18N
        jPanel3.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 35, 110, 30));
        ...
        jPanel3.add(txt_salepoint, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 35, 60, 30));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 520, 80));
        ...
        if (tbl_fixplu.getColumnModel().getColumnCount() > 0) {
            ...
            tbl_fixplu.getColumnModel().getColumn(2).setPreferredWidth(170);
        }
        ...
        jPanel13.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 280, 380));
        ...
        if (tbl_unlinkplu.getColumnModel().getColumnCount() > 0) {
            ...
            tbl_unlinkplu.getColumnModel().getColumn(1).setPreferredWidth(100);
            tbl_unlinkplu.getColumnModel().getColumn(2).setPreferredWidth(180);
        }
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jPanel13, javax.swing.GroupLayout.PREFERRED_SIZE, 311, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        m1.setText("ฟังก์ชั่น");
        m1.setFont(new java.awt.Font("Norasi", 1, 14)); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(Tab, javax.swing.GroupLayout.PREFERRED_SIZE, 572, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        setSize(new java.awt.Dimension(1028, 732));
...
//        txtBGroupName.setText(frm.getBgname());
    ...
    private void btnBrowsBranchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBrowsBranchActionPerformed
        if (tbl_fixbranchgroup.getRowCount() > 0) {
            dBrows_BranchRedeem list = new dBrows_BranchRedeem(new NimbusFrame(), true, scode, procode);
...
//        loadFixPlu(scode, procode);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        dBrows_PrintStampProRedeem frm = new dBrows_PrintStampProRedeem(null, true);
        frm.setVisible(true);
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dForm_masterProRedeem.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dForm_masterProRedeem dialog = new dForm_masterProRedeem(new javax.swing.JFrame(), true);
    ...
    private void ProcessSave() {
        ...
        try {
            String sql = "select * from stampredeem where sr_campaign ='" + campaigncode + "' and sr_code='" + procode + "' ";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    String upd = "update  stampredeem set sr_name=?, sr_startdate=?, sr_enddate=?, sr_day=?, sr_saletype=?, "
                            + "sr_saletimeS=?, sr_saletimeE=?, sr_saleitem=?, sr_point=? where sr_campaign ='" + campaigncode + "' and sr_code='" + procode + "' ";
                ...
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    String inst = "insert into stampredeem(sr_name, sr_startdate, sr_enddate, sr_day, sr_saletype,"
                            + "sr_saletimeS, sr_saletimeE, sr_saleitem, sr_point, sr_campaign, sr_code) "
                            + "values(?,?,?,?,?,?,?,?,?,?,?)";
    ...
    private void ProcessDelete() {
        ...
        try {
            ...
            String sql = "delete from stampredeem  where sr_campaign='" + scode + "' and sr_code='" + procode + "' ";
            String sql1 = "delete from stampredeem_linkbgroup  where s_code='" + scode + "' and sr_code='" + procode + "' ";
            String sql2 = "delete from stampredeem_linkbranch  where s_code='" + scode + "' and sr_code='" + procode + "' ";
            String sql3 = "delete from stampredeem_linkplu  where s_code='" + scode + "' and sr_code='" + procode + "' ";
            String sql4 = "delete from stampredeem_exceptdate  where s_code='" + scode + "' and sr_code='" + procode + "' ";
    ...
    private void loadDataProAll() {
        ...
        String sql = "";
        if (rdall.isSelected()) {
            sql = "select * from stampredeem sr "
                    + "left join stampcampaign s on sr.sr_campaign = s.s_campaigncode "
                    + "order by sr.sr_campaign, sr.sr_code";
        } else {
            sql = "select * from stampredeem sr "
                    + "left join stampcampaign s on sr.sr_campaign = s.s_campaigncode "
                    + "where sr.sr_enddate>= '" + f.dateFmtSQL(new Date()) + "' order by sr.sr_campaign, sr.sr_code";
        }
                ...
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    do {
                        modelP.addRow(new Object[]{
                            ...
                            cvth.ASCII2Unicode(rs.getString("sr.sr_campaign")) + " - " + cvth.ASCII2Unicode(rs.getString("s.s_campaignname")),
                            ...
                            cvth.ASCII2Unicode(rs.getString("sr.sr_saleitem")),
                            cvth.ASCII2Unicode(rs.getString("sr.sr_point"))
                        });
                    } while (rs.next());
                } else {
                    do {
                        modelP.addRow(new Object[]{
                            ...
                            rs.getString("sr.sr_campaign") + " - " + rs.getString("s.s_campaignname"),
                            f.convertDatesqlToShow(rs.getString("sr.sr_startdate")),
                            f.convertDatesqlToShow(rs.getString("sr.sr_enddate")),
                            rs.getString("sr.sr_day"),
                            rs.getString("sr.sr_saletype"),
                            rs.getString("sr.sr_saleitem"),
                            rs.getString("sr.sr_point")
                        });
                    } while (rs.next());
                }
            }
...
//                txt_scdateend.setText(f.convertDatesqlToShow(rs.getString("s_campaignend")));
    ...
    private void searchStampPromotion(String _campaigncode, String _procode) {
        ...
        try {
            String sql = "select * from stampredeem sr "
                    + "left join stampcampaign s on sr.sr_campaign = s.s_campaigncode "
                    + "where sr.sr_campaign ='" + _campaigncode + "' and sr.sr_code='" + _procode + "' ";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    txt_sccode.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_campaign")));
                    txt_scname.setText(cvth.ASCII2Unicode(rs.getString("s.s_campaignname")));
                    txt_scdatestart.setText(cvth.ASCII2Unicode(f.convertDatesqlToShow(rs.getString("sr.sr_startdate"))));
                    txt_scdateend.setText(cvth.ASCII2Unicode(f.convertDatesqlToShow(rs.getString("sr.sr_enddate"))));
                    txt_procode.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_code")));
                    txt_proname.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_name")));
                    txt_proday.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_day")));
                    txt_saletype.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_saletype")));

                    pro_timestart.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_saletimeS")));
                    pro_timeend.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_saletimeE")));
                    txt_saleitem.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_saleitem")));
                    txt_salepoint.setText(cvth.ASCII2Unicode(rs.getString("sr.sr_point")));

                } else {
                    txt_sccode.setText(rs.getString("sr.sr_campaign"));
                    txt_scname.setText(rs.getString("s.s_campaignname"));
                    txt_scdatestart.setText(f.convertDatesqlToShow(rs.getString("sr.sr_startdate")));
                    txt_scdateend.setText(f.convertDatesqlToShow(rs.getString("sr.sr_enddate")));
                    txt_procode.setText(rs.getString("sr.sr_code"));
                    txt_proname.setText(rs.getString("sr.sr_name"));
                    txt_proday.setText(rs.getString("sr.sr_day"));
                    txt_saletype.setText(rs.getString("sr.sr_saletype"));

                    pro_timestart.setText(rs.getString("sr.sr_saletimeS"));
                    pro_timeend.setText(rs.getString("sr.sr_saletimeE"));
                    txt_saleitem.setText(rs.getString("sr.sr_saleitem"));
                    txt_salepoint.setText(rs.getString("sr.sr_point"));
                }

                //---------------------------------------------------------------------------------
                String day = txt_proday.getText(); //checkBoxboDay
                ...
                String sale = txt_saletype.getText(); //checkBoxSaletype
    ...
    private void loadFixbranchgroup(String scode, String procode) {
        ...
        try {
            String sql = "select * from stampredeem_linkbgroup sb "
                    + "left join branchgroup b on sb.bgcode = b.bgroupcode "
                    + "where sr_code='" + procode + "' and s_code='" + scode + "' ";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void addFixBranchGroup() {
        ...
        try {
            String sql = "select * from stampredeem_linkbgroup where s_code='" + scode + "' and sr_code='" + procode + "' and bgcode ='" + bgcode + "' ";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() == 0) {
                String inst = "insert into stampredeem_linkbgroup(s_code, sr_code, bgcode) values(?,?,?)";
                preUp = dbUtility.con.prepareStatement(inst);
    ...
    private void loadFixbranch(String scode, String procode) {
        ...
        try {
            String sql = "select * from stampredeem_linkbranch sb "
                    + "left join branfile b on sb.bcode = b.code "
                    + "where sb.s_code='" + scode + "' and sb.sr_code='" + procode + "' order by sb.bcode";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void addFixBranch() {
        ...
        try {
            String sql = "select * from stampredeem_linkbranch where s_code='" + scode + "' and sr_code='" + procode + "' and bcode ='" + bcode + "' ";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() == 0) {
                String inst = "insert into stampredeem_linkbranch(s_code, sr_code, bcode) values(?,?,?)";
                preUp = dbUtility.con.prepareStatement(inst);
                preUp.setString(1, scode);
                preUp.setString(2, procode);
    ...
    private void loadFixPlu(String scode, String procode) {
        ...
        try {
            ...
            String sql = "select * from stampredeem_linkplu sp "
                    + "left join product p on sp.pcode = p.pcode "
                    + "where sp.sr_code='" + procode + "' and sp.s_code='" + scode + "' "
...
//                } while (rs.next());
    ...
    private void addFixPlu(String pcode) {
        ...
        procode = txt_procode.getText().trim();
        try {
            String sql = "select * from stampredeem_linkplu where s_code='" + scode + "' and sr_code='" + procode + "' and pcode ='" + pcode + "' ";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() == 0) {
                String inst = "insert into stampredeem_linkplu(s_code,sr_code, pcode) values(?,?,?)";
                preUp = dbUtility.con.prepareStatement(inst);
                preUp.setString(1, scode);
                preUp.setString(2, procode);
...
//            }
    ...
    private void addExpDate() {
        ...
        try {
            if (checkDate()) {
                String sql = "select * from stampredeem_exceptdate where s_code='" + scode + "' and sr_code='" + procode + "' "
                        + "and exp_date='" + expdate + "' order by sr_code, exp_date ";
                String ins = "insert into stampredeem_exceptdate(s_code,sr_code, exp_date) values(?,?,?)";
                pre = dbUtility.con.prepareStatement(sql);
                rs = pre.executeQuery();
                rs.first();
                if (rs.getRow() != 0) {
    ...
    private void loadExceptdate(String scode, String procode) {
        ...
        try {
            String sql = "select * from stampredeem_exceptdate where s_code='" + scode + "' and sr_code='" + procode + "' order by exp_date";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void ProcessSaveExcel() {
        dBrows_ExcelStampProRedeem frm = new dBrows_ExcelStampProRedeem(null, true, tbl_promotion);
        frm.setVisible(true);
    }
...
//            e.printStackTrace();
    ...
    private void loadUnlinkPlu(String scode, String procode) {
        ...
        try {
            stmt = (Statement) dbUtility.con.createStatement();
            String sql = "select * from stampredeem_unlinkplu sr "
                    + "left join product p on sr.unpcode = p.pcode "
                    + "where sr.sr_code='" + procode + "' and sr.s_code='" + scode + "' "
                    + "order by p.pgroup, sr.unpcode ";
//            pre = dbUtility.con.prepareStatement(sql);
//            rs = pre.executeQuery();
//            rs.first();
            rs = stmt.executeQuery(sql);
...
//                do {
                if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                    modelUnlinkPlu.addRow(new Object[]{
                        cvth.ASCII2Unicode(rs.getString("p.pgroup")),
                        cvth.ASCII2Unicode(rs.getString("sr.unpcode")),
                        cvth.ASCII2Unicode(rs.getString("p.pdesc"))
                    });
                } else {
                    modelUnlinkPlu.addRow(new Object[]{
                        rs.getString("p.pgroup"),
                        rs.getString("sr.unpcode"),
                        rs.getString("p.pdesc")
                    });
                }
//                } while (rs.next());
    ...
    private void addUnLinkPlu(String pcode) {
        ...
        procode = txt_procode.getText().trim();
        try {
            String sql = "select * from stampredeem_unlinkplu where s_code='" + scode + "' and sr_code='" + procode + "' and unpcode ='" + pcode + "' ";
            pre = dbUtility.con.prepareStatement(sql);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() == 0) {
                String inst = "insert into stampredeem_unlinkplu(s_code,sr_code, unpcode) values(?,?,?)";
                preUp = dbUtility.con.prepareStatement(inst);
                preUp.setString(1, scode);
                preUp.setString(2, procode);
                preUp.setString(3, pcode);
    ...
    private void deleteBranch() {
        ...
        String bcode = "";
        try {
            String seek = "select * from stampredeem_linkbranch where s_code='" + scode + "' and sr_code='" + procode + "' and bcode=?";
            String sql = "delete from stampredeem_linkbranch where s_code='" + scode + "' and sr_code='" + procode + "' and bcode=?";
    ...
    private void deleteBGroup() {
        ...
        String bgcode = "";
        try {
            String seek = "select * from stampredeem_linkbgroup where s_code='" + scode + "' and sr_code='" + procode + "' and bgcode=?";
            String delBGroup = "delete from stampredeem_linkbgroup where s_code='" + scode + "' and sr_code='" + procode + "' and bgcode=?";
    ...
    private void deleteBGroupAll() {
        ...
        procode = txt_procode.getText().trim();
        try {
            String seek = "select * from stampredeem_linkbgroup where s_code='" + scode + "' and sr_code='" + procode + "' ";
            String sql = "delete from stampredeem_linkbgroup where s_code='" + scode + "' and sr_code='" + procode + "' ";
            pre = dbUtility.con.prepareStatement(seek);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void deleteBranchAll() {
        ...
        procode = txt_procode.getText().trim();
        try {
            String seek = "select * from stampredeem_linkbranch where s_code='" + scode + "' and sr_code='" + procode + "' ";
            String sql = "delete from stampredeem_linkbranch where s_code='" + scode + "' and sr_code='" + procode + "' ";
            pre = dbUtility.con.prepareStatement(seek);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void deletePLU() {
        ...
        String pcode = "";
        try {
            String seek = "select * from stampredeem_linkplu where s_code='" + scode + "' and sr_code='" + procode + "' and pcode=?";
            String sql = "delete from stampredeem_linkplu where s_code='" + scode + "' and sr_code='" + procode + "' and pcode=?";
    ...
    private void deletePLUAll() {
        ...
        procode = txt_procode.getText().trim();
        try {
            String seek = "select * from stampredeem_linkplu where s_code='" + scode + "' and sr_code='" + procode + "' ";
            String sql = "delete from stampredeem_linkplu where s_code='" + scode + "' and sr_code='" + procode + "' ";
            pre = dbUtility.con.prepareStatement(seek);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void deleteExpDate() {
        ...
        String expdate = "";
        try {
            String seek = "select * from stampredeem_linkplu where s_code='" + scode + "' and sr_code='" + procode + "' and exp_date=?";
            String sql = "delete from stampredeem_linkplu where s_code='" + scode + "' and sr_code='" + procode + "' and exp_date=?";
    ...
    private boolean checkbranchgroup() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (!bgroup.equals("")) {
                    String sqlBG = "select * from stampredeem_linkbgroup where bgcode ='" + bgroup + "' and s_code='" + scode + "' and sr_code='" + procode + "' ";
    ...
    private void getProductGroup(String group) {
        ...
        try {
            ...
            String sql = "SELECT product.pcode,pdesc,pgroup FROM product "
                    ...
                    + "left join stampredeem_linkbgroup on stampredeem_linkbgroup.bgcode=blink.bgroup "
                    + "where pgroup = '" + group + "' and s_code='" + txt_sccode.getText() + "' and sr_code='" + txt_procode.getText() + "' "
    ...
    public boolean chkplu(String scode, String procode, String plu) {
        ...
        try {
            ...
            String sql = "select p.pcode from product p "
                    ...
                    + "left join stampredeem_linkbgroup s on b.bgroup=s.bgcode "
                    + "where s.s_code ='" + scode + "' and s.sr_code='" + procode + "'  and p.pcode='" + plu + "' ";
            rs = stmt.executeQuery(sql);
            if (rs.next()) {
                chk = true;
            } else {
    ...
    public boolean chkFixplu(String scode, String procode, String plu) {
        ...
        try {
            stmt = (Statement) dbUtility.con.createStatement();
            String sql = "select *from stampredeem_linkplu "
                    + "where s_code ='" + scode + "' and sr_code='" + procode + "' and pcode='" + plu + "' ";
            rs = stmt.executeQuery(sql);
            if (rs.next()) {
                chk = true;
            } else {
    ...
    public boolean insertFixplu(String scode, String procode, String pcode) {
        ...
        try {
            stmt = (Statement) dbUtility.con.createStatement();
            sql = "insert into stampredeem_linkplu(s_code, sr_code, pcode) values('" + scode + "' , '" + procode + "','" + pcode + "')";
    ...
    private void BrowsUnlinkPlu() {
        Point point = btnBrowsPlu1.getLocation();
        point.setLocation(point.getX() + 1, point.getY() + 1);
        ListProduct dialog = new ListProduct(new NimbusFrame(), true);
        dialog.setVisible(true);
    ...
    public boolean chkUnlinkPlu(String scode, String procode, String plu) {
        ...
        try {
            stmt = (Statement) dbUtility.con.createStatement();
            String sql = "select *from stampredeem_unlinkplu "
                    + "where s_code ='" + scode + "' and sr_code='" + procode + "' and unpcode='" + plu + "' ";
            rs = stmt.executeQuery(sql);
            if (rs.next()) {
                chk = true;
            } else {
    ...
    private boolean insertUnlinkPlu(String scode, String procode, String pcode) {
        ...
        try {
            stmt = (Statement) dbUtility.con.createStatement();
            sql = "insert into stampredeem_unlinkplu(s_code, sr_code, unpcode) values('" + scode + "' , '" + procode + "','" + pcode + "')";
            rowInsert = stmt.executeUpdate(sql);
            System.out.println(" " + f.timeFmtmili(f.nowDate()));
            if (rowInsert > 0) {
                isupdate = true;
    ...
    private void deleteUnlinkPLU() {
        ...
        String pcode = "";
        try {
            String seek = "select * from stampredeem_unlinkplu where s_code='" + scode + "' and sr_code='" + procode + "' and unpcode=?";
            String sql = "delete from stampredeem_unlinkplu where s_code='" + scode + "' and sr_code='" + procode + "' and unpcode=?";
    ...
    private void deleteUnlinkPLUAll() {
        ...
        procode = txt_procode.getText().trim();
        try {
            String seek = "select * from stampredeem_unlinkplu where s_code='" + scode + "' and sr_code='" + procode + "' ";
            String sql = "delete from stampredeem_unlinkplu where s_code='" + scode + "' and sr_code='" + procode + "' ";
            pre = dbUtility.con.prepareStatement(seek);
            rs = pre.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
    ...
    private void checkuserconfig() {
        ...
        if (userrec.getMast27().equals("1")) {
            ...
            m3.setEnabled(false);
            m4.setEnabled(false);
        } else if (userrec.getMast27().equals("2")) {
            ...
            m3.setEnabled(true);
            m4.setEnabled(false);
        } else if (userrec.getMast27().equals("3")) {
            btnAdd.setEnabled(true);
            btnCancel.setEnabled(true);
            btnSave.setEnabled(true);
