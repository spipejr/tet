 ...
 * @author pos
 */
public class reportEStampRedeem_Bean {
    ...
    public List<reportEStampRedeem_Bean> children = new ArrayList<reportEStampRedeem_Bean>();

    public reportEStampRedeem_Bean(String u_barcode, String u_campaign, String u_refno, String u_date, String u_time, String u_point) {
    ...
    public List<reportEStampRedeem_Bean> getChildren() {
        return children;
    }

    public void setChildren(List<reportEStampRedeem_Bean> children) {
        this.children = children;
    }

    reportEStampRedeem_Bean() {
