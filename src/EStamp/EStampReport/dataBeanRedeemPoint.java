 ...
 * @author pos
 */
public class dataBeanRedeemPoint {
    ...
    public dataBeanRedeemPoint() {
    }

    public dataBeanRedeemPoint(String stamp_barcode, String stamp_campaign, String stamp_promotion, String ues_branchcode, String ues_branchname,
    ...
    public static Collection getCollectionRedeemPoint(String seek) {
        Statement stmt = null;
        ResultSet rs = null;
        PreparedStatement pre = null;
        Collection<dataBeanRedeemPoint> col = new ArrayList();
        String sql = seek;
        try {
            ...
            if (rs.getRow() != 0) {
                do {
                    if (db.Char_Set.equalsIgnoreCase("utf-8")) {
                        col.add(new dataBeanRedeemPoint(
