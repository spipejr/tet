 ...
 * @author soneping
 */
public class masterSAP_code_distype extends javax.swing.JDialog {
    ...
    private String createuser = UserLogin.userlogin.getUserName();
    private String createdate = "";
    private String createtime = "00:00:01";
    private ArrayList<sap_mastercode_distype> list;
    //==============================================
    utilitySAP us = new utilitySAP();
    formatDateNum fdn = new formatDateNum();
    eventFocus ef = new eventFocus();
    sap_mastercode_distype smd;

    public masterSAP_code_distype(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        model = us.setTable(jTable1, "1,2,3", "0,", ",");
        clearForm();
    ...
    private void initComponents() {
        ...
        com_distype = new javax.swing.JComboBox();
        ...
        setTitle("แฟ้มข้อมูลรหัสส่วนลดในการขาย (SAP Mapping)");
        ...
        jLabel3.setText("ใช้กับ");

        com_distype.setFont(new java.awt.Font("Norasi", 0, 14)); // NOI18N
        com_distype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-P: ส่วนลดโปรโมชั่น", "-M: ส่วนลดสมาชิก", "-E: ส่วนลดพนักงาน", "-D: ส่วนลดหักเงินมัดจำ", "-C: รายได้ค่าบริการ" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(com_distype, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(com_distype, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void txtCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodeKeyPressed
        this.dis_sap_code = txtCode.getText().trim();
    ...
    private void txtNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNameKeyPressed
        this.dis_sap_name = txtName.getText().trim();
        if (evt.getKeyCode() == evt.VK_ENTER) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(masterSAP_code_distype.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                masterSAP_code_distype dialog = new masterSAP_code_distype(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox com_distype;
    ...
    private void clearForm() {
        ...
        com_distype.setEnabled(false);

        dis_sap_code = "";
        dis_sap_name = "";
        dis_sale_type = "";
        dis_sale_description = "";
        createuser = UserLogin.userlogin.getUserName();
        createdate = fdn.dateFmtSQL(fdn.nowDate());
        createtime = "00:00:01";
    ...
    private void openForm() {
        ...
        com_distype.setEnabled(true);
    }

    private void loadData() {
        us.resetTable(model);

        smd = new sap_mastercode_distype();
        list = smd.seekAll();
        for (int i = 0; i < list.size(); i++) {
            model.addRow(new Object[]{
                list.get(i).getDis_sap_code(),
                list.get(i).getDis_sap_name(),
                list.get(i).getDis_sale_type() + ": " + list.get(i).getDis_sale_description(),
                list.get(i).getSap_createuser()
            });
        }
    }
    ...
    private void seek() {
        this.dis_sap_code = txtCode.getText().trim();
        if (this.dis_sap_code.length() <= 0) {
            us.openTextFiled(txtCode, false, true);
        } else {
            smd = new sap_mastercode_distype();
            smd = smd.seek(this.dis_sap_code);
            if (smd.isHave()) {
                txtCode.setText(smd.getDis_sap_code());
                txtName.setText(smd.getDis_sap_name());
                String strMap = smd.getDis_sale_type() + ": " + smd.getDis_sale_description();
                com_distype.setSelectedItem(strMap);
            }
            openForm();
        }
    }
    ...
    private void save() {
        String[] mapping = com_distype.getSelectedItem().toString().split(":");
        dis_sap_code = txtCode.getText().trim();
        dis_sap_name = txtName.getText();
        dis_sale_type = mapping[0];
        dis_sale_description = mapping[1].substring(1, mapping[1].length());
        createuser = UserLogin.userlogin.getUserName();
        createdate = fdn.dateFmtSQL(fdn.nowDate());
        createtime = fdn.timeFmt(fdn.nowDate());

        smd = new sap_mastercode_distype(this.dis_sap_code, this.dis_sap_name, this.dis_sale_type, this.dis_sale_description, this.createuser, this.createdate, this.createtime);
        if (smd.execute()) {
            clearForm();
        } else {
            us.openTextFiled(txtName, false, true);
    ...
    private void delete() {
        ...
        if (this.dis_sap_code.length() > 0) {
            ...
            if (smd.isHave()) {
                if (smd.delete()) {
                    new showMessage().showMessageInformation("ลบข้อมูลเรียบร้อยแล้ว", "masterSAP_code_distype.delete()");
                    clearForm();
                }
            }
            us.openTextFiled(txtCode, false, true);
    ...
    private void checkuserconfig() {
        ...
        if (userrec.getMast29().equals("1")) {
        ...
        } else if (userrec.getMast29().equals("2")) {
            ...
            menu_remove.setEnabled(false);
        } else if (userrec.getMast29().equals("3")) {
            btn_add.setEnabled(true);
            btn_cancel.setEnabled(true);
            btn_save.setEnabled(true);
