 ...
 * @author soneping
 */
public class masterSAP_Department extends javax.swing.JDialog {
    ...
    private String dept_costcenter;
    private String dept_active;
    ...
    public masterSAP_Department(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        btn_print.setVisible(false);
    ...
    private void initComponents() {
        ...
        setTitle("แฟ้มข้อมูลหน่วยยงาน (SAP Department Code)");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสหน่วยงาน", "คำอธิบาย", "SAP_Costcenter", "Active"
            }
        ) {
        ...
        jLabel4.setText("SAP Cost Center");

        txtCostcenter.setFont(new java.awt.Font("Norasi", 1, 14)); // NOI18N
        txtCostcenter.setText("ZE10");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtCostcenter, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void txtCodeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodeKeyPressed
        this.dept_code = txtCode.getText().trim();
        if (evt.getKeyCode() == evt.VK_ENTER) {
            if (this.dept_code.length() > 0) {
                seek();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(masterSAP_Department.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                masterSAP_Department dialog = new masterSAP_Department(new javax.swing.JFrame(), true);
...
//        btn_print.setVisible(false);
        ...
        String sql = "SELECT * FROM sap_department order by dept_code";
        try {
            ...
            if (rs.getRow() != 0) {
                do {
                    model.addRow(new Object[]{
                        ...
                        cvth.ASCII2Unicode(rs.getString("dept_name")),
                        rs.getString("dept_costcenter"),
                        rs.getString("dept_active"),
                    });
                } while (rs.next());
            }
        } catch (Exception e) {
        ...
        us.closeTextFiled(txtCostcenter, true);
    ...
    private void openForm() {
        ...
        us.openTextFiled(txtCostcenter, false, true);
        txtName.requestFocus();
    }

    private void btnSave() {
        this.dept_code = txtCode.getText().trim();
        this.dept_name = txtName.getText();
        this.dept_costcenter = txtCostcenter.getText() ;
        if (dept_name.equals("")) {
            JOptionPane.showMessageDialog(null, "กรุณากำหนด ชื่อหน่วยงาน ...");
            return ;
        }
        if (dept_costcenter.equals("")) {
            JOptionPane.showMessageDialog(null, "กรุณากำหนด Cost Center ของหน่วยงาน ...");
            return ;
        }
        String sql = "SELECT * FROM sap_department where dept_code=? order by dept_code";
        String execute = "insert into sap_department (dept_name, dept_costcenter,dept_active,dept_code) values(?,?,?,?)";
        try {
            ps = dbutility.dbUtility.con.prepareStatement(sql);
            ps.setString(1, this.dept_code);
            rs = ps.executeQuery();
            rs.first();
            if (rs.getRow() != 0) {
                execute = "update sap_department set "
                        + "dept_name=?, dept_costcenter=?, dept_active=? "
                        + "where dept_code=?";
            } else {
                execute = "insert into sap_department(dept_name, dept_costcenter, dept_active,dept_code) values(?,?,?,?)";
            }
            String sap_active = "" ;
            ...
            ps.setString(1, cvth.Unicode2ASCII(this.dept_name));
            ps.setString(2,  this.dept_costcenter);
            ps.setString(3, sap_active);
            ps.setString(4, this.dept_code);
            ps.executeUpdate();
            clearForm();
        } catch (Exception e) {
    ...
    private void btnDel() {
        ...
        this.dept_code = txtCode.getText().trim();
        String sql = "delete from sap_department where dept_code=?";
    ...
    private void seek() {
        ...
        try {
            ...
            if (rs.getRow() != 0) {
                ...
                txtName.setText(cvth.ASCII2Unicode(rs.getString("dept_name")));
                txtCostcenter.setText(rs.getString("dept_costcenter"));
                if (rs.getString("dept_active").equals("Y")) {
                    r_active.setSelected(true);
                } else {
