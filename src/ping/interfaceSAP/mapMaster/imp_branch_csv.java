 ...
 * @author soneping
 */
public class imp_branch_csv extends javax.swing.JDialog {
    ...
    public imp_branch_csv(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(imp_branch_csv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                imp_branch_csv dialog = new imp_branch_csv(new javax.swing.JFrame(), true);
...
//                        dispose();
    ...
    public void insertNew2(String StrS[]) {
        String bran = "";
        String vuser = "";
        //--------------------------------------------------------------------
        bran = StrS[0] ;
        ...
        try {
            stmt = (Statement) dbUtility.con.createStatement();
            String sql = "Insert into branvoid (b_code,u_code) "
                    + " values(?,?)";
            PreparedStatement prm = (PreparedStatement) dbUtility.con.prepareStatement(sql);
            prm.setString(1, bran);
            prm.setString(2, vuser);
            prm.executeUpdate();
            stmt.close();
        } catch (Exception e) {
