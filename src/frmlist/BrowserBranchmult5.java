 ...
 * @author natee
 */
public class BrowserBranchmult5 extends javax.swing.JDialog {
    ...
    public BrowserBranchmult5(java.awt.Frame parent, boolean modal, String code) {
        super(parent, modal);
        initComponents();
        checkuserconfig() ;
        db.dbconnect();
    ...
    public BrowserBranchmult5(java.awt.Frame parent, boolean modal, Point point) {
        this(parent, modal, "");
...
private void checkuserconfig() {
                ...
                if (chkbox.equalsIgnoreCase("true")) {
                    if (!chk(code, tblList.getValueAt(i, 2).toString())) {
                        if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                            stmt = (Statement) dbUtility.con.createStatement();
                            String sql = "Insert into fixgppromotion (bcode,prcode) "
                                    + " values(?,?)";
                        ...
                        stmt = (Statement) dbUtility.con.createStatement();
                        String sql2 = "Delete from fixgppromotion where bcode = ? and prCode = '" + code + "'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchmult5 dialog = new BrowserBranchmult5(new javax.swing.JFrame(), true, "");
    ...
    public boolean chk(String code, String bcode) {
        ...
        try {
            sql = "SELECT * FROM fixgppromotion WHERE bcode='" + bcode + "' and prcode = '" + code + "'";
            stmt = dbUtility.con.createStatement();
