 ...
 * @author s386
 */
public class listBgroupOfEff extends javax.swing.JDialog {
    ...
    int index = 0;
    String code = "";
    public listBgroupOfEff(java.awt.Frame parent, boolean modal,String Code) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tblBgroup.setFont(new java.awt.Font("Norasi", 0, 14));
        ...
        db_btnOK.setFont(new java.awt.Font("Norasi", 1, 14));
        ...
        db_btnExit.setFont(new java.awt.Font("Norasi", 1, 14));
        db_btnExit.setText("ออก (Exit)");
        db_btnExit.setName("db_btnExit"); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                listBgroupOfEff dialog = new listBgroupOfEff(new javax.swing.JFrame(), true,"");
    ...
    try {
        ...
        if(!db.Char_Set.equalsIgnoreCase("utf-8"))
            {        
        sql = "select * from blink l left join branchgroup b on l.bgroup = b.bgroupcode where l.pcode = '"+cvth.Unicode2ASCII(code)+"'";
            }
        else
        {
        sql = "select * from blink l left join branchgroup b on l.bgroup = b.bgroupcode where l.pcode = '"+code+"'";
        }
        ...
        while(rs.next())
        {
            if(!db.Char_Set.equalsIgnoreCase("utf-8"))
            {
            tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("bgroup").toUpperCase()),cvth.ASCII2Unicode(rs.getString("bgroupname"))});
            }
            else
            {
            tbBranctype.addRow(new Object[]{rs.getString("bgroup").toUpperCase(),rs.getString("bgroupname")});
