 ...
 * @author natee
 */
public class BrowserBrand extends javax.swing.JDialog {
    ...
    public BrowserBrand(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserBrand(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBrand.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBrand dialog = new BrowserBrand(new javax.swing.JFrame(), true);
    ...
    private void initTable() {
        ...
        try {
            String sql = "select brandcode,brandname "
                    + "from brandfile";
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM brandfile WHERE brandcode='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        fb.setCode(cvth.ASCII2Unicode(rs.getString("brandcode")));
                        fb.setName(cvth.ASCII2Unicode(rs.getString("brandname")));
                    } else {
                        fb.setCode(rs.getString("brandcode"));
                        fb.setName(rs.getString("brandname"));
                    }
