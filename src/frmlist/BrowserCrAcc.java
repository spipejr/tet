 ...
 * @author natee
 */
public class BrowserCrAcc extends javax.swing.JDialog {
    ...
    public BrowserCrAcc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserCrAcc(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserCrAcc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserCrAcc dialog = new BrowserCrAcc(new javax.swing.JFrame(), true);
    ...
    private void initTable() {
        ...
        try {
            String sql = "select Bank_Code,Bank_Name "
                    + "from craccno";
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM craccno where Bank_Code='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        fb.setCode(cvth.ASCII2Unicode(rs.getString("Bank_Code")));
                        fb.setName(cvth.ASCII2Unicode(rs.getString("Bank_Name")));
                    } else {
                        fb.setCode(rs.getString("Bank_Code"));
                        fb.setName(rs.getString("Bank_Name"));
                    }
