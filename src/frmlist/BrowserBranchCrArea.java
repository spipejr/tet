 ...
 * @author natee
 */
public class BrowserBranchCrArea extends javax.swing.JDialog {
    ...
    public BrowserBranchCrArea(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserBranchCrArea(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBranchCrArea.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchCrArea dialog = new BrowserBranchCrArea(new javax.swing.JFrame(), true);
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM crarea WHERE Code='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
