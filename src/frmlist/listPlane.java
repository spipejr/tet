 ...
 * @author s386
 */
public class listPlane extends javax.swing.JDialog {

    /**
     * Creates new form listPlane
     */
    ...
    public String bname = "";
    int index = 0;
    public listPlane(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listPlane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                listPlane dialog = new listPlane(new javax.swing.JFrame(), true);
