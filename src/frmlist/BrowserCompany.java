 ...
 * @author natee
 */
public class BrowserCompany extends javax.swing.JDialog {
    ...
    public BrowserCompany(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserCompany(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserCompany.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserCompany dialog = new BrowserCompany(new javax.swing.JFrame(), true);
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM company WHERE Code='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
