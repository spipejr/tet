 ...
 * @author s386
 */
public class CashierNumber extends javax.swing.JDialog {
    ...
    Statement stmt;
    String frmName = "CashierNumber";
    ThaiUtilities cvth = new ThaiUtilities();
    public String bcode = "";
    public String bname = "";
    int index = 0;

    public CashierNumber(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(460, 504));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashierNumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                CashierNumber dialog = new CashierNumber(new javax.swing.JFrame(), true);
...
private void showdata() {
        ...
        try {
            ...
            String sql = "SELECT * from posuser order by UserName";
            rs = stmt.executeQuery(sql);
            while (rs.next()) {
                if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
                    tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("UserName")), cvth.ASCII2Unicode(rs.getString("Name"))});
                } else {
                    tbBranctype.addRow(new Object[]{rs.getString("UserName"), rs.getString("Name")});
                }
            }
        } catch (Exception e) {
        }
