...
private void showdata() {
    ...
    try {
        ...
        while(rs.next())
        {
            ...
            {
            tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("brandcode")),cvth.ASCII2Unicode(rs.getString("brandname"))});
            }
            else
            {
            tbBranctype.addRow(new Object[]{rs.getString("brandcode"),rs.getString("brandname")});
            }
        }
    } catch (Exception e) {
    }
