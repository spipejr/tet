 ...
 * @author s386
 */
public class XlistVender extends javax.swing.JDialog {

    /**
     * Creates new form XlistVender
     */
      DefaultTableModel tbVendor ;
    dbUtility db = new dbUtility();
    Statement stmt ;
    String frmName = "listvender2";
    ThaiUtilities cvth = new ThaiUtilities();
    public String code = "";
    public String name = "";
    int index = 0;
    public XlistVender(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        tbVendor = (DefaultTableModel) tbl.getModel();
    ...
    private void initComponents() {
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสผู้จัดจำหน่าย", "ชื่อผู้จัดจำหน่าย"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XlistVender.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                XlistVender dialog = new XlistVender(new javax.swing.JFrame(), true);
 ...
 private void showdata() {
    ...
    tbVendor = (DefaultTableModel) tbl.getModel();
     int cnt = tbVendor.getRowCount();
        if (cnt > 0) {
            for (int i = 0; i < cnt; i++) {
                tbVendor.removeRow(0);
            }
        }
    try {
        ...
        while(rs.next())
        {
            ...
            {
            tbVendor.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("vcode")),cvth.ASCII2Unicode(rs.getString("vname"))});
            }
            else
            {
            tbVendor.addRow(new Object[]{rs.getString("vcode"),rs.getString("vname")});
            }
        }
    } catch (Exception e) {
    }
