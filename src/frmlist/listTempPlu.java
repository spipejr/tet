 ...
 * @author s386
 */
public class listTempPlu extends javax.swing.JDialog {

    /**
     * Creates new form listTempPlu
     */
    ...
    public String bname = "";
    int index = 0;
    public listTempPlu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        lang.setText(frmName, this, lang.getChklang());
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-342)/2, (screenSize.height-423)/2, 342, 423);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listTempPlu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                listTempPlu dialog = new listTempPlu(new javax.swing.JFrame(), true);
    ...
    try {
        ...
        while(rs.next())
        {
            ...
            {
            tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("plugroup"))});
            }
            else
            {
            tbBranctype.addRow(new Object[]{rs.getString("plugroup")});
            }
        }
    } catch (Exception e) {
    }
