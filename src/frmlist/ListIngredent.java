...
public class ListIngredent extends javax.swing.JDialog {
    ...
    public String code="";
    public String name="";
    String frmname="listingredent";
    public ListIngredent(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
    ...
    private void initComponents() {
        ...
        tbltable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "รหัสวัตถุดิบ", "ชื่อวัตถุดิบ", "รหัสกลุ่ม", "หน่วยนับหลัก", "ราคาทุน/หน่วยหลัก", "หน่วยย่อย", "อัตราส่วนต่อหน่วย", "ชื่อกลุ่ม"
            }
        ) {
        ...
        tbltable.getColumnModel().getColumn(0).setPreferredWidth(120);
        tbltable.getColumnModel().getColumn(0).setMaxWidth(120);
        tbltable.getColumnModel().getColumn(1).setMinWidth(230);
        tbltable.getColumnModel().getColumn(1).setPreferredWidth(230);
        tbltable.getColumnModel().getColumn(1).setMaxWidth(230);
        tbltable.getColumnModel().getColumn(2).setMinWidth(80);
        tbltable.getColumnModel().getColumn(2).setPreferredWidth(80);
        tbltable.getColumnModel().getColumn(3).setMinWidth(120);
        tbltable.getColumnModel().getColumn(3).setPreferredWidth(120);
        tbltable.getColumnModel().getColumn(3).setMaxWidth(120);
        tbltable.getColumnModel().getColumn(4).setMinWidth(150);
        tbltable.getColumnModel().getColumn(4).setPreferredWidth(150);
        tbltable.getColumnModel().getColumn(4).setMaxWidth(150);
        tbltable.getColumnModel().getColumn(5).setMinWidth(150);
        tbltable.getColumnModel().getColumn(5).setPreferredWidth(150);
        tbltable.getColumnModel().getColumn(5).setMaxWidth(150);
        tbltable.getColumnModel().getColumn(6).setMinWidth(150);
        tbltable.getColumnModel().getColumn(6).setPreferredWidth(150);
        tbltable.getColumnModel().getColumn(6).setMaxWidth(150);
        tbltable.getColumnModel().getColumn(7).setMinWidth(300);
        tbltable.getColumnModel().getColumn(7).setPreferredWidth(300);
        tbltable.getColumnModel().getColumn(7).setMaxWidth(300);
        ...
        db_h1.setText("ค้นหาจากวัตถุดิบ");
        db_h1.setName("db_h1");
        ...
        setBounds((screenSize.width-1032)/2, (screenSize.height-793)/2, 1032, 793);
    ...
    private void txtnameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnameKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!txtname.getText().trim().equals("")) {
                showtable("inname", txtname.getText());
            } else {
                txtid.requestFocus();
            }
        }
    ...
    private void txtidKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtidKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!txtid.getText().trim().equals("")) {
                showtable("incode", txtid.getText());
            } else {
...
//        tcm.getColumn(10).setCellRenderer(l);
        ...
        try {
            ...
            while (rs.next()) {
                if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                    combo1.addItem(cvth.ASCII2Unicode(rs.getString("inggroupCode")) + " - " + cvth.ASCII2Unicode(rs.getString("ingGroupName")));
                } else {
                    combo1.addItem(rs.getString("ingGroupCode") + " - " + rs.getString("ingGroupName"));
                }
                txtgroup.setText("");
            }
    ...
    private void showtable(String where,String code)
    {
        try {
            ...
            if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
            String sql = "select * from ingredent inner join inggroup on ingredent.ingroup = inggroup.inggroupcode where "+where+"  like '%" + cvth.Unicode2ASCII(code) + "%' order by inCode";
            ResultSet rs = stmt.executeQuery(sql);
            while (rs.next()) {
                String remark ="";
                count++;
                                ...
                                cvth.ASCII2Unicode(rs.getString("ingroup")),
                                cvth.ASCII2Unicode(rs.getString("inunit")),
                                rs.getDouble("incost"),
            ...
            while (rs.next()) {
                ...
                count++;
                                ...
                                rs.getString("incode"),
                                rs.getString("inname"),
                                rs.getString("ingroup"),
                                rs.getString("inunit"),
                                rs.getDouble("incost"),
                                rs.getString("insubunit"),
                                rs.getDouble("inpack"),
    ...
    if(!txtgroup.getText().trim().equals(""))
        {
        showtable("ingroup", txtgroup.getText());
        }
        else
        {
