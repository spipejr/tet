...
public class listBranchGroup extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblBgroup.getColumnModel().getColumn(1).setPreferredWidth(0);
    ...
    try {
        ...
        while(rs.next())
        {
            ...
            {
            tbBranctype.addRow(new Object[]{true,cvth.ASCII2Unicode(rs.getString("bgroupcode")),cvth.ASCII2Unicode(rs.getString("bgroupname"))});
            }
            else
            {
