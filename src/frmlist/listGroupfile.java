 ...
 * @author s386
 */
public class listGroupfile extends javax.swing.JDialog {

    /**
     * Creates new form listGroupfile
     */
    ...
    public String name = "";
    int index = 0;
    public listGroupfile(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("แสดงรายการ DEPT สินค้า");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listGroupfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                listGroupfile dialog = new listGroupfile(new javax.swing.JFrame(), true);
 ...
 private void showdata() {
    ...
    try {
        ...
        while(rs.next())
        {
            ...
            {
            tbList.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("groupcode")),cvth.ASCII2Unicode(rs.getString("groupname"))});
            }
            else
            {
            tbList.addRow(new Object[]{rs.getString("groupcode"),rs.getString("groupname")});
            }
        }
    } catch (Exception e) {
    }
