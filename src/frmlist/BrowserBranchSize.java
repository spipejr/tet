 ...
 * @author natee
 */
public class BrowserBranchSize extends javax.swing.JDialog {
    ...
    public BrowserBranchSize(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserBranchSize(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBranchSize.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchSize dialog = new BrowserBranchSize(new javax.swing.JFrame(), true);
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM size WHERE Code='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
