 ...
 * @author s386
 */
public class listeCoupon extends javax.swing.JDialog {
    ...
    public String bname = "";
    int index = 0;
    public listeCoupon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        lang.setText(frmName, this, lang.getChklang());
    ...
    private void initComponents() {
        ...
        tblCoupon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "รหัส BarCode", "ชื่อบัตรคูปอง"
            }
        ) {
        ...
        tblCoupon.getColumnModel().getColumn(0).setPreferredWidth(80);
        tblCoupon.getColumnModel().getColumn(1).setPreferredWidth(100);
        tblCoupon.getColumnModel().getColumn(2).setPreferredWidth(250);
        ...
        setBounds((screenSize.width-459)/2, (screenSize.height-604)/2, 459, 604);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listeCoupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                listeCoupon dialog = new listeCoupon(new javax.swing.JFrame(), true);
...
private void showdata() {
    ...
    try {
        ...
        String sql = "select * from ecupon order by cucode";
        ...
        while(rs.next())
        {
            ...
            {
            tbCoupon.addRow(new Object[]{rs.getString("cucode"),
