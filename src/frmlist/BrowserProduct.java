 ...
 * @author natee
 */
public class BrowserProduct extends javax.swing.JDialog {
    ...
    public BrowserProduct(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserProduct(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    private void initComponents() {
        ...
        tblList.getColumnModel().getColumn(0).setMaxWidth(120);
        tblList.getColumnModel().getColumn(1).setMinWidth(360);
        tblList.getColumnModel().getColumn(1).setPreferredWidth(360);
        tblList.getColumnModel().getColumn(1).setMaxWidth(360);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserProduct dialog = new BrowserProduct(new javax.swing.JFrame(), true);
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM Product WHERE PCode='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        fb.setCode(cvth.ASCII2Unicode(rs.getString("PCode")));
                        fb.setName(cvth.ASCII2Unicode(rs.getString("PDesc")));
                    } else {
                        fb.setCode(rs.getString("PCode"));
                        fb.setName(rs.getString("PDesc"));
                    }
