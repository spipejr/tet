 ...
 * @author natee
 */
public class BrowserBranchType extends javax.swing.JDialog {
    ...
    public BrowserBranchType(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserBranchType(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBranchType.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchType dialog = new BrowserBranchType(new javax.swing.JFrame(), true);
    ...
    private void initTable() {
        ...
        try {
            String sql = "select BTCode,BTName "
                    + "from btype";
            ...
            while (rs.next()) {
                if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                    model.addRow(new Object[]{
                                cvth.ASCII2Unicode(rs.getString("BTCode")),
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM btype WHERE BTCode='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        fb.setCode(cvth.ASCII2Unicode(rs.getString("BTCode")));
                        fb.setName(cvth.ASCII2Unicode(rs.getString("BTName")));
                    } else {
                        fb.setCode(rs.getString("BTCode"));
                        fb.setName(rs.getString("BTName"));
                    }
