 ...
 * @author natee
 */
public class BrowserBustype extends javax.swing.JDialog {
    ...
    public BrowserBustype(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserBustype(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBustype.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBustype dialog = new BrowserBustype(new javax.swing.JFrame(), true);
    ...
    private void initTable() {
        ...
        try {
            String sql = "select buscode,busname "
                    + "from businesstype";
            ...
            while (rs.next()) {
                if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                    model.addRow(new Object[]{
                                cvth.ASCII2Unicode(rs.getString("buscode")),
                                cvth.ASCII2Unicode(rs.getString("busname")),});
                } else {
                    model.addRow(new Object[]{
                                rs.getString("buscode"),
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM businesstype WHERE buscode='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        fb.setCode(cvth.ASCII2Unicode(rs.getString("buscode")));
                        fb.setName(cvth.ASCII2Unicode(rs.getString("busname")));
                    } else {
                        fb.setCode(rs.getString("buscode"));
                        fb.setName(rs.getString("busname"));
                    }
