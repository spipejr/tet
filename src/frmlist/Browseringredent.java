 ...
 * @author natee
 */
public class Browseringredent extends javax.swing.JDialog {
    ...
    public Browseringredent(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public Browseringredent(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Browseringredent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Browseringredent dialog = new Browseringredent(new javax.swing.JFrame(), true);
    ...
    private void initTable() {
        ...
        try {
            String sql = "select InCode,InName "
                    + "from ingredent";
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM ingredent WHERE InCode='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        fb.setCode(cvth.ASCII2Unicode(rs.getString("InCode")));
                        fb.setName(cvth.ASCII2Unicode(rs.getString("InName")));
                    } else {
                        fb.setCode(rs.getString("InCode"));
                        fb.setName(rs.getString("InName"));
                    }
