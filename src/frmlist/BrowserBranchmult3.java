 ...
 * @author natee
 */
public class BrowserBranchmult3 extends javax.swing.JDialog {
    ...
    public BrowserBranchmult3(java.awt.Frame parent, boolean modal, String code, DefaultTableModel model3) {
        super(parent, modal);
        initComponents();
        checkuserconfig();
        db.dbconnect();
...
//        tcm.getColumn(1).setCellRenderer(l);
    ...
    public BrowserBranchmult3(java.awt.Frame parent, boolean modal, Point point) {
                ...
                if (chkbox.equalsIgnoreCase("true")) {
                    if (!chk(code, tblList.getValueAt(i, 2).toString())) {
                        if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                            stmt = (Statement) dbUtility.con.createStatement();
                            String sql = "Insert into fixbranchecoupon (bcode,cucode) "
                                    + " values(?,?)";
                        ...
                        stmt = (Statement) dbUtility.con.createStatement();
                        String sql2 = "Delete from fixbranchecoupon where bcode = ? and CuCode = '" + code + "'";
...
//                    JOptionPane.showMessageDialog(this, chkbox);
                if (chkbox.equalsIgnoreCase("true")) {
                    if (!chk(code, tblList.getValueAt(i, 2).toString())) {
                        if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                            ...
                            stmt = (Statement) dbUtility.con.createStatement();
                            String sql = "Insert into eculink (bcode,cucode,fixbranch) "
                                    + " values(?,?)";
                            PreparedStatement prm2 = (PreparedStatement) dbUtility.con.prepareStatement(sql);
                            prm2.setString(2, cvth.Unicode2ASCII(code));
                            prm2.setString(1, cvth.Unicode2ASCII(tblList.getValueAt(i, 2).toString()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBranchmult3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchmult3 dialog = new BrowserBranchmult3(new javax.swing.JFrame(), true, "", new DefaultTableModel());
    ...
    private void initTable() {
        ...
        try {
            String sql = "select branfile.bgroup,name,code from branfile "
                    + "left join eculink on eculink.bgroup=branfile.bgroup "
                    + "where cucode='"+code+"' "
    ...
    public boolean chk(String code, String bcode) {
        ...
        try {
            sql = "SELECT * FROM fixbranchecoupon WHERE bcode='" + bcode + "' and cucode = '" + code + "'";
            stmt = dbUtility.con.createStatement();
