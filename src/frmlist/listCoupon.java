 ...
 * @author s386
 */
public class listCoupon extends javax.swing.JDialog {
    ...
    public String bname = "";
    int index = 0;
    public listCoupon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        lang.setText(frmName, this, lang.getChklang());
    ...
    private void initComponents() {
        ...
        tblCoupon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "รหัส BarCode", "ชื่อบัตรคูปอง", "วันที่เริ่มต้น", "วันที่สิ้นสุด", "วันที่ให้ส่วนลดได้", "Cu-Type", "ส่วนลด %", "ส่วนลดบาท", "ใช้เป็นส่วนลดหลัก", "Redule Discount", "Redule Service", "ยอดซื้อขั้นต่ำ", "ประเภทการขาย"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listCoupon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                listCoupon dialog = new listCoupon(new javax.swing.JFrame(), true);
...
private void showdata() {
    ...
    try {
        ...
        while(rs.next())
        {
            ...
            {
            tbCoupon.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("cucode")),
                                      cvth.ASCII2Unicode(rs.getString("cubarcode")),
                                      cvth.ASCII2Unicode(rs.getString("cuname")),
                                      cvth.ASCII2Unicode(dateFmtShow.format(rs.getDate("cubegin"))),
                                      cvth.ASCII2Unicode(dateFmtShow.format(rs.getDate("cuend"))),
