 ...
 * @author natee
 */
public class BrowserBranchGroup extends javax.swing.JDialog {
    ...
    public BrowserBranchGroup(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserBranchGroup(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBranchGroup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchGroup dialog = new BrowserBranchGroup(new javax.swing.JFrame(), true);
    ...
    private void initTable() {
        ...
        try {
            String sql = "select BGroupCode,BGroupName "
                    + "from branchgroup";
            ...
            while (rs.next()) {
                if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                    model.addRow(new Object[]{
                                cvth.ASCII2Unicode(rs.getString("BGroupCode")),
                                cvth.ASCII2Unicode(rs.getString("BGroupName")),});
                } else {
                    model.addRow(new Object[]{
                                rs.getString("BGroupCode"),
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM branchgroup WHERE BGroupCode='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                        fb.setCode(cvth.ASCII2Unicode(rs.getString("BGroupCode")));
                        fb.setName(cvth.ASCII2Unicode(rs.getString("BGroupName")));
                    } else {
                        fb.setCode(rs.getString("BGroupCode"));
                        fb.setName(rs.getString("BGroupName"));
                    }
