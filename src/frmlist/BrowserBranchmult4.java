 ...
 * @author natee
 */
public class BrowserBranchmult4 extends javax.swing.JDialog {
    ...
    public BrowserBranchmult4(java.awt.Frame parent, boolean modal, String code, DefaultTableModel model3) {
        super(parent, modal);
        initComponents();
        checkuserconfig();
        db.dbconnect();
    ...
    public BrowserBranchmult4(java.awt.Frame parent, boolean modal, Point point) {
                ...
                if (chkbox.equalsIgnoreCase("true")) {
                    if (!chk(code, tblList.getValueAt(i, 2).toString())) {
                        if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                            stmt = (Statement) dbUtility.con.createStatement();
                            String sql = "Insert into fixbranchpropoint (bcode,procode) "
                                    + " values(?,?)";
                        ...
                        stmt = (Statement) dbUtility.con.createStatement();
                        String sql2 = "Delete from fixbranchpropoint where bcode = ? and proCode = '" + code + "'";
...
//                    JOptionPane.showMessageDialog(this, chkbox);
                if (chkbox.equalsIgnoreCase("true")) {
                    if (!chk(code, tblList.getValueAt(i, 2).toString())) {
                        if (!dbUtility.Char_Set.equalsIgnoreCase("utf-8")) {
                            ...
                            stmt = (Statement) dbUtility.con.createStatement();
                            String sql = "Insert into propintlink (bcode,procode) "
                                    + " values(?,?)";
                            PreparedStatement prm2 = (PreparedStatement) dbUtility.con.prepareStatement(sql);
                            prm2.setString(2, cvth.Unicode2ASCII(code));
                            prm2.setString(1, cvth.Unicode2ASCII(tblList.getValueAt(i, 2).toString()));
    ...
    private void btnok2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnok2ActionPerformed
        ...
        try {
            ...
            for (int i = 0; i < model3.getRowCount(); i++) {
                if (i == 0) {
                    where = "btype = '" + model3.getValueAt(i, 0) + "'";
                } else {
                    where += " or btype = '" + model3.getValueAt(i, 0) + "'";
                }
            }

            String sql = "select btype,name,code "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBranchmult4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchmult4 dialog = new BrowserBranchmult4(new javax.swing.JFrame(), true, "", new DefaultTableModel());
    ...
    private void initTable() {
        ...
        try {
            String sql = "select branfile.bgroup,name,code from branfile "
                    + "left join propointlink on propointlink.bgroup=branfile.bgroup "
                    + "where procode='"+code+"' "
    ...
    public boolean chk(String code, String bcode) {
        ...
        try {
            sql = "SELECT * FROM fixbranchpropoint WHERE bcode='" + bcode + "' and procode = '" + code + "'";
            stmt = dbUtility.con.createStatement();
