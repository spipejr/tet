 ...
 * @author natee
 */
public class BrowserBranchStore extends javax.swing.JDialog {
    ...
    public BrowserBranchStore(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        db.dbconnect();
        try {
    ...
    public BrowserBranchStore(java.awt.Frame parent, boolean modal, Point point) {
        this(parent,modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrowserBranchStore.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                BrowserBranchStore dialog = new BrowserBranchStore(new javax.swing.JFrame(), true);
    ...
    public BranchCodeName getRecordAt(String GroupCode) {
        ...
        try {
            sql = "SELECT * FROM store WHERE Code='" + GroupCode + "'";
            stmt = dbUtility.con.createStatement();
