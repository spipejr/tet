 ...
 * @author s386
 */
public class ListOption extends javax.swing.JDialog {

    /**
     * Creates new form ListOption
     */
    DefaultTableModel tbList ;
    dbUtility db = new dbUtility();
    Statement stmt ;
    String frmName = "listgroupfile";
    public String code = "";
    public String name = "";
    int index = 0;
    public ListOption(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-472)/2, (screenSize.height-507)/2, 472, 507);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListOption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ListOption dialog = new ListOption(new javax.swing.JFrame(), true);
    ...
    private void loadtxt()
    {
        ...
        {
            if(tbl.isRowSelected(i))
            {
                txt += ","+tbl.getValueAt(i,0);
            }
