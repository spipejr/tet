 ...
 * @author s386
 */
public class listBustype extends javax.swing.JDialog {

    /**
     * Creates new form listBustype
     */
    DefaultTableModel tbBranctype ;
    dbUtility db = new dbUtility();
    Statement stmt ;
    String frmName = "listbustype";
    ThaiUtilities cvth = new ThaiUtilities();
    public String bcode = "";
    public String bname = "";
    int index = 0;
    public listBustype(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width-460)/2, (screenSize.height-517)/2, 460, 517);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(listBustype.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                listBustype dialog = new listBustype(new javax.swing.JFrame(), true);
...
private void showdata() {
    ...
    try {
        ...
        while(rs.next())
        {
            ...
            {
            tbBranctype.addRow(new Object[]{cvth.ASCII2Unicode(rs.getString("buscode")),cvth.ASCII2Unicode(rs.getString("busname"))});
            }
            else
            {
            tbBranctype.addRow(new Object[]{rs.getString("buscode"),rs.getString("busname")});
            }
        }
    } catch (Exception e) {
    }
