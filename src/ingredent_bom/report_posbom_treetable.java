 ...
 * @author natee
 */
public class report_posbom_treetable extends javax.swing.JDialog {
    ...
    public report_posbom_treetable(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(btn_excel, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 30, 100, 65));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(report_posbom_treetable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                report_posbom_treetable dialog = new report_posbom_treetable(new javax.swing.JFrame(), true);
    ...
    private void inittbl() {
        try {
            ...
            tc4.setHeaderValue("ปริมาณที่ใช้");
            TableColumn tc5 = new TableColumn(4, 80);
            tc5.setHeaderValue("หน่วยที่ใช้");
            TableColumn tc6 = new TableColumn(5, 85);
            tc6.setHeaderValue("Sale Type");
            TableColumn tc7 = new TableColumn(6, 35);
            tc7.setHeaderValue("สูตร");
    ...
    private void btnProcess() {
        try {
            ...
            String sql = "select "
                    ...
                    + "order by p.pgroup, b.pcode, b.formula";
