 ...
 * @author s386
 */
public class reportSumSaleOfPluProductBean {
    ...
    public List<reportSumSaleOfPluProductBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportSumSaleOfPluProductBean> children) {
