 ...
 * @author s386
 */
public class reportPromotionAllModel extends AbstractTreeTableModel 
{
    private Statement stmt;
	private reportPromotionAllBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
        
        public reportPromotionAllModel(String sql,String code,String name) throws SQLException
    {
            db.dbconnect();
            stmt = null;
            ...
            myroot = new reportPromotionAllBean();
            ...
            while (rs.next()) {
                        ...
                        if(!code.equals("null"))
                        {
                        myroot.getChildren().add(new reportPromotionAllBean( cvth.ASCII2Unicode(rs.getString(code)),
                        ...
                        {
                        myroot.getChildren().add(new reportPromotionAllBean( "",
                                                                        "",
                                                                        cvth.ASCII2Unicode(rs.getString("prtype")),
                                                                        cvth.ASCII2Unicode(rs.getString("prcode")),
                                                                        cvth.ASCII2Unicode(rs.getString("prname")),
            ...
            myroot.getChildren().add(new reportPromotionAllBean( "Total All",
                                                            "",
                                                            "",
                                                            "",
                                                            "",
            ...
            else
            {
                while (rs.next()) {
                        ...
                        if(!code.equals("null"))
                        {
                        myroot.getChildren().add(new reportPromotionAllBean( rs.getString(code),
                                                                        rs.getString(name),
                                                                        rs.getString("prtype"),
                                                                        rs.getString("prcode"),
                                                                        rs.getString("prname"),
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportPromotionAllBean treenode = ( reportPromotionAllBean )node;
		switch( column )
		{
		...
		case 4: return treenode.getProname();
                case 5: return treenode.getPcode();
                case 6: return treenode.getPname();
	...
	{
		reportPromotionAllBean treenode = ( reportPromotionAllBean )parent;
