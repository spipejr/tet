...
public class reportTerminalBean {
    ...
    public List<reportTerminalBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportTerminalBean> children) {
