 ...
 * @author natee
 */
public class reportSaleOfPluModel extends AbstractTreeTableModel 
{
        private Statement stmt;
	private reportSaleOfPluBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
    public reportSaleOfPluModel(String sql) throws SQLException
    {
        ...
        db.dbconnect();
            ...
            reportSaleOfPluBean subtree = null;
            reportSaleOfPluBean datetree = null;
            myroot = new reportSaleOfPluBean( "รายงานททั้งหมด","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","" );
            if(!db.Char_Set.equalsIgnoreCase("utf-8"))
            {
            while (rs.next()) {
                double price = 0;
                price = rs.getDouble("pprice11");
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    if(subtree != null)
                    {
                       ...
                       // subtree.getChildren().add(new MyTreeNode("Total Of Group","","","",Format.doubleFmt.format(totalgroup),""));
                        subtree.getChildren().add(new reportSaleOfPluBean(tempbranold,"","","","Total Branch "+tempbranold,Format.doubleFmt.format(totalgroup1),"",Format.doubleFmt.format(totalgroup2),Format.doubleFmt.format(totalgroup3),Format.doubleFmt.format(totalgroup4)
                    ...
                    subtree = new reportSaleOfPluBean();
                    countgroup = 0;
                    if(!tempdateold.equals(tempdate))
                    {
                        ...
                        if(datetree!=null)
                        {
                            datetree.getChildren().add(new reportSaleOfPluBean(tempbranold,"","","","Total Date "+utilititiesfunction.Format.dateFmtShow.format(d_tempdateold)
                        ...
                        datetree = new reportSaleOfPluBean("Date "+utilititiesfunction.Format.dateFmtShow.format(rs.getDate("s_date")),"","","","","","","","","","","","","","","","","","","","","","","","","","","","","","" );
                        ...
                        datetree.getChildren().add(new reportSaleOfPluBean( cvth.ASCII2Unicode(rs.getString("s_bran")),
                ...
                totalgroup1 += rs.getDouble("pprice11");
                ...
                totaldate[0] += rs.getDouble("pprice11");
                ...
                totaldate[25] += rs.getDouble("s_price");
                
                
                total1 += rs.getDouble("pprice11");
...
//            Format.doubleFmt.format(totalgroup)
           if(datetree!=null)
                        {
                            datetree.getChildren().add(new reportSaleOfPluBean(tempbran,"","","","Total Date "+utilititiesfunction.Format.dateFmtShow.format(d_tempdate)
                            ,Format.doubleFmt.format(totaldate[0]),"",Format.doubleFmt.format(totaldate[1])
                            ,Format.doubleFmt.format(totaldate[2]),Format.doubleFmt.format(totaldate[3])
                            ,Format.doubleFmt.format(totaldate[4]),Format.doubleFmt.format(totaldate[5])
                            ,Format.doubleFmt.format(totaldate[6]),Format.doubleFmt.format(totaldate[7])
           ...
           if(subtree != null)
           {
            subtree.getChildren().add(new reportSaleOfPluBean(tempbran,"","","","Total Branch "+tempbran,Format.doubleFmt.format(totalgroup1),"",Format.doubleFmt.format(totalgroup2),Format.doubleFmt.format(totalgroup3),Format.doubleFmt.format(totalgroup4)
                    ,Format.doubleFmt.format(totalgroup5),Format.doubleFmt.format(totalgroup6)
                    ,Format.doubleFmt.format(totalgroup7),Format.doubleFmt.format(totalgroup8)
                    ,Format.doubleFmt.format(totalgroup9),Format.doubleFmt.format(totalgroup10),Format.doubleFmt.format(totalgroup11)
                    ,Format.doubleFmt.format(totalgroup12),Format.doubleFmt.format(totalgroup13)
            ...
            myroot.getChildren().add(new reportSaleOfPluBean("Total All","","","","",Format.doubleFmt.format(total1),""
               ...
               while (rs.next()) {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    if(!tempdateold.equals(tempdate))
                    {
                        ...
                        datetree.getChildren().add(new reportSaleOfPluBean( rs.getString("s_bran"),
                                                                        utilititiesfunction.Format.dateFmtShow.format(rs.getDate("s_date")),
                                                                        rs.getString("pgroup"),
...
//            Format.doubleFmt.format(totalgroup)
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportSaleOfPluBean treenode = ( reportSaleOfPluBean )node;
		switch( column )
		{
		...
		case 3: return treenode.getS_pcode();
                ...
                case 7: return treenode.getE_qty();
                case 8: return treenode.getE_amt();
                case 9: return treenode.getE_disc();
                case 10: return treenode.getE_net();
		case 11: return treenode.getT_qty();
		case 12: return treenode.getT_amt();
                case 13: return treenode.getT_disc();
                case 14: return treenode.getT_net();
                case 15: return treenode.getD_qty();
                case 16: return treenode.getD_amt();
                case 17: return treenode.getD_disc();
                case 18: return treenode.getD_net();
                case 19: return treenode.getP_qty();
		case 20: return treenode.getP_amt();
		case 21: return treenode.getP_disc();
                case 22: return treenode.getP_net();
                case 23: return treenode.getW_qty();
                case 24: return treenode.getW_amt();
                case 25: return treenode.getW_disc();
                case 26: return treenode.getW_net();
                case 27: return treenode.getS_qty();
                case 28: return treenode.getS_amt();
                case 29: return treenode.getS_disc();
                case 30: return treenode.getS_net();
		default: return "Unknown";
		}
	}
	...
	{
		reportSaleOfPluBean treenode = ( reportSaleOfPluBean )parent;
