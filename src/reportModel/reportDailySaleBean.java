 ...
 * @author s386
 */
public class reportDailySaleBean {
    private String code;
    private String name;
    private String b1;
    private String b2;
    ...
    public List<reportDailySaleBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportDailySaleBean> children) {
