...
public class reportHourlyModel extends AbstractTreeTableModel
{
	...
	private reportHourlyBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
        public reportHourlyModel(String sql) throws SQLException
    {
        db.dbconnect();
            stmt = null;
            String tempbran = "";
            ...
            reportHourlyBean subtree = null;
            myroot = new reportHourlyBean();
                ...
                if(!tempbranold.equals(tempbran))
                {
                    if(subtree != null)
                    {
                       ...
                       //Format.doubleFmt.format(totalgroup1) subtree.getChildren().add(new MyTreeNode("Total Of Group","","","",Format.doubleFmt.format(totalgroup),""));
                        subtree.getChildren().add(new reportHourlyBean(tempbranold,
                                "Total Branch ",
                    ...
                    subtree = new reportHourlyBean();
                    countgroup = 0;
                    i=1;
                        subtree.getChildren().add(new reportHourlyBean( cvth.ASCII2Unicode(rs.getString("s_bran")),
                                                                        ...
                                                                        Format.doubleFmt.format(rs.getDouble("pnt2")),
                                                                        Format.doubleFmt.format(rs.getDouble("cnt2")),
                                                                        Format.doubleFmt.format(rs.getDouble("amt2")),
                                                                        Format.doubleFmt.format(rs.getDouble("pnt3")),
                                                                        Format.doubleFmt.format(rs.getDouble("cnt3")),
                                                                        Format.doubleFmt.format(rs.getDouble("amt3")),
                                                                        Format.doubleFmt.format(rs.getDouble("pnt4")),
                                                                        Format.doubleFmt.format(rs.getDouble("cnt4")),
                                                                        Format.doubleFmt.format(rs.getDouble("amt4")),
                                                                        Format.doubleFmt.format(rs.getDouble("pnt5")),
                                                                        Format.doubleFmt.format(rs.getDouble("cnt5")),
                                                                        Format.doubleFmt.format(rs.getDouble("amt5")),
                                                                        Format.doubleFmt.format(rs.getDouble("pnt6")),
                                                                        Format.doubleFmt.format(rs.getDouble("cnt6")),
                                                                        Format.doubleFmt.format(rs.getDouble("amt6")),
...
//                         
                ...
                totalgroup1[3] += rs.getDouble("pnt2");
                totalgroup1[4] += rs.getDouble("cnt2");
                totalgroup1[5] += rs.getDouble("amt2");
                totalgroup1[6] += rs.getDouble("pnt3");
                totalgroup1[7] += rs.getDouble("cnt3");
                totalgroup1[8] += rs.getDouble("amt3");
                totalgroup1[9] += rs.getDouble("pnt4");
                totalgroup1[10] += rs.getDouble("cnt4");
                totalgroup1[11] += rs.getDouble("amt4");
                totalgroup1[12] += rs.getDouble("pnt5");
                totalgroup1[13] += rs.getDouble("cnt5");
                totalgroup1[14] += rs.getDouble("amt5");
                totalgroup1[15] += rs.getDouble("pnt6");
                totalgroup1[16] += rs.getDouble("cnt6");
                totalgroup1[17] += rs.getDouble("amt6");
                totalgroup1[18] += rs.getDouble("pnt7");
                totalgroup1[19] += rs.getDouble("cnt7");
                totalgroup1[20] += rs.getDouble("amt7");
                totalgroup1[21] += rs.getDouble("pnt8");
                totalgroup1[22] += rs.getDouble("cnt8");
                totalgroup1[23] += rs.getDouble("amt8");
                totalgroup1[24] += rs.getDouble("pnt9");
                totalgroup1[25] += rs.getDouble("cnt9");
                totalgroup1[26] += rs.getDouble("amt9");
                totalgroup1[27] += rs.getDouble("pnt10");
                totalgroup1[28] += rs.getDouble("cnt10");
                totalgroup1[29] += rs.getDouble("amt10");
                totalgroup1[30] += rs.getDouble("pnt11");
                totalgroup1[31] += rs.getDouble("cnt11");
                totalgroup1[32] += rs.getDouble("amt11");
                totalgroup1[33] += rs.getDouble("pnt12");
                totalgroup1[34] += rs.getDouble("cnt12");
                totalgroup1[35] += rs.getDouble("amt12");
                totalgroup1[36] += rs.getDouble("pnt13");
                totalgroup1[37] += rs.getDouble("cnt13");
                totalgroup1[38] += rs.getDouble("amt13");
                totalgroup1[39] += rs.getDouble("pnt14");
                totalgroup1[40] += rs.getDouble("cnt14");
                totalgroup1[41] += rs.getDouble("amt14");
                totalgroup1[42] += rs.getDouble("pnt15");
                totalgroup1[43] += rs.getDouble("cnt15");
                totalgroup1[44] += rs.getDouble("amt15");
                totalgroup1[45] += rs.getDouble("pnt16");
                totalgroup1[46] += rs.getDouble("cnt16");
                totalgroup1[47] += rs.getDouble("amt16");
                totalgroup1[48] += rs.getDouble("pnt17");
                totalgroup1[49] += rs.getDouble("cnt17");
                totalgroup1[50] += rs.getDouble("amt17");
                totalgroup1[51] += rs.getDouble("pnt18");
                totalgroup1[52] += rs.getDouble("cnt18");
                totalgroup1[53] += rs.getDouble("amt18");
                totalgroup1[54] += rs.getDouble("pnt19");
                totalgroup1[55] += rs.getDouble("cnt19");
                totalgroup1[56] += rs.getDouble("amt19");
                ...
                total1[3] += rs.getDouble("pnt2");
                total1[4] += rs.getDouble("cnt2");
                total1[5] += rs.getDouble("amt2");
                total1[6] += rs.getDouble("pnt3");
                total1[7] += rs.getDouble("cnt3");
                total1[8] += rs.getDouble("amt3");
                total1[9] += rs.getDouble("pnt4");
                total1[10] += rs.getDouble("cnt4");
                total1[11] += rs.getDouble("amt4");
                total1[12] += rs.getDouble("pnt5");
                total1[13] += rs.getDouble("cnt5");
                total1[14] += rs.getDouble("amt5");
                total1[15] += rs.getDouble("pnt6");
                total1[16] += rs.getDouble("cnt6");
                total1[17] += rs.getDouble("amt6");
                total1[18] += rs.getDouble("pnt7");
                total1[19] += rs.getDouble("cnt7");
                total1[20] += rs.getDouble("amt7");
                total1[21] += rs.getDouble("pnt8");
                total1[22] += rs.getDouble("cnt8");
                total1[23] += rs.getDouble("amt8");
                total1[24] += rs.getDouble("pnt9");
                total1[25] += rs.getDouble("cnt9");
                total1[26] += rs.getDouble("amt9");
                total1[27] += rs.getDouble("pnt10");
                total1[28] += rs.getDouble("cnt10");
                total1[29] += rs.getDouble("amt10");
                total1[30] += rs.getDouble("pnt11");
                total1[31] += rs.getDouble("cnt11");
                total1[32] += rs.getDouble("amt11");
                total1[33] += rs.getDouble("pnt12");
                total1[34] += rs.getDouble("cnt12");
                total1[35] += rs.getDouble("amt12");
                total1[36] += rs.getDouble("pnt13");
                total1[37] += rs.getDouble("cnt13");
                total1[38] += rs.getDouble("amt13");
                total1[39] += rs.getDouble("pnt14");
                total1[40] += rs.getDouble("cnt14");
                total1[41] += rs.getDouble("amt14");
                total1[42] += rs.getDouble("pnt15");
                total1[43] += rs.getDouble("cnt15");
                total1[44] += rs.getDouble("amt15");
                total1[45] += rs.getDouble("pnt16");
                total1[46] += rs.getDouble("cnt16");
                total1[47] += rs.getDouble("amt16");
                total1[48] += rs.getDouble("pnt17");
                total1[49] += rs.getDouble("cnt17");
                total1[50] += rs.getDouble("amt17");
                total1[51] += rs.getDouble("pnt18");
                total1[52] += rs.getDouble("cnt18");
                total1[53] += rs.getDouble("amt18");
                total1[54] += rs.getDouble("pnt19");
                total1[55] += rs.getDouble("cnt19");
                total1[56] += rs.getDouble("amt19");
           ...
           if(subtree != null)
           {
           subtree.getChildren().add(new reportHourlyBean(tempbran,
                                "Total Branch ",
                                Format.doubleFmt.format(totalgroup1[0]),
                                Format.doubleFmt.format(totalgroup1[1]),
                                Format.doubleFmt.format(totalgroup1[2]),
...
//            }
             myroot.getChildren().add(new reportHourlyBean("Total All",
                                "",
            ...
            else
            {
               while (rs.next()) {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    countgroup = 0;
                    i=1;
                        subtree.getChildren().add(new reportHourlyBean( rs.getString("s_bran"),
                                                                        utilititiesfunction.Format.dateFmtShow.format(rs.getDate("t_date")),
                                                                        Format.doubleFmt.format(rs.getDouble("pnt1")),
                                                                        Format.doubleFmt.format(rs.getDouble("cnt1")),
                                                                        Format.doubleFmt.format(rs.getDouble("amt1")),
...
//            }
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportHourlyBean treenode = ( reportHourlyBean )node;
		switch( column )
		{
	...
	{
		reportHourlyBean treenode = ( reportHourlyBean )parent;
