 ...
 * @author s386
 */
public class reportSumPluIngModel extends AbstractTreeTableModel 
{
    private Statement stmt;
	private reportSumPluIngBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
        
        public reportSumPluIngModel(String sql,String code,String name) throws SQLException
    {
            db.dbconnect();
            stmt = null;
            String tempbran = " ";
            ...
            reportSumPluIngBean subtree = null;
            myroot = new reportSumPluIngBean( "รายงานททั้งหมด","","","","","","","","" );
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    if(subtree != null)
                    {
                       ...
                       // subtree.getChildren().add(new MyTreeNode("Total Of Group","","","",Format.doubleFmt.format(totalgroup),""));
                        subtree.getChildren().add(new reportSumPluIngBean(tempbranold,"","Total "+code+" "+tempbranold
                                ,""
                                ,""
                                ,""
                        ,""
                    ...
                    subtree = new reportSumPluIngBean();
                    countgroup = 0;
                        i=1;
                        
                        subtree.getChildren().add(new reportSumPluIngBean( cvth.ASCII2Unicode(rs.getString("tgroup")),
...
//            Format.doubleFmt.format(totalgroup)
           ...
           if(subtree != null)
           {
            subtree.getChildren().add(new reportSumPluIngBean(tempbran,"","Total "+code+" "+tempbran
           ...
           myroot.getChildren().add(new reportSumPluIngBean("Total All"
                    ,""
                    ,""
               ...
               while (rs.next()) {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    countgroup = 0;
                        ...
                        subtree.getChildren().add(new reportSumPluIngBean( rs.getString("tgroup"),
                                                                        rs.getString("tdept"),
...
//            Format.doubleFmt.format(totalgroup)
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportSumPluIngBean treenode = ( reportSumPluIngBean )node;
		switch( column )
		{
		...
		case 7: return treenode.getQty();
                case 8: return treenode.getTotcost();
		default: return "Unknown";
		}
	}
	...
	{
		reportSumPluIngBean treenode = ( reportSumPluIngBean )parent;
