 ...
 * @author s386
 */
public class reportTempDailySale2Model extends AbstractTreeTableModel
{
	...
	private reportTempDailySaleBean myroot;
        ...
        public reportTempDailySale2Model(String sql,String code,String name) throws SQLException
    {
        try {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    if(subtree != null)
                    {
                       ...
                       // subtree.getChildren().add(new MyTreeNode("Total Of Group","","","",Format.doubleFmt.format(totalgroup),""));
                        ...
                        subtree.setQue("Fastival "+" Total "+countgroup+" Record");
                    ...
                    countgroup = 0;
                        ...
                        subtree.getChildren().add(new reportTempDailySaleBean( cvth.ASCII2Unicode(rs.getString("tque")),
            ...
            else
            {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    countgroup = 0;
                        ...
                        subtree.getChildren().add(new reportTempDailySaleBean( rs.getString("tque"),
                                                                        rs.getString("tcode"),
                                                                        rs.getString("tpname"),
                                                                        rs.getString("tprice"),
                                                                        rs.getString("tunit"),
