 ...
 * @author s386
 */
public class reportSumSaleOfPluProductModel extends AbstractTreeTableModel
{
        private Statement stmt;
	private reportSumSaleOfPluProductBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
        
        public reportSumSaleOfPluProductModel(String sql,String code,String name) throws SQLException
    {
            db.dbconnect();
            stmt = null;
            String tempproduct = " ";
            ...
            reportSumSaleOfPluProductBean subtree = null;
            myroot = new reportSumSaleOfPluProductBean( "รายงานททั้งหมด","","","","","","","","","","","","","","","","","","","","","","","","","","","","","" );
            if(!db.Char_Set.equalsIgnoreCase("utf-8"))
            {
            while (rs.next()) {
                
                tempproduct = rs.getString("s_pcode");
                ...
                if(!tempproductold.equals(tempproduct))
                {
                    ...
                    if(subtree != null)
                    {
                       ...
                       // subtree.getChildren().add(new MyTreeNode("Total Of Group","","","",Format.doubleFmt.format(totalgroup),""));
                        subtree.getChildren().add(new reportSumSaleOfPluProductBean("Total รหัสสินค้า "+tempproductold,"","","",Format.doubleFmt.format(totalgroup1),"",Format.doubleFmt.format(totalgroup2),Format.doubleFmt.format(totalgroup3),Format.doubleFmt.format(totalgroup4)
                    ...
                    subtree = new reportSumSaleOfPluProductBean();
                    countgroup = 0;
                        i=1;
                        
                        subtree.getChildren().add(new reportSumSaleOfPluProductBean( cvth.ASCII2Unicode(rs.getString("BranchCode")),
                                                                        cvth.ASCII2Unicode(rs.getString("branchname")),
...
//            Format.doubleFmt.format(totalgroup)
           ...
           if(subtree != null)
           {
            subtree.getChildren().add(new reportSumSaleOfPluProductBean("Total รหัสสินค้า "+tempproduct,"","","",Format.doubleFmt.format(totalgroup1),"",Format.doubleFmt.format(totalgroup2),Format.doubleFmt.format(totalgroup3),Format.doubleFmt.format(totalgroup4)
                    ,Format.doubleFmt.format(totalgroup5),Format.doubleFmt.format(totalgroup6)
                    ,Format.doubleFmt.format(totalgroup7),Format.doubleFmt.format(totalgroup8)
                    ,Format.doubleFmt.format(totalgroup9),Format.doubleFmt.format(totalgroup10),Format.doubleFmt.format(totalgroup11)
                    ,Format.doubleFmt.format(totalgroup12),Format.doubleFmt.format(totalgroup13)
            ...
            myroot.getChildren().add(new reportSumSaleOfPluProductBean("Total All","","","",Format.doubleFmt.format(total1),""
               ...
               while (rs.next()) {
                ...
                if(!tempproductold.equals(tempproduct))
                {
                    ...
                    countgroup = 0;
                        ...
                        subtree.getChildren().add(new reportSumSaleOfPluProductBean( rs.getString("BranchCode"),
...
//            Format.doubleFmt.format(totalgroup)
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportSumSaleOfPluProductBean treenode = ( reportSumSaleOfPluProductBean )node;
		switch( column )
		{
		...
		case 2: return treenode.getS_pcode();
                ...
                case 6: return treenode.getE_qty();
                case 7: return treenode.getE_amt();
                case 8: return treenode.getE_disc();
                case 9: return treenode.getE_net();
		case 10: return treenode.getT_qty();
		case 11: return treenode.getT_amt();
                case 12: return treenode.getT_disc();
                case 13: return treenode.getT_net();
                case 14: return treenode.getD_qty();
                case 15: return treenode.getD_amt();
                case 16: return treenode.getD_disc();
                case 17: return treenode.getD_net();
                case 18: return treenode.getP_qty();
		case 19: return treenode.getP_amt();
		case 20: return treenode.getP_disc();
                case 21: return treenode.getP_net();
                case 22: return treenode.getW_qty();
                case 23: return treenode.getW_amt();
                case 24: return treenode.getW_disc();
                case 25: return treenode.getW_net();
                case 26: return treenode.getS_qty();
                case 27: return treenode.getS_amt();
                case 28: return treenode.getS_disc();
                case 29: return treenode.getS_net();
		default: return "Unknown";
		}
	}
	...
	{
		reportSumSaleOfPluProductBean treenode = ( reportSumSaleOfPluProductBean )parent;
