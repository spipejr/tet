 ...
 * @author s386
 */
public class reportTerminalModel extends AbstractTreeTableModel 
{
    private Statement stmt;
	private reportTerminalBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
        
        public reportTerminalModel(String sql) throws SQLException
    {
        db.dbconnect();
            stmt = null;
            String tempbran = "";
            ...
            reportTerminalBean subtree = null;
            reportTerminalBean datetree = null;
            myroot = new reportTerminalBean();
            ...
            while (rs.next()) {
                        ...
                        myroot.getChildren().add(new reportTerminalBean( cvth.ASCII2Unicode(rs.getString("s_bran"))+"   ("+rs.getString("sap_site_code")+")",
            ...
            myroot.getChildren().add(new reportTerminalBean( "Total All",
                                                            "",
                                                            "",
                                                            "",
            ...
            else
            {
               while (rs.next()) {
                        ...
                        myroot.getChildren().add(new reportTerminalBean( rs.getString("s_bran")+"   ("+rs.getString("sap_site_code")+")",
                                                                        rs.getString("name"),
                                                                        rs.getString("tday"),
                                                                        utilititiesfunction.Format.dateFmtShow.format(rs.getDate("t_date")),
                                                                        Format.doubleFmt.format(rs.getDouble("deptsum")),
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportTerminalBean treenode = ( reportTerminalBean )node;
		switch( column )
		{
		case 0: return treenode.getS_bran();
		case 1: return treenode.getBranname();
		case 2: return treenode.getTday();
                case 3: return treenode.getS_date();
                case 4: return treenode.getDeptsum();
                case 5: return treenode.getService();
                case 6: return treenode.getDiscount();
                case 7: return treenode.getNetsale();
                case 8: return treenode.getCash();
                case 9: return treenode.getMisc();
		case 10: return treenode.getCupon();
		case 11: return treenode.getAr();
                case 12: return treenode.getSalevat();
                case 13: return treenode.getSalenonvat();
                case 14: return treenode.getSvat();
                case 15: return treenode.getCust();
                case 16: return treenode.getPcust();
                case 17: return treenode.getVoids();
                case 18: return treenode.getRefund();
                case 19: return treenode.getPledge();
		case 20: return treenode.getANB();
		case 21: return treenode.getACB();
                case 22: return treenode.getE();
                case 23: return treenode.getEnet();
                case 24: return treenode.getNE();
                case 25: return treenode.getCE();
                case 26: return treenode.getANE();
                case 27: return treenode.getACE();
                case 28: return treenode.getT();
                case 29: return treenode.getTnet();
                case 30: return treenode.getNT();
                case 31: return treenode.getCT();
                case 32: return treenode.getANT();
                case 33: return treenode.getACT();
                case 34: return treenode.getD();
                case 35: return treenode.getDnet();
                case 36: return treenode.getND();
                case 37: return treenode.getCD();
                case 38: return treenode.getAND();
                case 39: return treenode.getACD();
                case 40: return treenode.getP();
                case 41: return treenode.getPnet();
                case 42: return treenode.getNP();
                case 43: return treenode.getCP();
                case 44: return treenode.getANP();
                case 45: return treenode.getACP();
                case 46: return treenode.getW();
                case 47: return treenode.getWnet();
                case 48: return treenode.getNW();
                case 49: return treenode.getCW();
                case 50: return treenode.getANW();
                case 51 : return treenode.getACW();
		default: return "Unknown";
		}
	}
	...
	{
		reportTerminalBean treenode = ( reportTerminalBean )parent;
