 ...
 * @author s386
 */
public class reportSumSaleOfPluBean {
    ...
    public List<reportSumSaleOfPluBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportSumSaleOfPluBean> children) {
