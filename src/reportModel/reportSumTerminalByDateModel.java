 ...
 * @author s386
 */
public class reportSumTerminalByDateModel extends AbstractTreeTableModel {

    private Statement stmt;
    private reportSumterminalByDateBean myroot;
    ThaiUtilities cvth = new ThaiUtilities();
    dbUtility db = new dbUtility();

    public reportSumTerminalByDateModel(String sql, String code, String name) throws SQLException {
        db.dbconnect();
        stmt = null;
        ...
        myroot = new reportSumterminalByDateBean();
        if (!db.Char_Set.equalsIgnoreCase("utf-8")) {
            while (rs.next()) {
                ...
                if (!code.equals("null")) {
                    myroot.getChildren().add(new reportSumterminalByDateBean(cvth.ASCII2Unicode(rs.getString(code)) + Sap_Site_Code,
                    ...
                    myroot.getChildren().add(new reportSumterminalByDateBean("",
                            "",
                            rs.getString("tday"),
                            utilititiesfunction.Format.dateFmtShow.format(rs.getDate("t_date")),
                            Format.doubleFmt.format(rs.getDouble("deptsum")),
            ...
            myroot.getChildren().add(new reportSumterminalByDateBean("Total All",
                    "",
                    "",
                    "",
            ...
            while (rs.next()) {
                ...
                double bill = rs.getDouble("cust") - rs.getDouble("nre");
                if (!code.equals("null")) {
                    myroot.getChildren().add(new reportSumterminalByDateBean(rs.getString(code) + Sap_Site_Code,
                            rs.getString(name),
                            rs.getString("tday"),
                            utilititiesfunction.Format.dateFmtShow.format(rs.getDate("t_date")),
                            Format.doubleFmt.format(rs.getDouble("deptsum")),
    ...
    public Object getValueAt(Object node, int column) {
        ...
        reportSumterminalByDateBean treenode = (reportSumterminalByDateBean) node;
        switch (column) {
            case 0:
    ...
    public int getChildCount(Object parent) {
        reportSumterminalByDateBean treenode = (reportSumterminalByDateBean) parent;
