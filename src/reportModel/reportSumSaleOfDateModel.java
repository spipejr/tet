 ...
 * @author s386
 */
public class reportSumSaleOfDateModel extends AbstractTreeTableModel
{
        private Statement stmt;
	private reportSumSaleOfDateBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
        
        public reportSumSaleOfDateModel(String sql,String code,String name) throws SQLException
    {
            db.dbconnect();
            stmt = null;
            String tempbran = " ";
            ...
            reportSumSaleOfDateBean subtree = null;
            myroot = new reportSumSaleOfDateBean( );
            ...
            while (rs.next()) {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    if(subtree != null)
                    {
                        ...
                        subtree.getChildren().add(new reportSumSaleOfDateBean(tempbranold,"","","","Total "+code+" "+tempbranold,Format.doubleFmt.format(totalgroup1),"",Format.doubleFmt.format(totalgroup2),Format.doubleFmt.format(totalgroup3),Format.doubleFmt.format(totalgroup4)
                    ...
                    subtree = new reportSumSaleOfDateBean();
                    countgroup = 0;
                        i=1;
                        
                        subtree.getChildren().add(new reportSumSaleOfDateBean( cvth.ASCII2Unicode(rs.getString(code)),
           ...
           if(subtree != null)
           {
            subtree.getChildren().add(new reportSumSaleOfDateBean(tempbran,"","","","Total "+code+" "+tempbran,Format.doubleFmt.format(totalgroup1),"",Format.doubleFmt.format(totalgroup2),Format.doubleFmt.format(totalgroup3),Format.doubleFmt.format(totalgroup4)
                    ,Format.doubleFmt.format(totalgroup5),Format.doubleFmt.format(totalgroup6)
                    ,Format.doubleFmt.format(totalgroup7),Format.doubleFmt.format(totalgroup8)
                    ,Format.doubleFmt.format(totalgroup9),Format.doubleFmt.format(totalgroup10),Format.doubleFmt.format(totalgroup11)
                    ,Format.doubleFmt.format(totalgroup12),Format.doubleFmt.format(totalgroup13)
            ...
            myroot.getChildren().add(new reportSumSaleOfDateBean("Total All","","","","",Format.doubleFmt.format(total1),""
               ...
               while (rs.next()) {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    countgroup = 0;
                        ...
                        subtree.getChildren().add(new reportSumSaleOfDateBean( rs.getString(code),
                                                                        utilititiesfunction.Format.dateFmtShow.format(rs.getDate("s_date")),
                                                                        rs.getString("pgroup"),
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportSumSaleOfDateBean treenode = ( reportSumSaleOfDateBean )node;
		switch( column )
		{
	...
	{
		reportSumSaleOfDateBean treenode = ( reportSumSaleOfDateBean )parent;
