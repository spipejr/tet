 ...
 * @author s386
 */
public class reportSumSaleLostBean {
    private String item;
    private String rjno;
    private String dept;
    private String desc;
    ...
    public List<reportSumSaleLostBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportSumSaleLostBean> children) {
    ...
    public String getRjno() {
        return rjno;
    }

    public void setRjno(String rjno) {
        this.rjno = rjno;
    }
