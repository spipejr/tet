 ...
 * @author s386
 */
public class reportTempDailySaleBean {
    ...
    public List<reportTempDailySaleBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportTempDailySaleBean> children) {
