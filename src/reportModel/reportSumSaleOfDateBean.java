 ...
 * @author s386
 */
public class reportSumSaleOfDateBean {
    ...
    public List<reportSumSaleOfDateBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportSumSaleOfDateBean> children) {
