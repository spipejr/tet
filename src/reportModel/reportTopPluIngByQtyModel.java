 ...
 * @author s386
 */
public class reportTopPluIngByQtyModel extends AbstractTreeTableModel 
{
    
    private Statement stmt;
	private reportTopPluIngByQtyBean myroot;
        ThaiUtilities cvth = new ThaiUtilities();
        dbUtility db = new dbUtility();
        
        public reportTopPluIngByQtyModel(String sql,String code,String name) throws SQLException
    {
            db.dbconnect();
            stmt = null;
            String tempbran = " ";
            ...
            reportTopPluIngByQtyBean subtree = null;
            myroot = new reportTopPluIngByQtyBean( "รายงานททั้งหมด","","","","","","","" );
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    if(subtree != null)
                    {
                       ...
                       // subtree.getChildren().add(new MyTreeNode("Total Of Group","","","",Format.doubleFmt.format(totalgroup),""));
                        subtree.getChildren().add(new reportTopPluIngByQtyBean(tempbranold,""
                                ,""
                    ...
                    subtree = new reportTopPluIngByQtyBean();
                    countgroup = 0;
                        i=1;
                        
                        subtree.getChildren().add(new reportTopPluIngByQtyBean( cvth.ASCII2Unicode(rs.getString("tgroup")),
...
//            Format.doubleFmt.format(totalgroup)
           ...
           if(subtree != null)
           {
            subtree.getChildren().add(new reportTopPluIngByQtyBean(tempbran,""
           ...
           myroot.getChildren().add(new reportTopPluIngByQtyBean("Total All"
                    ,""
                    ,""
                    ,""
                    ,""
            ...
            else
            {
                ...
                if(!tempbranold.equals(tempbran))
                {
                    ...
                    countgroup = 0;
                        ...
                        subtree.getChildren().add(new reportTopPluIngByQtyBean( rs.getString("tgroup"),
                                                                        rs.getString("tque"),
                                                                        rs.getString("tcode"),
                                                                        rs.getString("tpname"),
                                                                        Format.doubleFmt.format(rs.getDouble("tprice")),
...
//            Format.doubleFmt.format(totalgroup)
	...
	public Object getValueAt( Object node, int column ) 
	{
		...
		reportTopPluIngByQtyBean treenode = ( reportTopPluIngByQtyBean )node;
		switch( column )
		{
	...
	{
		reportTopPluIngByQtyBean treenode = ( reportTopPluIngByQtyBean )parent;
