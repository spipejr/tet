 ...
 * @author s386
 */
public class reportSumPluCostBean {
    ...
    public List<reportSumPluCostBean> children = new ArrayList<reportSumPluCostBean>();

    public reportSumPluCostBean(String s_bran, String s_dept, String s_pcode, String pname, String pprice, String punit, String s_qty, String s_amt, String totalcost, String s_per) {
        this.s_bran = s_bran;
        this.s_dept = s_dept;
    ...
    public reportSumPluCostBean() {
    }

    public List<reportSumPluCostBean> getChildren() {
        return children;
    }

    public void setChildren(List<reportSumPluCostBean> children) {
